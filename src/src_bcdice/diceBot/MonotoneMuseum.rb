...
INFO_MESSAGE_TEXT
  ...
  def mm_distortion_table_ver2
    table = [
      ...
      "【平穏無事】\n何も起きない。紡ぎ手は背筋が凍るほどの恐怖を覚える。",
      "【疫病蔓延】\n登場している角色は【肉体】難易度8の判定を行ない、失敗すると［邪毒］5を受ける。病の治療法の有無などについてはGMが決定する。迷ったら、伽藍を倒すと病も消滅する、とせよ。",
      "【疫病蔓延】\n登場している角色は【肉体】難易度8の判定を行ない、失敗すると［邪毒］5を受ける。病の治療法の有無などについてはGMが決定する。迷ったら、伽藍を倒すと病も消滅する、とせよ。",
  ...
  def mm_world_distortion_table
    table = [
      "【消失】\n世界からボス角色が消去され、消滅する。エンディングフェイズへ。",
      "【自己犠牲】\nチャートを振ったPCのパートナーとなっているNPCのひとりが死亡する。チャートを振ったPCのHPとMPを完全に回復させる。",
      "【生命誕生】\nキミたちは大地の代わりに何かの生き物の臓腑の上に立っている。登場している角色全員に［邪毒］5を与える。",
      "【歪曲拡大】\nシーンに登場している紡ぎ手ではないNPCひとりが漆黒の凶獣（『MM』P.240）に変身する。",
      "【暴走】\n“ほつれ ”がいくつも生まれ、シーンに登場しているすべての角色の剥離値を +1 する。",
      "【幻像世界】\n周囲の空間は歪み、破壊的なエネルギーが充満する。次に行なわれるダメージロールに+5D6する。",
      "【変調】\n右は左に、赤は青に、上は下に、歪みが身体の動きを妨げる。登場している角色全員に［狼狽］を与える。",
      "【空間消失】\n演目の舞台が煙のように消失する。圧倒的な喪失感により、登場している角色全員に［放心］を与える。",
  ...
  def mm_world_distortion_table_ver2
    table = [
      "【歪みの茨】\nシーン全体が鋼鉄よりも硬い茨の棘によって埋め尽くされる。飛行状態でない角色は、移動を行う度に〈刺〉3D6+[そのシーンで登場する角色の中で最大の演者レベル]点のダメージを受ける。",
      "【歪みの茨】\nシーン全体が鋼鉄よりも硬い茨の棘によって埋め尽くされる。飛行状態でない角色は、移動を行う度に〈刺〉3D6+[そのシーンで登場する角色の中で最大の演者レベル]点のダメージを受ける。",
      "【世界歪曲】\n世界歪曲表（『MM』P264）を振る。",
      "【世界歪曲】\n世界歪曲表（『MM』P264）を振る。",
      "【さかさま世界】\n空か゛地面に、地面が空になる。そのシーン中、全ての飛行状態である角色は飛行状態でないものとして、飛行状態にない角色は飛行状態として扱う。",
      "【さかさま世界】\n空か゛地面に、地面が空になる。そのシーン中、全ての飛行状態である角色は飛行状態でないものとして、飛行状態にない角色は飛行状態として扱う。",
      "【海の記憶】\n存在するはずのない潮騒が聞こえ、世界の全てが波に飲み込まれる。このシーン中、飛行状態でない全ての角色は水中状態として扱う。",
      "【海の記憶】\n存在するはずのない潮騒が聞こえ、世界の全てが波に飲み込まれる。このシーン中、飛行状態でない全ての角色は水中状態として扱う。",
      "【空間湾曲】\n世界は歪む。こことあそこは意味を失う。このシーンの間、全ての角色の移動力は∞となり、特技と装備の射程は全て「視界」となる。",
      "【空間湾曲】\n世界は歪む。こことあそこは意味を失う。このシーンの間、全ての角色の移動力は∞となり、特技と装備の射程は全て「視界」となる。",
      ...
      "【豪雨】\nすさまじい雨が降る。雨は全ての人の心を凍らせる。このシーンの間、「種別：銃」である武器を用いた攻撃のファンブル値を+6する。また、別エンゲージへの物理攻撃の達成値を-2する。",
      "【どろどろ】\n足下がいつの間にか不定型な泥沼になっている。このシーンの間、飛行状態でない角色が同一エンゲージに対して行う物理攻撃のファンブル値を+6する。",
      "【どろどろ】\n足下がいつの間にか不定型な泥沼になっている。このシーンの間、飛行状態でない角色が同一エンゲージに対して行う物理攻撃のファンブル値を+6する。",
      "【暴風】\n風は吹きすさび運命を嘲笑する。このシーンの間、飛行状態でない角色が同一エンゲージに対して行う物理攻撃のファンブル値を+6する",
      "【暴風】\n風は吹きすさび運命を嘲笑する。このシーンの間、飛行状態でない角色が同一エンゲージに対して行う物理攻撃のファンブル値を+6する",
      ...
      "【虚構の果て】\n神が見捨てたのか、神を見捨てたのか。逸脱の果て、世界は終わる。あなたはこのシーンで逸脱能力を使用した場合、上昇した剥離値の10倍だけの実ダメージを受ける。このダメージは軽減できず、移し替えることも出来ない。",
      "【人格交代】\n魂、厳密には魂の背後にあるナニモノカが入れ替わる。左隣の玩家に角色卡を渡し、このシーン中はその玩家があなたのPCを演じる。GMが認めれば、GMもNPCと入れ替えてもいい。",
      "【人格交代】\n魂、厳密には魂の背後にあるナニモノカが入れ替わる。左隣の玩家に角色卡を渡し、このシーン中はその玩家があなたのPCを演じる。GMが認めれば、GMもNPCと入れ替えてもいい。",
      "【因果の糸】\n嗤う声がする。「逸脱の結果は共有しようよ？」PC全員の剥離値を平均し（端数切り上げ）、全員の剥離値をその計算結果に書き換える、",
      "【因果の糸】\n嗤う声がする。「逸脱の結果は共有しようよ？」PC全員の剥離値を平均し（端数切り上げ）、全員の剥離値をその計算結果に書き換える、",
      "【剣に斃る】\n人を裁く者に報いを、剣には剣の対価を。このシーンで攻撃を行いファンブルした場合、5D6点の実ダメージを受ける。",
      "【剣に斃る】\n人を裁く者に報いを、剣には剣の対価を。このシーンで攻撃を行いファンブルした場合、5D6点の実ダメージを受ける。",
      "【秘密暴露】\n隠しておきたい秘密を小鳥が囀り、リスが囁く。登場している全ての紡ぎ手、異形、伽藍は隠しておきたい秘密（その角色の主観で良い）ひとつを明らかにする。さもなければ、10D6点の実ダメージを受ける。このダメージは軽減も移し替えも出来ない。",
      "【秘密暴露】\n隠しておきたい秘密を小鳥が囀り、リスが囁く。登場している全ての紡ぎ手、異形、伽藍は隠しておきたい秘密（その角色の主観で良い）ひとつを明らかにする。さもなければ、10D6点の実ダメージを受ける。このダメージは軽減も移し替えも出来ない。",
  ...
  def mm_omens_table_ver2
    table = [
      ...
      "【昏倒】\nもうあなたは逸脱の重さに耐えることは出来ない。これが世界に刃向かった報いだ。あなたは[戦闘不能]になる。すでに[戦闘不能]なら、[死亡]する。",
      "【肉体の崩壊】\n硝子の砕ける音がして、あなたも砕けていく。あなたは2D6+角色レベル点の【HP】を失う。",
      "【肉体の崩壊】\n硝子の砕ける音がして、あなたも砕けていく。あなたは2D6+角色レベル点の【HP】を失う。",
      ...
      "【逸脱の重責】\n世界から逸脱した結果、肉体が急激に異形化し身体を苛む。[上昇した剥離値×10]点の【HP】を失う。",
      "【急激な異形化】\n身体の一部（耳、指、瞳）などが歪んだ獣のそれになる。しかし、そのことはあなたの力ともなる。【HP】を（角色レベル）D6点回復する（回復できない状態でも回復する）。あなたの剥離値を+2する（この効果では兆候表を振らない）。",
      "【急激な異形化】\n身体の一部（耳、指、瞳）などが歪んだ獣のそれになる。しかし、そのことはあなたの力ともなる。【HP】を（角色レベル）D6点回復する（回復できない状態でも回復する）。あなたの剥離値を+2する（この効果では兆候表を振らない）。",
      "【精神の崩壊】\n身体が異形化し、世界から剥離していく。あなたの存在はぼやけてやがて消えていく。魂すらも。あなたは2D6+角色レベル点の【MP】を失う。",
      "【精神の崩壊】\n身体が異形化し、世界から剥離していく。あなたの存在はぼやけてやがて消えていく。魂すらも。あなたは2D6+角色レベル点の【MP】を失う。",
  ...
  def mm_distortion_table_outdoor
    table = [
      ...
      "【異形化】\n周囲の動物たちが歪みによって異形と化し、襲撃してくる。異形の群れ（『IZ』P237）×1D6体と戦闘になっても良い。",
      "【凍結世界】\n気温が異様に低下し、すべてのものが凍結する。また、凍結した世界の中で戦闘する全ての角色は、防御判定にファンブルした場合狼狽を受ける。",
      "【凍結世界】\n気温が異様に低下し、すべてのものが凍結する。また、凍結した世界の中で戦闘する全ての角色は、防御判定にファンブルした場合狼狽を受ける。",
      "【天候暴走】\n大嵐、竜巻、吹雪、酷暑などの異常気象が発生する。船は木の葉のように揺れ、獣は恐怖に騒ぐ。このシーン中に行うすべての移動はその距離が半減する。",
      "【天候暴走】\n大嵐、竜巻、吹雪、酷暑などの異常気象が発生する。船は木の葉のように揺れ、獣は恐怖に騒ぐ。このシーン中に行うすべての移動はその距離が半減する。",
      "【天の怒り】\n歪みによってあり得ないほどの異常気象が発生する。全てを吹き飛ばす風が吹き、雷鳴が唸る。このシーン中、あらゆる角色は飛行状態になることは出来ない。",
      "【天の怒り】\n歪みによってあり得ないほどの異常気象が発生する。全てを吹き飛ばす風が吹き、雷鳴が唸る。このシーン中、あらゆる角色は飛行状態になることは出来ない。",
      ...
      "【虚無現出】\nほつれの中から虚無がしみ出す。シーンに登場しているエキストラは虫一匹にいたるまで消滅し、二度と現れない。",
      "【虚無現出】\nほつれの中から虚無がしみ出す。シーンに登場しているエキストラは虫一匹にいたるまで消滅し、二度と現れない。",
      "【汚染世界】\n水は毒を含み、大気は有毒の霧に包まれる。登場している全ての角色は【体力】難易度10の判定を行い、失敗すると邪毒5を受ける。エキストラがどうなるかはGMが決定するが、治療されなければ早晩死亡するだろう。",
      "【汚染世界】\n水は毒を含み、大気は有毒の霧に包まれる。登場している全ての角色は【体力】難易度10の判定を行い、失敗すると邪毒5を受ける。エキストラがどうなるかはGMが決定するが、治療されなければ早晩死亡するだろう。",
      "【地域消滅】\n演目の舞台となっている地域そのものが消えてなくなる。影響下にあるすべての角色（伽藍を含む）は【縫製】難易度10の判定に成功すれば脱出できる。失敗した場合即座に死亡する。エキストラは無条件で死亡する。",
      "【地域消滅】\n演目の舞台となっている地域そのものが消えてなくなる。影響下にあるすべての角色（伽藍を含む）は【縫製】難易度10の判定に成功すれば脱出できる。失敗した場合即座に死亡する。エキストラは無条件で死亡する。",
    ]
  ...
  def mm_distortion_table_sea
    table = [
      "【海域汚染】\n赤潮が発生する。あるいは海水そのものが毒に変わる。登場している全ての角色は【体力】難易度10の判定を行い、失敗すると邪毒5を受ける。エキストラがどうなるかはGMが決定するが、治療されなければ早晩死亡するだろう。",
      "【海域汚染】\n赤潮が発生する。あるいは海水そのものが毒に変わる。登場している全ての角色は【体力】難易度10の判定を行い、失敗すると邪毒5を受ける。エキストラがどうなるかはGMが決定するが、治療されなければ早晩死亡するだろう。",
      "【色彩浸食】\n世界が漆黒と曇白に塗り分けられる。シーン内に登場するあらゆる無生物と生物は、白と黒のモノトーンの存在になる。紡ぎ手は【縫製】難易度8の判定に成功すれば、この影響を受けない。",
      "【色彩浸食】\n世界が漆黒と曇白に塗り分けられる。シーン内に登場するあらゆる無生物と生物は、白と黒のモノトーンの存在になる。紡ぎ手は【縫製】難易度8の判定に成功すれば、この影響を受けない。",
      ...
      "【歪曲御標】\n歪んだ御標が下される。歪み表（『MM』P263）を振ること。",
      "【歪曲御標】\n歪んだ御標が下される。歪み表（『MM』P263）を振ること。",
      "【曇白の海】\n海の水が曇白になる。虚無への甘い誘いに満ちた海に触れたものは、考えることをやめ、意思なき人形のようになり、いずれ溶けて消滅してしまう。この歪みが1D6シーン（または1D6日）以内に消えない場合、すべての角色は（PCも含め）エキストラとなって二度と自我を取り戻すことはない。GMは何らかの理由で効果を受けない角色を設定しても良い。",
      "【曇白の海】\n海の水が曇白になる。虚無への甘い誘いに満ちた海に触れたものは、考えることをやめ、意思なき人形のようになり、いずれ溶けて消滅してしまう。この歪みが1D6シーン（または1D6日）以内に消えない場合、すべての角色は（PCも含め）エキストラとなって二度と自我を取り戻すことはない。GMは何らかの理由で効果を受けない角色を設定しても良い。",
      ...
      "【固形化】\n海の水が固形化する。その中にいるものは氷で硬められたように身動きが取れず、ただ死を待つのみ。エキストラは完全に動けなくなる。エネミーやPCは等しく重圧＆捕縛を受ける。この効果は歪みが引き受けられるまでの間、毎シーン＆毎ラウンドの開始後に再度適用される。",
      "【氾濫】\n海の水が急激に増幅し、水槽からあふれ出す。シーンに登場している海守りのクラスを持たない角色の【HP】は即座に0になる。ただし《大河の導き》の効果を受けている角色と《ミズモノ》を取得している角色は3D6点の【HP】を消費することでこの効果を打ち消せる。",
      "【氾濫】\n海の水が急激に増幅し、水槽からあふれ出す。シーンに登場している海守りのクラスを持たない角色の【HP】は即座に0になる。ただし《大河の導き》の効果を受けている角色と《ミズモノ》を取得している角色は3D6点の【HP】を消費することでこの効果を打ち消せる。",
      ...
      "【酒の海】\n海の水が酒になる。水を飲んだすべての者は酔っ払い理性を失う。その様はまるで暗黒期に滅亡した“怠惰の古都”を彷彿とさせる。",
      "【冷たき海】\n海の水が魂を凍らせるような冷たさになる。水に触れた者は暗く排他的で疑心暗鬼になり、互いを憎悪するようになる。また、全ての角色は海水に触れている限り、毎シーン【MP】を2D6点失う。",
      "【冷たき海】\n海の水が魂を凍らせるような冷たさになる。水に触れた者は暗く排他的で疑心暗鬼になり、互いを憎悪するようになる。また、全ての角色は海水に触れている限り、毎シーン【MP】を2D6点失う。",
      "【大渦巻き】\n巨大な大渦が出現する。渦の中心は虚無に通じており、海守りの力を持ってしても渦を消すことはできない。海中にいる全ての角色は2D6を振り、出た目に等しい【HP】を失う。ただし出目が2の場合、即座に【HP】が0となる。",
      "【大渦巻き】\n巨大な大渦が出現する。渦の中心は虚無に通じており、海守りの力を持ってしても渦を消すことはできない。海中にいる全ての角色は2D6を振り、出た目に等しい【HP】を失う。ただし出目が2の場合、即座に【HP】が0となる。",
