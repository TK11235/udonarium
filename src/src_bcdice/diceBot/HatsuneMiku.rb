  ...
  @@tables =
    {
      ...
      'CWT' => {
        ...
        :type => '1D6',
        :table => %w{
          絶望的な攻撃を受ける。その角色は強制退出になる。
          苦痛の悲鳴をあげ、無惨にも崩れ落ちる。その角色は行動不能になる。また、黒のネイロが一つ増える。
          オトクイの一撃で、あなたは吹き飛ばされてしまう。その角色は行動不能になる。また、分類が装備のナンバーにストレスを１点受ける。
          強烈な一撃を受けて気絶する。その角色は行動不能になる。
          意識はあるが、立ち上がることができない。その角色は行動不能になる。次のシーンにまだ【生命力】が０点だった場合、自動的に１点に回復する。
      ...
      'BT' => {
        ...
        :table => %w{
          ...
          ノイズストアに連線できた。各PCは、自分の【頭脳】の骰子の数と同じ個数まで、アプリを購入できる。
        },
      },
      ...
      'TT' => {
        ...
        :table => %w{
          ...
          堅実。ＰＣの中で、その脅威の「判定欄」に書かれた能力値がもっとも低いランクの角色一人を目標に選ぶ。もっとも低いランクの角色が複数いる場合、その中から、もっとも低いモッドの角色一人を目標に選ぶ。モッドも同じ値だった場合、ＧＭが自由に一人目標を選ぶ。
