...
MESSAGETEXT
  ...
  def getTableResult(table, dice, hasGap = false)
    ...
    text += command.call() unless command.nil?
    ...
    @tables =
      ...
      "FT" => {
        ...
        [
         ...
         [3, "１Ｄ６に１００を掛け、それだけの【所持金】を失う", lambda{ getGoldText(1, 100, "失う") }],
         [4, "１Ｄ６に１００を掛け、それだけの【所持金】を拾う", lambda{ getGoldText(1, 100, "拾う") }],
         [5, "【経験値】２を獲得する"],
         [6, "【経験値】４を獲得する"],
        ],},
      ...
      "DC" => {
        ...
        [[1, "装備以外のアイテムのうちＧＭ指定の１つを失う"],
         [2, "装備のうちＧＭ指定の１つを失う"],
         [3, "２Ｄ６に１００を掛け、それだけの【所持金】を失う", lambda{ getGoldText(2, 100, "失う") }],
         [4, "【ＬＩＦＥ】が１Ｄ６減少する", lambda{ getDownText("【ＬＩＦＥ】", 1) }],
         [5, "【ＳＴ】が１Ｄ６減少する", lambda{ getDownText("【ＳＴ】", 1) }],
         [6, "【ＬＩＦＥ】が２Ｄ６減少する", lambda{ getDownText("【ＬＩＦＥ】", 2) }],
        ],},
      ...
      "OUTENC" => {
        ...
        :table => 
        [
         [1, "エリアの地形ごとの野外モンスター表へ移動。モンスターのうち１体にランダムな特徴がつく。モンスター特徴表（１５６ページ）を使用する。", lambda{ getAddRoll("MONFT") }],
         [2, "エリアの地形ごとの野外モンスター表へ移動。"],
         [3, "エリアの地形ごとの野外モンスター表へ移動。"],
         [4, "アンデッドの群れ（１５６ページ）。"],
         [5, "盗賊の群れ（１５６ページ）。"],
         [6, "希少動物表（１５６ページ）へ移動。", lambda{ getAddRoll("RANI") }],
        ],},
      ...
      "OUTENCP" => {
        ...
        :table => 
        [
         [1, "エリアの地形ごとの野外モンスター表プラスへ移動。モンスターのうち1体にランダムな特徴がつく。モンスター特徴表プラス（０２７ページ）を使用する。", lambda{ getAddRoll("MONFTP") }],
         [2, "エリアの地形ごとの野外モンスター表プラスへ移動し、出現したモンスターとの戦闘が発生する"],
         [3, "スライムモンスター表プラス（０２７ページ）へ移動。"],
         [4, "アンデッドの群れ（基本１５６ページ）"],
         [5, "盗賊の群れ（基本１５６ページ）"],
         [6, "希少動物表（基本１５６ページ）へ移動", lambda{ getAddRoll("RANI") }],p
        ],},
      ...
      "DROP" => {
        ...
        :table => 
        [
         [1, "武器ドロップ表へ移動", lambda{ getAddRoll("DROPWP") }],
         [2, "武器ドロップ表へ移動", lambda{ getAddRoll("DROPWP") }],
         [3, "防具ドロップ表へ移動", lambda{ getAddRoll("DROPAR") }],
         [4, "食品ドロップ表へ移動", lambda{ getAddRoll("DROPFD") }],
         [5, "巻物ドロップ表へ移動", lambda{ getAddRoll("DROPSC") }],
         [6, "その他ドロップ表へ移動", lambda{ getAddRoll("DROPOT") }],
        ],},
      ...
      "DROPP" => {
        ...
        :table => 
        [
         [11, "武器ドロップ表", lambda{ getAddRoll("DROPWP") }],
         [12, "武器ドロップ表", lambda{ getAddRoll("DROPWP") }],
         [13, "武器ドロップ表2", lambda{ getAddRoll("DROPWP2") }],
         [14, "武器ドロップ表2", lambda{ getAddRoll("DROPWP2") }],
         [15, "防具ドロップ表", lambda{ getAddRoll("DROPAR") }],
         [16, "防具ドロップ表", lambda{ getAddRoll("DROPAR") }],
         [22, "防具ドロップ表2", lambda{ getAddRoll("DROPAR2") }],
         [23, "防具ドロップ表2", lambda{ getAddRoll("DROPAR2") }],
         [24, "食品ドロップ表", lambda{ getAddRoll("DROPFD") }],
         [25, "食品ドロップ表", lambda{ getAddRoll("DROPFD") }],
         [26, "食品ドロップ表2", lambda{ getAddRoll("DROPFD2") }],
         [33, "食品ドロップ表2", lambda{ getAddRoll("DROPFD2") }],
         [34, "薬品ドロップ表プラス", lambda{ getAddRoll("DROPDRP") }],
         [35, "薬品ドロップ表プラス", lambda{ getAddRoll("DROPDRP") }],
         [36, "巻物ドロップ表", lambda{ getAddRoll("DROPSC") }],
         [44, "巻物ドロップ表", lambda{ getAddRoll("DROPSC") }],
         [45, "巻物ドロップ表2", lambda{ getAddRoll("DROPSC2") }],
         [46, "巻物ドロップ表2", lambda{ getAddRoll("DROPSC2") }],
         [55, "その他ドロップ表", lambda{ getAddRoll("DROPOT") }],
         [56, "その他ドロップ表", lambda{ getAddRoll("DROPOT") }],
         [66, "その他ドロップ表2", lambda{ getAddRoll("DROPOT2") }],
        ],},
