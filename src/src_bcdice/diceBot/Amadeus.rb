  ...
  @@tables =
    {
      ...
      "FT" => {
        ...
        :table => %w{
          ...
          あまりの失敗に、みんなの態度が変わる。自分に対して一番高い【想い】の値を持っている角色全員の、【想い】の属性が反転する。
      ...
      "BT" => {
        ...
        :table => [
          ...
          [13, "強欲な商人に出会う。このシーンに登場した角色は、アイテムを購入することができる。ただし、すべてのアイテムの価格は通常の値段より1高い。"],
          ...
          [22, "＜絶界＞の外の世界の友人のことを思い出す。みんなは元気にしているだろうか？　この出目を振った玩家のPCは、【日常】で判定を行うことができる。成功すると、自分の変調を1つ回復するか、黒の領域からインガを1つ取り除くことができる。"],
          [23, "奇妙な商人に出会う。このシーンに登場した角色は、アイテムを購入することができる。"],
          [24, "喋る動物に願いごとをされる。動物たちも、この神話災害で苦しんでいるようだ。あなたは、「この怪物の本体の【生命力】を0にする」という追加の【任務】を受けることができる。この【任務】を達成すると、追加で経験値を20点もらうことができる。"],
          [25, "素敵な夢を見る。この出目を振った玩家は、自分のPC以外の好きな角色一人に対する【想い】が1点上昇する。"],
          [26, "大切な人から、あなたを心配するメールが届いていた。なんて返そう？　この出目を振った玩家のPCは、【日常】で判定を行うことができる。成功すると、自分の変調を1つ回復するか、自分の好きなパトスマークについたチェックを1つ消す。"],
          [33, "親切な商人に出会う。このシーンに登場した角色は、アイテムを購入することができる。ただし、すべてのアイテムの価格は通常の値段より1低い（価格1未満にはならない）。"],
          [34, "武器の手入れを行う。この出目を振った玩家のPCは、【日常】で判定を行うことができる。成功すると、そのセッションの間、自分の武器1つの威力を1点上昇させることができる。"],
          [35, "最後に買い物をしたときに、おつりを多くもらっていたことに気がついた。1神貨を手に入れる。"],
          [36, "食事をしながら、仲間と大いに語り合う。このシーンに登場して、食事を行った角色は、自分の好きなパトスマークについたチェックを一つ消す。"],
          [44, "一眠りしてしまったのか、不思議な夢を見る。この出目を振った玩家のPCは、【霊力】で判定を行うことができる。成功すると、好きな予言卡牌1枚を選び、その【真実】を見ることができる。"],
          [45, "チンピラにからまれている異性の子を見つける。この出目を振った玩家のPCは、【武勇】で判定を行うことができる。成功すると、その子は、そのPCに対して【想い】を1点獲得する。この子を協力者にするなら、その玩家はその子の名前と関係を自由に決めること。"],
          [46, "心地よい風に吹かれる。運命があなたに味方してくれるような気がした。好きな領域にインガを1つ配置する。"],
          [55, "目が覚めると、枕元に贈り物が。誰からだろう……？　この出目を振った玩家のPCは、「ランダムアイテム表」を使用する。"],
          [56, "困っている神話生物を助けてあげた。【日常】で判定を行う。成功すると、次に移動判定を行うことになったとき、自動的にそれを成功にすることができる（達成値が必要な場合6として扱う）。"],
          [66, "親神が、あなたに話しかけてくる。親子の会話だ。この出目を振った玩家のPCは、【日常】で判定を行うことができる。成功すると、自分の親神に対する【想い】か、親神の自分に対する【想い】のいずれかを1点上昇する。"],
        ],
      },
      ...
      "FWT" => {
        ...
        :type => '1D6',
        :table => %w{
          絶望的な攻撃を受ける。その角色は死亡する。
          苦痛の悲鳴をあげ、無惨にも崩れ落ちる。その角色は行動不能になる。また、黒の領域のインガが1つ増える。
          攻撃を受けた武器が砕け、敵の攻撃が直撃する。その角色は行動不能になる。また、自分の武器一つを破壊する。
          強烈な一撃を受けて気絶する。その角色は行動不能になる。
          意識はあるが、立ち上がることができない。その角色は行動不能になる。次のシーンになったら【生命力】が1点に回復する。
      ...
      "CCVT" => {
        ...
        :type => '1D6',
        :table => %w{
          新聞記者たちが忙しく行き来しているオフィスにいる。ここは、新聞社アーカムアドバタイザーの編輯部だ。「君が大きなニュースを持っていると聞いたんだけれど」記者の一人が尋ねてくる。自分の【真実】が公開されていなければ、「臆病1」の変調を受ける。
      ...
      "RGT" => {
        ...
        :table => %w{
          ...
          GMが選んだ角色と同じ親神の親神ギフトの中から選ぶ。
          ランダムに選んだPCと同じ神群の神群ギフトの中から選ぶ。
          GMが選んだ角色と同じ神群の神群ギフトの中から選ぶ。
          好きな背景ギフトの中から選ぶ。
          好きな汎用ギフトの中から選ぶ。
        },
      },
