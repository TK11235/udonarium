...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$getWishTableResult', TMP_11 = function $$getWishTableResult(command) {
      ...
      tableName = "";
      table = [];
      $case = command;if (/^DWT$/i['$===']($case) || /^DeathWT$/i['$===']($case)) {tableName = "소원표「죽음」";
      table = ["지금의 아름다움을 유지한 채 죽고 싶다.", "재밌는 방법으로 죽어보고 싶다.", "자살할 용기가 없어서 죽고 싶다.", "죽으면 어떻게 될지 보고 싶다.", "너무나 싫은 일이 있어서 죽고 싶다.", "불로불사가 질려서 죽고 싶다."];}else if (/^RWT$/i['$===']($case) || /^RevengeWT$/i['$===']($case)) {tableName = "소원표「복수」";
      table = ["가족을 죽인 범인에게 복수하고 싶다.", "자신보다 행복한 이웃에게 복수하고 싶다.", "자신을 배반한 친구에게 복수하고 싶다.", "자신을 버린 애인에게 복수하고 싶다.", "소중한 것을 빼앗은 범인에게 복수하고 싶다.", "처참한 패배를 안겨준 라이벌에게 복수하고 싶다."];}else if (/^VWT$/i['$===']($case) || /^VictoryWT$/i['$===']($case)) {tableName = "소원표「승리」";
      table = ["이전에 졌던 라이벌에게 이기고 싶다.", "쓰러트리고 싶은 유명인(고인)이 있다.", "쓰러트리고 싶은 유명인이 있다.", "특정 업계에서 제일의 실력자가 되고 싶다.", "특정 게임에서 최강의 플레이어가 되고 싶다.", "특정 테스트에서 1위를 하고 싶다."];}else if (/^PWT$/i['$===']($case) || /^PossesionWT$/i['$===']($case)) {tableName = "소원표「획득」";
      table = ["원하는 아이템이 있다.", "원하는 생물이 있다.", "원하는 관계가 있다.", "원하는 친족이 있다.", "원하는 지식이 있다.", "원하는 부동산이 있다."];}else if (/^CWT$/i['$===']($case) || /^ControlWT$/i['$===']($case)) {tableName = "소원표「지배」";
      table = ["지배하고 싶은 인물집단이 있다.", "지배하고 싶은 지역이 있다.", "세계를 정복하고 싶다.", "선거에서 이기고 싶다.", "굴욕을 주고 싶은 사람이 있다.", "어리광쟁이인 친척을 마음대로 하고 싶다."];}else if (/^FWT$/i['$===']($case) || /^FlourishWT$/i['$===']($case)) {tableName = "소원표「번영」";
      table = ["몰락한 일족을 부흥시키고 싶다.", "지역 경제를 활성화시키고 싶다.", "취미인 장르에서 사람을 모으고 싶다.", "절멸한 생물을 부활시키고 싶다.", "동물이나 식물을 절멸에서 구하고 싶다.", "아무튼 많은 돈을 원한다."];}else if (/^IWT$/i['$===']($case) || /^IntensifyWT$/i['$===']($case)) {tableName = "소원표「강화」";
      table = ["세계최강이 되고 싶다.", "세계에서 가장 아름다워지고 싶다.", "세계에서 가장 현명해지고 싶다.", "세계에서 가장 행복해지고 싶다.", "세계에서 가장 터프해지고 싶다.", "세계에서 가장 빨라지고 싶다."];}else if (/^HWT$/i['$===']($case) || /^HealthWT$/i['$===']($case)) {tableName = "소원표「건강」";
      table = ["완성시키고 싶은 약물이 있다.", "절멸시키고 싶은 병원균이 있다.", "난치병에서 회복시키고 싶은 친척이 있다.", "난치병에서 회복하고 싶다.", "병으로 죽은 사람을 부활시키고 싶다.", "병에 걸리지 않는 몸을 원한다."];}else if (/^SaWT$/i['$===']($case) || /^SafetyWT$/i['$===']($case)) {tableName = "소원표「안전」";
      table = ["평온한 생활을 보내고 싶다.", "평온하게 지내길 바라는 사람이 있다.", "끝내고 싶은 분쟁이 있다.", "사고로 죽은 사람을 부활시키고 싶다.", "사고를 겪지 않는 능력을 원한다.", "다가오는 세계의 위기를 회피하고 싶다."];}else if (/^LWT$/i['$===']($case) || /^LongevityWT$/i['$===']($case)) {tableName = "소원표「장수」";
      table = ["지금의 아름다움을 유지하고 싶다.", "지금의 강함을 유지하고 싶다.", "아이가 어른이 되기까지 죽지 않는다.", "불로의 몸을 원한다.", "치매에 걸리고 싶지 않다.", "손자의 얼굴을 보고 싶다."];}else if (/^EWT$/i['$===']($case) || /^ExistWT$/i['$===']($case)) {tableName = "소원표「삶」";
