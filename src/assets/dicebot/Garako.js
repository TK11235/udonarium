...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17, TMP_18, TMP_19, TMP_20, TMP_21, TMP_22, TMP_23, TMP_24, TMP_25, TMP_26, TMP_27, TMP_28, TMP_29, TMP_30, TMP_31, TMP_32, TMP_33, TMP_34;
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      output = (function() {$case = command.$upcase();if (/^GR((\+|\-)\d+)?>=(\d+)$/i['$===']($case)) {modifyString = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      targetString = (($a = $gvars['~']) === nil ? nil : $a['$[]'](3));
      return self.$checkRoll(modifyString, targetString);}else if (/(\w)DC(\d+)/i['$===']($case)) {part = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$upcase();
      damage = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
      return self.$get_damage_chart(part, damage);}else if ("PNM"['$===']($case)) {return self.$get_nametable_pm()}else if ("PNF"['$===']($case)) {return self.$get_nametable_pf()}else if ("ENM"['$===']($case)) {return self.$get_nametable_em()}else if ("ENF"['$===']($case)) {return self.$get_nametable_ef()}else if ("NNM"['$===']($case)) {return self.$get_nametable_nm()}else if ("NNF"['$===']($case)) {return self.$get_nametable_nf()}else if ("RNM"['$===']($case)) {return self.$get_nametable_rm()}else if ("RNF"['$===']($case)) {return self.$get_nametable_rf()}else if ("BN1"['$===']($case)) {return self.$get_nametable_b1()}else if ("BN2"['$===']($case)) {return self.$get_nametable_b2()}else if ("TN1"['$===']($case)) {return self.$get_nametable_t1()}else if ("TN2"['$===']($case)) {return self.$get_nametable_t2()}else if ("IDI"['$===']($case)) {return self.$get_idiosyncrasy_table()}else if ("MTV"['$===']($case)) {return self.$get_motivation_table()}else if ("HIT"['$===']($case)) {return self.$get_damage_region_chart()}else if ("GCC"['$===']($case)) {return self.$get_garako_custom_chart()}else if ("WCC"['$===']($case)) {return self.$get_weapon_custom_chart()}else if ("EVC"['$===']($case)) {return self.$get_event_chart()}else if ("BSD"['$===']($case)) {return self.$get_battle_start_distance()}else {return nil}})();
      return output;
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$checkRoll', TMP_6 = function $$checkRoll(modifyString, targetString) {
    ...
    Opal.defn(self, '$getResultText', TMP_7 = function $$getResultText(dice, total, target) {
      var $a, self = this;

      if ((($a = (dice['$=='](1))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "ファンブル"};
      if ((($a = (dice['$=='](10))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "クリティカル"};
      if ((($a = $rb_lt(total, target)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "失敗"};
      return "成功";
    }, TMP_7.$$arity = 3);

    Opal.defn(self, '$get_nametable_pm', TMP_8 = function $$get_nametable_pm() {
    ...
    Opal.defn(self, '$get_nametable_pf', TMP_9 = function $$get_nametable_pf() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_em', TMP_10 = function $$get_nametable_em() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_ef', TMP_11 = function $$get_nametable_ef() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_nm', TMP_12 = function $$get_nametable_nm() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_nf', TMP_13 = function $$get_nametable_nf() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_rm', TMP_14 = function $$get_nametable_rm() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_rf', TMP_15 = function $$get_nametable_rf() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_b1', TMP_16 = function $$get_nametable_b1() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_b2', TMP_17 = function $$get_nametable_b2() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_t1', TMP_18 = function $$get_nametable_t1() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_nametable_t2', TMP_19 = function $$get_nametable_t2() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_idiosyncrasy_table', TMP_20 = function $$get_idiosyncrasy_table() {
    ...
    Opal.defn(self, '$get_motivation_table', TMP_21 = function $$get_motivation_table() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_damage_region_chart', TMP_22 = function $$get_damage_region_chart() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_damage_chart', TMP_23 = function $$get_damage_chart(part, damage) {
      var $a, $b, self = this, $case = nil, name = nil, table = nil, tableMaxValue = nil, result = nil;

      $b = (function() {$case = part;if ("C"['$===']($case)) {return self.$get_damagechart_cockpit()}else if ("E"['$===']($case)) {return self.$get_damagechart_engine()}else if ("F"['$===']($case)) {return self.$get_damagechart_frame()}else if ("A"['$===']($case)) {return self.$get_damagechart_arm()}else if ("L"['$===']($case)) {return self.$get_damagechart_leg()}else {return nil}})(), $a = Opal.to_ary($b), name = ($a[0] == null ? nil : $a[0]), table = ($a[1] == null ? nil : $a[1]), $b;
    ...
    Opal.defn(self, '$get_damagechart_cockpit', TMP_24 = function $$get_damagechart_cockpit() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_damagechart_engine', TMP_25 = function $$get_damagechart_engine() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_damagechart_frame', TMP_26 = function $$get_damagechart_frame() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_damagechart_arm', TMP_27 = function $$get_damagechart_arm() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_damagechart_leg', TMP_28 = function $$get_damagechart_leg() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_garako_custom_chart', TMP_29 = function $$get_garako_custom_chart() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_weapon_custom_chart', TMP_30 = function $$get_weapon_custom_chart() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_event_chart', TMP_31 = function $$get_event_chart() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_battle_start_distance', TMP_32 = function $$get_battle_start_distance() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_garako_1d10_table_result', TMP_33 = function $$get_garako_1d10_table_result(name, table) {
    ...
    return (Opal.defn(self, '$get_garako_table_result', TMP_34 = function $$get_garako_table_result(name, dice, output) {
      var self = this;

      return "" + (name) + "(" + (dice) + ") ＞ " + (output);
    }, TMP_34.$$arity = 3), nil) && 'get_garako_table_result';
