...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      $case = command;if (/^ACT(\d+)$/i['$===']($case)) {number = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
      info = (($a = Opal.cvars['@@tables']) == null ? nil : $a)['$[]']("ACT");
      name = info['$[]']("name");
      table = self.$getTableInfoFromExtraTableText(info['$[]']("table"));
      text = table['$[]'](number);
      result = "" + (name) + "(" + (number) + ") ＞ " + (text);
      return text;};
      result = self.$getTableCommandResult(command, (($a = Opal.cvars['@@tables']) == null ? nil : $a));
