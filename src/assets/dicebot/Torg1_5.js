...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$get_torg_table_result', '$get_torg_damage', '$<', '$-', '$length', '$<=', '$to_i', '$/', '$+', '$*']);
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$get_torg_success_level', TMP_3 = function $$get_torg_success_level(value) {
      var self = this, success_table = nil;
    ...
    Opal.defn(self, '$get_torg_interaction_result_intimidate_test', TMP_4 = function $$get_torg_interaction_result_intimidate_test(value) {
      var self = this, interaction_results_table = nil;
    ...
    Opal.defn(self, '$get_torg_interaction_result_taunt_trick', TMP_5 = function $$get_torg_interaction_result_taunt_trick(value) {
      var self = this, interaction_results_table = nil;
    ...
    Opal.defn(self, '$get_torg_interaction_result_maneuver', TMP_6 = function $$get_torg_interaction_result_maneuver(value) {
      var self = this, interaction_results_table = nil;
    ...
    Opal.defn(self, '$get_torg_damage_ords', TMP_7 = function $$get_torg_damage_ords(value) {
      var self = this, damage_table_ords = nil;
    ...
    Opal.defn(self, '$get_torg_damage_posibility', TMP_8 = function $$get_torg_damage_posibility(value) {
      var self = this, damage_table_posibility = nil;
    ...
    return (Opal.defn(self, '$get_torg_damage', TMP_9 = function $$get_torg_damage(value, max_damage, max_shock, damage_table) {
      var $a, self = this, table_max_value = nil, over_kill_value = nil, over_kill_damage = nil, over_kill_shock = nil;
    ...
    }, TMP_9.$$arity = 4), nil) && 'get_torg_damage';
  })($scope.base, $scope.get('Torg'));
})(Opal);
