...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      output = (function() {$case = command.$upcase();if (/EMA(\d+)?$/i['$===']($case)) {roc = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
      return self.$get_emancipation_table(roc);}else if (/PER(\d+)?$/i['$===']($case)) {roc = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
      return self.$get_personality_table(roc);}else if (/LOC(\d+)?$/i['$===']($case)) {roc = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
      return self.$get_location_table(roc);}else if (/QUI(\d+)?$/i['$===']($case)) {roc = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
      return self.$get_quiet_table(roc);}else if (/DEL(\d+)?$/i['$===']($case)) {roc = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
      return self.$get_delight_table(roc);}else if (/TRA(\d+)?$/i['$===']($case)) {roc = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
      return self.$get_trauma_table(roc);}else if (/SCE(\d+)?$/i['$===']($case)) {roc = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
      return self.$get_scene_production_table(roc);}else if (/STA(\d+)?$/i['$===']($case)) {roc = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
      return self.$get_stance_table(roc);}else if (/EMO(\d+)?$/i['$===']($case)) {roc = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
      return self.$get_emotion_table(roc);}else {return nil}})();
      return output;
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$get_emancipation_table', TMP_6 = function $$get_emancipation_table(roc) {
      ...
      if ((($a = ($rb_gt(roc, 1))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dice = roc;
        if ((($a = ($rb_gt(dice, 12))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          dice = 12};
        diceText = "";
        } else {
      ...
      if ((($a = ($rb_ge(dice, 7))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        tableText = $rb_plus(tableText, "\n【達成値7以上】GM：攻撃ルーチン1つを開示（番号はペアPLが指定）　PL：戦闘開始時のアクセルレベル+1")};
      return "" + (name) + " ＞ " + (dice) + (diceText) + "：" + (tableText);
    }, TMP_6.$$arity = 1);

    Opal.defn(self, '$get_personality_table', TMP_7 = function $$get_personality_table(roc) {
    ...
    Opal.defn(self, '$get_location_table', TMP_8 = function $$get_location_table(roc) {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_quiet_table', TMP_9 = function $$get_quiet_table(roc) {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_delight_table', TMP_10 = function $$get_delight_table(roc) {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_trauma_table', TMP_11 = function $$get_trauma_table(roc) {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_scene_production_table', TMP_12 = function $$get_scene_production_table(roc) {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_stance_table', TMP_13 = function $$get_stance_table(roc) {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_emotion_table', TMP_14 = function $$get_emotion_table(roc) {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_Alter_raise_1d6_table_result', TMP_15 = function $$get_Alter_raise_1d6_table_result(name, table, roc) {
      var $a, $b, self = this, dice = nil, tableText = nil;

      if ((($a = ($rb_gt(roc, 0))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dice = roc;
        if ((($a = ($rb_gt(dice, 6))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          dice = 6};
        } else {
    ...
    return (Opal.defn(self, '$get_Alter_raise_d66_table_result', TMP_16 = function $$get_Alter_raise_d66_table_result(name, table, roc) {
      var $a, $b, self = this, diceText = nil, dice1 = nil, dice2 = nil, dice = nil, tableText = nil;

      if ((($a = ($rb_gt(roc, 10))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        diceText = roc.$to_s();
        dice1 = diceText['$[]'](0, 1).$to_i();
        if ((($a = ($rb_gt(dice1, 6))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          dice1 = 6};
        dice2 = diceText['$[]'](1, 1).$to_i();
        if ((($a = ($rb_lt(dice2, 1))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          dice2 = 1};
        if ((($a = ($rb_gt(dice2, 6))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          dice2 = 6};
      } else if ((($a = ($rb_gt(roc, 0))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dice1 = roc;
        if ((($a = ($rb_gt(dice1, 6))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          dice1 = 6};
    ...
    }, TMP_16.$$arity = 3), nil) && 'get_Alter_raise_d66_table_result';
