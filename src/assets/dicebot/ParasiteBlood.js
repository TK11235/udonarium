...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$check_nD6', TMP_5 = function $$check_nD6(total_n, dice_n, signOfInequality, diff, dice_cnt, dice_max, n1, n_max) {
      ...
      if ((($a = ($rb_ge(n1, 2))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return " ＞ 致命的失敗"};
      if ((($a = ($rb_ge(n_max, 2))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return " ＞ 効果的成功"};
      if ((($a = (diff['$==']("?"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ""};
      return (function() {$case = signOfInequality;if (">="['$===']($case)) {if ((($a = ($rb_ge(total_n, diff))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return " ＞ 成功"};
      return " ＞ 失敗";}else if (">"['$===']($case)) {if ((($a = ($rb_gt(total_n, diff))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return " ＞ 成功"};
      return " ＞ 失敗";}else { return nil }})();
    }, TMP_5.$$arity = 8);

    Opal.defn(self, '$rollDiceCommand', TMP_6 = function $$rollDiceCommand(command) {
      var self = this, $case = nil;

      return (function() {$case = command;if (/(\w)?URGE\s*(\d+)/i['$===']($case)) {return self.$get_urge(command)}else {return "1"}})();
    }, TMP_6.$$arity = 1);

    Opal.defn(self, '$get_urge', TMP_7 = function $$get_urge(string) {
      ...
      if ((($a = (/(\w)?URGE\s*(\d+)/i['$=~'](string))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return "1"
      };
      ...
      urge_type = 0;
      $case = initialWord;if (nil['$===']($case)) {urge_type = 1}else if (/n/i['$===']($case)) {urge_type = 2}else if (/a/i['$===']($case)) {urge_type = 3}else if (/m/i['$===']($case)) {urge_type = 4}else if (/u/i['$===']($case)) {urge_type = 5}else if (/c/i['$===']($case)) {urge_type = 6}else {urge_type = 1};
      if ((($a = (((($b = ($rb_lt(urgelv, 1))) !== false && $b !== nil && $b != null) ? $b : ($rb_gt(urgelv, 5))))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "衝動段階は1から5です"};
      if ((($a = (urge_type['$=='](0))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "1"};
      urge = self.$dp_urge_get(urge_type);
      $b = self.$roll(2, 6), $a = Opal.to_ary($b), dice_now = ($a[0] == null ? nil : $a[0]), $b;
      if ((($a = ($rb_le(urge_type, 1))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        title = "衝動表"
      } else if ((($a = ($rb_le(urge_type, 2))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        title = "新衝動表"
      } else if ((($a = ($rb_le(urge_type, 3))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        title = "誤作動表"
      } else if ((($a = ($rb_le(urge_type, 4))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        title = "ミュータント衝動表"
      } else if ((($a = ($rb_le(urge_type, 5))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        title = "鬼御魂(戦闘外)衝動表"
        } else {
        title = "鬼御魂(戦闘中)衝動表"
      };
    ...
    return (Opal.defn(self, '$dp_urge_get', TMP_8 = function $$dp_urge_get(urge_type) {
      var $a, self = this;
...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$get_urge', TMP_4 = function $$get_urge(string) {
      ...
      initialWord = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      urgelv = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
      $case = initialWord;if (""['$===']($case)) {urge_type = 1}else if (/A/i['$===']($case)) {urge_type = 2}else {urge_type = 1};
      if ((($a = (((($b = ($rb_lt(urgelv, 1))) !== false && $b !== nil && $b != null) ? $b : ($rb_gt(urgelv, 5))))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "衝動段階は1から5です"};
      if ((($a = (urge_type['$=='](0))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "1"};
    ...
    Opal.defn(self, '$get_pb_urge_table', TMP_5 = function $$get_pb_urge_table(level, dice, urge_type) {
    ...
    Opal.defn(self, '$get_pb_normal_urge_table', TMP_6 = function $$get_pb_normal_urge_table() {
      var self = this;
    ...
    return (Opal.defn(self, '$get_pb_aas_urge_table', TMP_7 = function $$get_pb_aas_urge_table() {
      var self = this;
    ...
    }, TMP_7.$$arity = 0), nil) && 'get_pb_aas_urge_table';
  })($scope.base, $scope.get('DemonParasite'));
})(Opal);
