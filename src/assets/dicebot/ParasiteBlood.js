...
Opal.loaded(["diceBot/DemonParasite"]);
/* Generated by Opal 0.11.4 */
(function(Opal) {
  function $rb_lt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs < rhs : lhs['$<'](rhs);
  ...
  return (function($base, $super, $parent_nesting) {
    function $ParasiteBlood(){};
    var self = $ParasiteBlood = $klass($base, $super, 'ParasiteBlood', $ParasiteBlood);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ParasiteBlood_gameName_1, TMP_ParasiteBlood_gameType_2, TMP_ParasiteBlood_getHelpMessage_3, TMP_ParasiteBlood_get_urge_4, TMP_ParasiteBlood_get_pb_urge_table_5, TMP_ParasiteBlood_get_pb_normal_urge_table_6, TMP_ParasiteBlood_get_pb_aas_urge_table_7;

    
    self.$setPrefixes(["(N|A|M|U|C|)?URGE\\d+"]);
    
    Opal.defn(self, '$gameName', TMP_ParasiteBlood_gameName_1 = function $$gameName() {
      var self = this;

      return "パラサイトブラッド"
    }, TMP_ParasiteBlood_gameName_1.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_ParasiteBlood_gameType_2 = function $$gameType() {
      var self = this;

      return "ParasiteBlood"
    }, TMP_ParasiteBlood_gameType_2.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_ParasiteBlood_getHelpMessage_3 = function $$getHelpMessage() {
      var self = this;

      return "" + "・衝動表　(URGEx)\n" + "　\"URGE衝動レベル\"の形で指定します。\n" + "　衝動表に従って自動で骰子ロールを行い、結果を表示します。\n" + "　骰子ロールと同様に、他の玩家に隠れてロールすることも可能です。\n" + "　頭に識別文字を追加して、デフォルト以外の衝動表もロールできます。\n" + "　・AURGEx　頭に「A」を付けると「誤作動表」。\n" + "例）URGE1　　　urge5　　　Aurge2\n" + "・D66骰子あり\n"
    }, TMP_ParasiteBlood_getHelpMessage_3.$$arity = 0);
    
    Opal.defn(self, '$get_urge', TMP_ParasiteBlood_get_urge_4 = function $$get_urge(string) {
      ...
      return output;
    }, TMP_ParasiteBlood_get_urge_4.$$arity = 1);
    
    Opal.defn(self, '$get_pb_urge_table', TMP_ParasiteBlood_get_pb_urge_table_5 = function $$get_pb_urge_table(level, dice, urge_type) {
    ...
    }, TMP_ParasiteBlood_get_pb_urge_table_5.$$arity = 3);
    
    Opal.defn(self, '$get_pb_normal_urge_table', TMP_ParasiteBlood_get_pb_normal_urge_table_6 = function $$get_pb_normal_urge_table() {
      var self = this;
    ...
    }, TMP_ParasiteBlood_get_pb_normal_urge_table_6.$$arity = 0);
    return (Opal.defn(self, '$get_pb_aas_urge_table', TMP_ParasiteBlood_get_pb_aas_urge_table_7 = function $$get_pb_aas_urge_table() {
      var self = this;
    ...
    }, TMP_ParasiteBlood_get_pb_aas_urge_table_7.$$arity = 0), nil) && 'get_pb_aas_urge_table';
  })($nesting[0], Opal.const_get_relative($nesting, 'DemonParasite'), $nesting);
})(Opal);
