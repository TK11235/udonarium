...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      if ((($a = /(\d+)AV(\d+)((x|\*)(\d+))?(\+(\d+))?(C(\d+))?$/i['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        diceCount = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
        target = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
        damage = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](5))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
        criticalTrigger = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](7))) !== false && $a !== nil && $a != null) ? $a : 0)).$to_i();
        criticalNumber = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](9))) !== false && $a !== nil && $a != null) ? $a : 1)).$to_i();
        if ((($a = ($rb_gt(criticalNumber, 3))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          criticalNumber = 2};
