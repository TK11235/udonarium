...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_11, TMP_12, TMP_13, TMP_15, TMP_17, TMP_19, TMP_21, TMP_22, TMP_23;
    ...
    Opal.defn(self, '$checkRoll', TMP_6 = function $$checkRoll(string) {
      ...
      if ((($a = (/^(\d+)R>=(\d+)(\[(\d+)?(,|,\d+)?(,\d+(S)?)?\])?$/i['$=~'](string))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return ""
      };
      ...
      if ((($a = ($rb_gt(target, 12))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        while ((($b = ($rb_gt(target, 12))) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        target = $rb_minus(target, 1);
        fumble = $rb_plus(fumble, 1);};};
      if ((($a = (((($b = $rb_lt(critical, 1)) !== false && $b !== nil && $b != null) ? $b : $rb_gt(critical, 12)))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        critical = 13};
      if ((($a = ($rb_ge(fumble, 6))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      if ((($a = ((($b = isCritical !== false && isCritical !== nil && isCritical != null) ? $rb_gt(total_suc, 0) : isCritical))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = $rb_plus(result, " ＞ 必殺発動可能！")};
      self.$debug("checkRoll result result", result);
      return result;
    }, TMP_6.$$arity = 1);

    Opal.defn(self, '$getRollParams', TMP_7 = function $$getRollParams(params) {
      var $a, $b, self = this, min_suc = nil, fumble = nil, critical = nil, isCriticalStop = nil;

      min_suc = 0;
      fumble = 1;
      critical = 13;
      isCriticalStop = false;
      if ((($a = (params['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      } else if ((($a = (/\[(\d*)(,(\d*)?)?(,(\d*)(S)?)?\]/['$=~'](params))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        min_suc = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
        if ((($a = ((($b = $gvars['~']) === nil ? nil : $b['$[]'](3)).$to_i()['$!='](0))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$getJudgeInfo', TMP_8 = function $$getJudgeInfo(target, fumble, critical) {
      var self = this;

      return "【難易度" + (target) + "、ファンブル率" + (fumble) + (self.$getcriticalString(critical)) + "】";
    }, TMP_8.$$arity = 3);

    Opal.defn(self, '$getcriticalString', TMP_9 = function $$getcriticalString(critical) {
    ...
    Opal.defn(self, '$checkRollLoop', TMP_11 = function $$checkRollLoop(roll_times, min_suc, target, critical, fumble, isCriticalStop) {
      var $a, $b, TMP_10, self = this, dice_str = nil, isFumble = nil, isCritical = nil, total_suc = nil;

      dice_str = "";
      isFumble = false;
      isCritical = false;
      total_suc = 0;
      (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = roll_times).$times, $a.$$p = (TMP_10 = function(i){var self = TMP_10.$$s || this, $c, $d, d1 = nil, d2 = nil, dice_suc = nil;
if (i == null) i = nil;
      self.$debug("roll_times", roll_times);
        self.$debug("min_suc, total_suc", min_suc, total_suc);
        if ((($c = (min_suc['$!='](0))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          if ((($c = ($rb_ge(total_suc, min_suc))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            self.$debug("(total_suc >= min_suc) break");
            
            Opal.brk(nil, $brk);}};
        $d = self.$roll(1, 6), $c = Opal.to_ary($d), d1 = ($c[0] == null ? nil : $c[0]), $d;
        $d = self.$roll(1, 6), $c = Opal.to_ary($d), d2 = ($c[0] == null ? nil : $c[0]), $d;
        dice_suc = 0;
        if ((($c = ($rb_le(target, ($rb_plus(d1, d2))))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          dice_suc = 1};
        if ((($c = (dice_str['$empty?']())) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          } else {
          dice_str = $rb_plus(dice_str, "+")
        };
        dice_str = $rb_plus(dice_str, "" + (dice_suc) + "[" + (d1) + "," + (d2) + "]");
        total_suc = $rb_plus(total_suc, dice_suc);
        if ((($c = ($rb_le(critical, $rb_plus(d1, d2)))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          isCritical = true;
          dice_str = $rb_plus(dice_str, "『必殺！』");};
        if ((($c = (($d = (d1['$=='](d2)), $d !== false && $d !== nil && $d != null ?($rb_le(d1, fumble)) : $d))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          isFumble = true;
          isCritical = false;
          
          Opal.brk(nil, $brk);};
        if ((($c = ((($d = isCritical !== false && isCritical !== nil && isCritical != null) ? isCriticalStop : isCritical))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          
          Opal.brk(nil, $brk)
          } else {
          return nil
        };}, TMP_10.$$s = self, TMP_10.$$brk = $brk, TMP_10.$$arity = 1, TMP_10), $a).call($b)
      } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
      return [dice_str, total_suc, isCritical, isFumble];
    }, TMP_11.$$arity = 6);

    Opal.defn(self, '$check_seigou', TMP_12 = function $$check_seigou(string) {
      ...
      if ((($a = (/^SR(\d+)(([+]|[-])(\d+))?$/i['$=~'](string))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return ""
      };
      ...
      modify = 0;
      if ((($a = (operator['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        if ((($a = (operator['$==']("+"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          modify = value};
        if ((($a = (operator['$==']("-"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      seigou = "";
      if ((($a = ($rb_lt(target, diceTotal))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        seigou = "「激」"};
      if ((($a = (target['$=='](diceTotal))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        seigou = "「迷」"};
      if ((($a = ($rb_gt(target, diceTotal))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        seigou = "「律」"};
      result = "〔性業値〕" + (target) + "、「修正値」" + (modify) + " ＞ ダイス結果：（" + (dice) + "） ＞ " + (dice) + "＋（" + (modify) + "）＝" + (diceTotal) + " ＞ " + (seigou);
      if ((($a = (dice['$=='](2))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = $rb_plus(result, " ＞ 1ゾロのため〔性業値〕が1点上昇！")};
      if ((($a = (dice['$=='](12))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = $rb_plus(result, " ＞ 6ゾロのため〔性業値〕が1点減少！")};
      self.$debug("check_seigou result result", result);
      return result;
    }, TMP_12.$$arity = 1);

    Opal.defn(self, '$rollTableCommand', TMP_13 = function $$rollTableCommand(command) {
      var $a, $b, self = this, result = nil, counts = nil, operator = nil, value = nil, $case = nil;

      command = command.$upcase();
      result = [];
      if ((($a = (/([A-Za-z]+)(\d+)?(([+]|[-]|[=])(\d+))?/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return result
      };
      ...
      $case = command;if ("TAGT"['$===']($case)) {result = self.$getTagTableResult(counts)}else if ("GETSST"['$===']($case)) {result = self.$getCreateSatasupeResult(counts)}else if ("NPCT"['$===']($case)) {result = self.$getNpcTableResult(counts)}else {result = self.$getAnotherTableResult(command, counts, operator, value)};
      return result.$join("\n");
    }, TMP_13.$$arity = 1);

    Opal.defn(self, '$getTagTableResult', TMP_15 = function $$getTagTableResult(counts) {
      var $a, $b, TMP_14, self = this, name = nil, table = nil, result = nil;
      ...
      result = [];
      ($a = ($b = counts).$times, $a.$$p = (TMP_14 = function(i){var self = TMP_14.$$s || this, $c, $d, info = nil, number = nil, text = nil;
if (i == null) i = nil;
      $d = self.$get_table_by_d66(table), $c = Opal.to_ary($d), info = ($c[0] == null ? nil : $c[0]), number = ($c[1] == null ? nil : $c[1]), $d;
        text = "" + (name) + ":" + (number) + ":" + (info);
        return result.$push(text);}, TMP_14.$$s = self, TMP_14.$$arity = 1, TMP_14), $a).call($b);
      return result;
    }, TMP_15.$$arity = 1);

    Opal.defn(self, '$getCreateSatasupeResult', TMP_17 = function $$getCreateSatasupeResult(counts) {
      ...
      $case = number1;if ((1)['$===']($case)) {baseParts = $rb_plus(baseParts, "「紙製の筒」");
      partsEffect = $rb_plus(partsEffect, "「命中：10、ダメージ：3、耐久度1」");
      hit = 10;
      damage = 3;
      life = 1;}else if ((2)['$===']($case)) {baseParts = $rb_plus(baseParts, "「木製の筒」");
      partsEffect = $rb_plus(partsEffect, "「命中：9、ダメージ：3、耐久度2」");
      hit = 9;
      damage = 3;
      life = 2;}else if ((3)['$===']($case)) {baseParts = $rb_plus(baseParts, "「小型のプラスチック製の筒」");
      partsEffect = $rb_plus(partsEffect, "「命中：9、ダメージ：4、耐久度2」");
      hit = 9;
      damage = 4;
      life = 2;}else if ((4)['$===']($case)) {baseParts = $rb_plus(baseParts, "「大型のプラスチック製の筒」");
      partsEffect = $rb_plus(partsEffect, "「命中：8、ダメージ：3、耐久度2、両手」");
      hit = 8;
      damage = 3;
      life = 2;
      abilities['$<<']("「両手」");}else if ((5)['$===']($case)) {baseParts = $rb_plus(baseParts, "「小型の金属製の筒」");
      partsEffect = $rb_plus(partsEffect, "「命中：9、ダメージ：4、耐久度3」");
      hit = 9;
      damage = 4;
      life = 3;}else if ((6)['$===']($case)) {baseParts = $rb_plus(baseParts, "「大型の金属製の筒」");
      ...
      ($a = ($b = counts).$times, $a.$$p = (TMP_16 = function(i){var self = TMP_16.$$s || this, $c, $d, number2 = nil;
if (i == null) i = nil;
      number2 = self.$d66(2);
    ...
    Opal.defn(self, '$getNpcTableResult', TMP_19 = function $$getNpcTableResult(counts) {
      var $a, $b, TMP_18, self = this, lmood = nil, lage = nil, age = nil, agen = nil, name = nil, result = nil;
      ...
      name = "NPC表:";
      result = [];
      ($a = ($b = counts).$times, $a.$$p = (TMP_18 = function(i){var self = TMP_18.$$s || this, $c, $d, age_type = nil, dummy = nil, agen_text = nil, age_num = nil, total = nil, ysold = nil, lmodValue = nil, lageValue = nil, text = nil;
if (i == null) i = nil;
      $d = self.$roll(1, 6), $c = Opal.to_ary($d), age_type = ($c[0] == null ? nil : $c[0]), dummy = ($c[1] == null ? nil : $c[1]), $d;
        age_type = $rb_minus(age_type, 1);
        agen_text = agen['$[]'](age_type);
        age_num = agen_text.$split(/\+/);
        $d = self.$rollDiceAddingUp(age_num['$[]'](1)), $c = Opal.to_ary($d), total = ($c[0] == null ? nil : $c[0]), dummy = ($c[1] == null ? nil : $c[1]), $d;
        ...
        return result.$push(text);}, TMP_18.$$s = self, TMP_18.$$arity = 1, TMP_18), $a).call($b);
      return result;
    }, TMP_19.$$arity = 1);

    Opal.defn(self, '$getAnotherTableResult', TMP_21 = function $$getAnotherTableResult(command, counts, operator, value) {
      ...
      if ((($a = (name['$empty?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return result};
      ($a = ($b = counts).$times, $a.$$p = (TMP_20 = function(i){var self = TMP_20.$$s || this, $c, $d, _ = nil, index = nil, info = nil, text = nil;
if (i == null) i = nil;
      $d = self.$getTableIndex(operator, value, 2, 6), $c = Opal.to_ary($d), _ = ($c[0] == null ? nil : $c[0]), index = ($c[1] == null ? nil : $c[1]), $d;
        ...
        return result.$push(text);}, TMP_20.$$s = self, TMP_20.$$arity = 1, TMP_20), $a).call($b);
      return result;
    }, TMP_21.$$arity = 4);

    Opal.defn(self, '$getTableIndex', TMP_22 = function $$getTableIndex(operator, value, diceCount, diceType) {
      var $a, $b, self = this, index = nil, modify = nil, $case = nil;

      index = nil;
      modify = 0;
      $case = operator;if ("+"['$===']($case)) {modify = value}else if ("-"['$===']($case)) {modify = $rb_times(value, (-1))}else if ("="['$===']($case)) {index = value};
    ...
    return (Opal.defn(self, '$get2d6TableInfo', TMP_23 = function $$get2d6TableInfo(command) {
      ...
      return [name, table];
    }, TMP_23.$$arity = 1), nil) && 'get2d6TableInfo';
