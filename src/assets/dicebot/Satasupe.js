...
if (_i == null) _i = nil;
    ...
    return (Opal.defn(self, '$get2d6TableInfo', TMP_Satasupe_get2d6TableInfo_23 = function $$get2d6TableInfo(command) {
      ...
      name = "報酬・奇天烈表:";
      table = ["好きな盟約おたから１個（玩家全員で相談して決定）", "《気球》（基本76p、乗物）", "《チェインソー》（基本74p、武器）", "誰かから感謝される。それだけ？", "持ち主の〔趣味〕からランダムに１種類選ぶ。その趣味おたからを１個ランダムに選ぶ。", "何もなかった（涙）。残念でした。", "持ち主と同じタイプの汎用おたから（基本82p、汎用おたから）", "《フォークリフト》（基本76p、乗物）", "《RPG-7》（基本74p、武器）", "倒された角色は、致命傷表を振り、まだ生きていれば、その角色を倒した者のトリコになる。", "「先にイッてるぜ」その角色１体を倒した者に経験点が１点与えられる。"];};
      return [name, table];
