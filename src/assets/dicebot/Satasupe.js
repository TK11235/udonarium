...
if (_i == null) _i = nil;
    ...
    return (Opal.defn(self, '$get2d6TableInfo', TMP_Satasupe_get2d6TableInfo_23 = function $$get2d6TableInfo(command) {
      ...
      name = "汎用アクシデント表:";
      table = ["痛恨のミス。激しく状況が悪化する。以降のケチャップに関する行為判定の難易度に＋１の修正がつき、あなたが追う側なら逃げる側のコマを２マス進める（逃げる側なら自分を２マス戻す）", "最悪の大事故。ケチャップどころではない！　〔犯罪〕で難易度９の判定を行う。失敗したら、ムーブ判定を行った角色は3D6点のダメージを受け、ケチャップから脱落する。判定に成功すればギリギリ難を逃れる。特に何もなし。", "もうダメだ……。絶望感が襲いかかってくる。後３ラウンド以内にケリをつけないと、あなたが追う側なら自動的に逃げる側が勝利する（逃げる側なら追う側が勝利する）", "まずい、突発事故だ！　ムーブ判定を行った角色は、1D6点のダメージを受ける。", "一瞬ひやりと緊張が走る。　ムーブ判定を行った角色は、〔精神点〕を２点減少する。", "スランプ！　思わず足踏みしてしまう。ムーブ判定を行った者は、ムーブ判定に使用した能力値を使って難易度７の判定を行うこと。失敗したら、ムーブ判定を行った角色は、ケチャップから脱落。成功しても、あなたが追う側なら逃げる側のコマを１マス進める（逃げる側なら自分を１マス戻す）", "イマイチ集中できない。〔性業値〕判定を行うこと。「激」になると、思わず見とれてしまう。あなたが追う側なら逃げる側のコマを１マス進める（逃げる側なら自分を１マス戻す）", "古傷が痛み出す。以降のケチャップに関する行為判定に修正が＋１つく", "うっかり持ち物を見失う。〔通常装備〕欄からアイテムを１個選んで消す", "苦しい状態に追い込まれた。ムーブ判定を行った角色は、今後のムーブ判定で成功度が－１される。", "頭の中が真っ白になる。〔精神点〕を1D6減少する。"];}
      else if (/R(omance)?F(umble)?T/i['$===']($case)) {
      name = "ロマンスファンブル表:";
      table = ["みんなあいそをつかす。自分のトリコ欄の角色の名前をすべて消すこと", "痴漢として通報される。〔犯罪〕の難易度９の判定に成功しない限り、1D6ターン後に検挙されてしまう", "へんにつきまとわれる。対象は、トリコになるが、ファンブル表の結果やトリコと分かれる判定に成功しない限り、常備化しなくてもトリコ欄から消えることはない", "修羅場！　対象とは別にトリコを所有していれば、その角色が現れ、あなたと対象に血戦をしかけてくる", "恋に疲れる。自分の〔精神点〕が1D6点減少する", "甘い罠。あなたが対象のトリコになってしまう", "平手うち！　自分の〔肉体点〕が1D6点減少する", "浮気がばれる。恋人関係にあるトリコがいれば、その角色の名前をあなたのトリコ欄から消す", "無礼な失言をしてしまう。対象はあなたに対し「憎悪（p.120参照）」の反応を抱き、あなたはその対象の名前を書き込んだ【仇敵】の代償を得る", "ショックな一言。トラウマを１点受ける", "トリコからの監視！　このセッションの間、ロマンス判定のファンブル率が自分のトリコの所持数と同じだけ上昇する"];}
      else if (/FumbleT/i['$===']($case)) {
      name = "命中判定ファンブル表:";
      table = ["自分の持ち物がすっぽぬけ、偶然敵を直撃！　持っているアイテムを１つ消し、ジオラマ上にいる角色１人をランダムに選ぶ。その角色の〔肉体点〕を1D6ラウンドの間０点にし、行動不能にさせる（致命傷表は使用しない）。1D6ラウンドが経過し、行動不能から回復すると、その角色の〔肉体点〕は、行動不能になる直前の値にまで回復する", "敵の増援！　「三下(p.125）」が1D6体現れて、自分たちに襲いかかってくる（DDは、この処理が面倒だと思ったら、ファンブルした角色の〔肉体点〕を1D6点減少させてもよい）", "お前のいるマスに「障害物」が出現！　そのマスに障害物オブジェクトを置き、そのマスにいた角色は全員２ダメージを受ける（セーブ不可）", "射撃武器を使っていれば、弾切れを起こす。準備行動を行わないとその武器はもう使えない", "転んでしまう。準備行動を行わないと移動フェイズに行動できず、格闘、射撃、突撃攻撃が行えない", "急に命が惜しくなる。性業値判定をすること。「激」なら戦闘を続行。「律」なら次のラウンドから全力移動を行い、ジオラマから逃走を試みる。「迷」なら次のラウンドは移動・攻撃フェイズに行動できない", "誤って別の目標を攻撃。目標以外であなたに一番近い角色に４ダメージ（セーブ不可）！", "誤って自分を攻撃。３ダメージ（セーブ不可）！", "今使っている武器が壊れる。アイテム欄から使用中の武器を消すこと。銃器を使っていた場合、暴発して自分に６ダメージ！　武器なしの場合、体を傷つけ３ダメージ（共にセーブ不可）！", "「制服警官(p.129）」が１人現れる。その場にいる角色をランダムに攻撃する", "最悪の事態。〔肉体点〕を０にして、その角色は行動不能に（致命傷表は使用しない）"];}
      ...
      name = "その後表:";
      table = ["ここらが潮時かもしれない。2D6を振り、その目が自分の修得している代償未満であれば、その角色は引退し、二度と使用できない", "苦労の数だけ喜びもある。2D6を振り、自分の代償の数以下の目を出した場合、経験点が追加で１点もらえる", "妙な恨みを買ってしまった。【仇敵】（p.95）を修得する。誰が【仇敵】になるかは、DDが今回登場したNPCの中から１人を選ぶ", "大物の覚えがめでたい。今回のセッションに登場した盟約へ入るための条件を満たしていれば、その盟約に経験点の消費なしで入ることができる", "思わず意気投合。今回登場したNPC１人を選び、その角色との【コネ】（p.95）を修得する", "今回の事件で様々な教訓を得る。自分の修得しているアドバンスドカルマの中から、汎用以外のものを好きなだけ選ぶ。そのカルマの異能と代償を、別な異能と代償に変更することができる", "深まるチームの絆。今回のセッションでミッションが成功していた場合、【絆】（p.95）を修得する", "色々な運命を感じる。今回のセッションでトリコができていた場合、経験点の消費なしにそのトリコを常備化することができる。また、自分が誰かのトリコになっていた場合、その人物への【トリコ】(p.95）の代償を得る", "やっぱり亜侠も楽じゃないかも。今回のセッションで何かツラい目にあっていた場合、【日常】（p.95）を取得する", "くそっ！　ここから出せ！！　今回のセッションで逮捕されていたら、【前科】(p.95）の代償を得る", "〔性業値〕が１以下、もしくは１３以上だった場合、その角色は大阪の闇に消える。その角色は引退し、二度と使用できない"];}
      else if (/KusaiMT/i['$===']($case)) {
      name = "臭い飯表:";
      table = ["やあ署長、ご苦労さん。いつでも好きなときに留置所を出ることができる。", "軽い取り調べを受ける。次の１ターンが終了するまで、未行動にならない。", "荒っぽい取り調べを受ける。次の１ターンが終了するまで、未行動にならない。１ターン休み。1D6ダメージを受ける（セーブ不可）。", "一晩泊まっていきなさい。次の日の朝まで未行動にならない。", "粘り強い取り調べが続く。1D6日後の朝まで未行動にならない。", "留置所のトイレで陵辱を受ける。1D6日後の朝まで未行動にならない。トラウマを１点受ける。", "劣悪な環境のせいで伝染病にかかる。1D6日後の朝まで未行動にならない。【病弱】の代償を得る。", "精神異常を訴え、無罪に。しかし、アーカム・アサイレムに移送され、1D6回別の角色でセッションを行うまで、その角色を使用できない。キジルシの代償の中から、ランダムに１つの代償を得る。", "起訴されて有罪に。海上刑務所行き。1D6回別の角色でセッションを行うまで、その角色を使用できない。【前科】の代償を得る。", "起訴されて有罪に。海上刑務所行き。2D6回別の角色でセッションを行うまで、その角色を使用できない。【前科】の代償を得る。", "起訴されて有罪に。海上刑務所行き。終身刑。その角色は引退する。"];}
      else if (/EnterT/i['$===']($case)) {
      name = "登場表:";
      table = ["「こっから先にはいかせないぜ」　【仇敵】がいれば現われ、血戦が始まる。現在の血戦、もしくはケチャップが終了したら、処理を行うこと。", "「待たせたな、みんな！」　ジオラマの好きな場所に自分の角色を配置する。", "おっと、鉢合わせ。ランダムにジオラマ上の敵を１体選ぶ。選んだ敵と同じマスに、その角色を配置する。", "全力ダッシュで駆けつける！　〔肉体点〕を1D6点消費すれば、ジオラマの好きな場所に自分の角色を配置する。そうでなければ、登場できない。", "裏道を歩いていたら、偶然その場所にでくわした。DDはジオラマの好きな場所にその角色を配置する。", "「キキィー！」　もしもその角色が乗物を装備していれば、DDはジオラマの好きな場所にその角色を配置する。そうでなければ、登場できない。", "……間に合ったみたいだな。仲間を１人選び、その角色と同じマスに自分の角色を配置する。", "ラッキー、「ジャリ銭」を拾った。……と、そんな場合じゃないよな。", "をっと、お前の好物だ。〔性業値〕判定を行え。「律」ならもう一回、登場表を振ることができる。それ以外なら、角色を配置できない。", "んー。ここは一度通ったような。疲労から〔精神点〕を2点減少。", "くあー。完全に道に迷っちまった。この実行フェイズには登場できない。"];}
      else if (/BudTT/i['$===']($case)) {
      name = "バッドトリップ表:";
      table = ["自分の身の周りにいる人たちが異様な何か(悪魔、宇宙人、ゾンビ、お前と同じ顔をした誰か…)に変貌し襲い掛かってくる。お前はNPCとなって、同じ場所にいる誰かに血戦をしかける。血戦が終了すれば（そして生きていれば）、視界は元に戻っている。", "世界は一つ。オープンソース。愛で結びつくべきなんだ。お前は自分の知っていることをペラペラと話だし、1D6ターンの間、聞かれれば知っていることを何でも話してしまう。", "自分と他人の区別がつかなくなり、現実感が薄れる。〔精神点〕を1D6点減少する。", "誰かが自分を殺そうと企んでいるような錯覚を覚える。1D6ターンの間、ペテン師の代償【疑心暗鬼】を修得する。", "風景が極彩色に彩られる！もっと……もっと極彩色に！もし他にも「麻薬」カテゴリのアイテムを持っていれば、その中の１個を使用する（行動は使わない）。", "目の前にいる人物が非常にいとおしく思えてくる。同じ場所にいる角色の中からランダムに１人選ぶ。1D6ターンの間、その角色のトリコになる。", "魅力的な裸の異性が、あなたの目の前で誘惑する幻覚を見る。〔性業値〕判定を行う。「激」になると服を脱ぎだす。もしも外にいればそのエリアの〔治安〕の難易度の〔犯罪〕判定を行う。失敗すると「臭い飯」表を振る。", "お前は痛みを感じなくなる。1D6ターンの間、〔肉体点〕の重症のペナルティが無効化される。", "自分の持っているものから触手が生え、あなたにからみつく。自分の〔通常装備〕欄のアイテムの中からランダムに１種を選ぶ。それを捨てる。", "皮膚の中を無数の蟲が蠢いているのを感じる。〔肉体点〕を３点減少する。", "神々しい声が聞こえてくる。1D6ターンの間、自分の好きな能力値を１点上昇することができる。"];}
