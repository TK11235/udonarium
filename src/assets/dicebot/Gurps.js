...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$==', '$-', '$<=', '$>=', '$getRollDiceResult', '$nil?', '$getCFTableResult', '$getFearResult', '$getReactResult', '$getHitResult', '$===', '$roll', '$sort', '$collect', '$to_i', '$split', '$size', '$select', '$getValue', '$+', '$check_nD6', '$get_table_by_nD6', '$>', '$[]', '$<', '$empty?', '$parren_killer']);
  return (function($base, $super) {
    function $Gurps(){};
    var self = $Gurps = $klass($base, $super, 'Gurps', $Gurps);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15;
    ...
    Opal.defn(self, '$check_nD6', TMP_5 = function $$check_nD6(total_n, dice_n, signOfInequality, diff, dice_cnt, dice_max, n1, n_max) {
      var $a, $b, self = this, success = nil, crt_string = nil, fmb_string = nil, fail_string = nil;

      if ((($a = ((($b = dice_cnt['$=='](3)) ? signOfInequality['$==']("<=") : dice_cnt['$=='](3)))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return ""
      };
      ...
      if ((($a = (($b = ($rb_le(dice_n, 6)), $b !== false && $b !== nil && $b != null ?($rb_ge(diff, 16)) : $b))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return crt_string
      } else if ((($a = (($b = ($rb_le(dice_n, 5)), $b !== false && $b !== nil && $b != null ?($rb_ge(diff, 15)) : $b))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return crt_string
      } else if ((($a = ($rb_le(dice_n, 4))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return crt_string};
      if ((($a = ($rb_le(($rb_minus(diff, dice_n)), -10))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return fmb_string
      } else if ((($a = (($b = ($rb_ge(dice_n, 17)), $b !== false && $b !== nil && $b != null ?($rb_le(diff, 15)) : $b))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return fmb_string
      } else if ((($a = ($rb_ge(dice_n, 18))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return fmb_string
      } else if ((($a = ($rb_ge(dice_n, 17))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return fail_string};
    ...
    Opal.defn(self, '$getRollDiceResult', TMP_10 = function $$getRollDiceResult(command) {
      var $a, $b, TMP_7, $c, TMP_8, $d, TMP_9, self = this, diffStr = nil, modStr = nil, dice_cnt = nil, dice_max = nil, dice_n = nil, dice_str = nil, diceList = nil, n1 = nil, n_max = nil, diff = nil, total_n = nil, signOfInequality = nil, result = nil;

      if ((($a = (/([\d\+\-]+)\-3[dD]6?([\d\+\-]*)/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      diffStr = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      modStr = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](2))) !== false && $a !== nil && $a != null) ? $a : ""));
      dice_cnt = 3;
      dice_max = 6;
...
if (i == null) i = nil;
      ...
      n1 = ($a = ($c = diceList).$select, $a.$$p = (TMP_8 = function(i){var self = TMP_8.$$s || this;
if (i == null) i = nil;
      return i['$=='](1)}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8), $a).call($c).$size();
      n_max = ($a = ($d = diceList).$select, $a.$$p = (TMP_9 = function(i){var self = TMP_9.$$s || this;
if (i == null) i = nil;
      return i['$=='](dice_max)}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9), $a).call($d).$size();
    ...
    Opal.defn(self, '$getFearResult', TMP_12 = function $$getFearResult(command) {
      var $a, $b, self = this, modify = nil, tableName = nil, table = nil, dice = nil, dummy = nil, number = nil, num = nil, result = nil;

      if ((($a = (/FEAR((\+)?\d+)?/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      ...
      if ((($a = ($rb_gt(number, 40))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        num = 36
        } else {
    ...
    Opal.defn(self, '$getReactResult', TMP_13 = function $$getReactResult(command) {
      var $a, $b, self = this, modify = nil, tableName = nil, dice = nil, dummy = nil, number = nil, result = nil;

      if ((($a = (/REACT((\+|\-)?\d*)/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      modify = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
      ...
      $b = self.$roll(3, 6), $a = Opal.to_ary($b), dice = ($a[0] == null ? nil : $a[0]), dummy = ($a[1] == null ? nil : $a[1]), $b;
      number = $rb_plus(dice, modify);
      if ((($a = ($rb_lt(number, 1))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = "最悪"
      } else if ((($a = ($rb_lt(number, 4))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = "とても悪い"
      } else if ((($a = ($rb_lt(number, 7))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = "悪い"
      } else if ((($a = ($rb_lt(number, 10))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = "良くない"
      } else if ((($a = ($rb_lt(number, 13))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = "中立"
      } else if ((($a = ($rb_lt(number, 16))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = "良い"
      } else if ((($a = ($rb_lt(number, 19))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = "とても良い"
        } else {
        result = "最高"
      };
    ...
    Opal.defn(self, '$getHitResult', TMP_14 = function $$getHitResult(command) {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      if ((($a = ("HIT"['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      tableName = "命中部位表";
    ...
    return (Opal.defn(self, '$getValue', TMP_15 = function $$getValue(text, defaultValue) {
      var $a, $b, self = this;
