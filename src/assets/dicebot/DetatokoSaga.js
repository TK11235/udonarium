...
if (i == null) i = nil;
    ...
    Opal.defn(self, '$getTotalResultValue', TMP_14 = function $$getTotalResultValue(total, value, operator) {
      ...
      return (function() {$case = operator;if ("+"['$===']($case)) {return "" + (total) + "+" + (value) + " ＞ 判定値：" + ($rb_plus(total, value))}else if ("-"['$===']($case)) {return "" + (total) + "-" + (value) + " ＞ 判定値：" + ($rb_minus(total, value))}else if ("/"['$===']($case)) {return self.$getTotalResultValueWhenSlash(total, value)}else {return "判定値：" + (total)}})();
    }, TMP_14.$$arity = 3);
