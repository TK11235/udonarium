...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$checkRoll', '$nil?', '$===', '$==', '$getLotResult', '$getSpecialResult', '$to_i', '$getCookResult', '$getTrapResult', '$getTresureResult', '$getRandomEventResult', '$getRandomEnemyDataResult', '$getRandomOptionResult', '$getValue', '$roll', '$+', '$<=', '$>=', '$-', '$empty?', '$parren_killer', '$first', '$<', '$last', '$>', '$get_table_by_1d6', '$lambda', '$cook', '$name', '$class', '$[]', '$normal', '$premium', '$get_table_by_nD6', '$get_table_by_d66', '$/', '$get_table_by_number']);
  return (function($base, $super) {
    function $FilledWith(){};
    var self = $FilledWith = $klass($base, $super, 'FilledWith', $FilledWith);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_27, TMP_46, TMP_47, TMP_48, TMP_49, TMP_50, TMP_51;
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      text = "";
      number = 0;
      $case = command;if (/LOT(N|P)/['$===']($case)) {type = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      if ((($a = (type['$==']("P"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        tableName = "ナンバーワンプレミアムくじ"
        } else {
        tableName = "ナンバーワンノーマルくじ"
      };
      $b = self.$getLotResult(type), $a = Opal.to_ary($b), result = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $b;}else if ("HST"['$===']($case)) {tableName = "【必殺技！】";
      $b = self.$getSpecialResult(), $a = Opal.to_ary($b), result = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $b;}else if (/COOK([1-8])/['$===']($case)) {lv = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
      tableName = "マジカルクッキング";
      $b = self.$getCookResult(lv), $a = Opal.to_ary($b), result = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $b;}else if (/TRAP[ENHL]/['$===']($case)) {return self.$getTrapResult(command)}else if (/TRS.*/i['$===']($case)) {return self.$getTresureResult(command)}else if (/RAND.*/['$===']($case)) {return self.$getRandomEventResult(command)}else if (/RENC.*/['$===']($case)) {return self.$getRandomEventResult(command)}else if (/RED.*/i['$===']($case)) {return self.$getRandomEnemyDataResult(command)}else if (/ROP[ENHL]/['$===']($case)) {return self.$getRandomOptionResult(command)}else {return nil};
      text = "" + (tableName) + "(" + (number) + "):" + (result);
      return text;
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$checkRoll', TMP_6 = function $$checkRoll(command) {
      ...
      crt = 4;
      fmb = 17;
      if ((($a = (/(\d[\+\-\d]*)-(\d+)FW(\@(\d+))?(\#(\d+))?/i['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        difficultyText = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
        diceCount = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
        if ((($a = ((($b = $gvars['~']) === nil ? nil : $b['$[]'](3))['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
      ...
      } else if ((($a = (/(\d+)FW(\@(\d+))?(\#(\d+))?(<=([\+\-\d]*))?/i['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        diceCount = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
        if ((($a = ((($b = $gvars['~']) === nil ? nil : $b['$[]'](2))['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          crt = (($a = $gvars['~']) === nil ? nil : $a['$[]'](3)).$to_i()
        };
        if ((($a = ((($b = $gvars['~']) === nil ? nil : $b['$[]'](4))['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
      ...
      if ((($a = (crt['$=='](4))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        command = $rb_plus(command, "@" + (crt))
      };
      if ((($a = (fmb['$=='](17))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
      ...
      if ((($a = ($rb_le(dice, crt))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = $rb_plus(result, " ＞ クリティカル！")
      } else if ((($a = ($rb_ge(dice, fmb))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = $rb_plus(result, " ＞ ファンブル！")
      } else if ((($a = (difficultyText['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        success = $rb_minus(difficulty, dice);
        if ((($a = ($rb_le(dice, difficulty))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$getValue', TMP_7 = function $$getValue(text, defaultValue) {
      var $a, $b, self = this;

      if ((($a = (((($b = text['$=='](nil)) !== false && $b !== nil && $b != null) ? $b : text['$empty?']()))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return defaultValue};
      return self.$parren_killer($rb_plus($rb_plus("(0", text), ")")).$to_i();
    }, TMP_7.$$arity = 2);

    Opal.defn(self, '$getAdjustNumber', TMP_8 = function $$getAdjustNumber(number, table) {
      var $a, self = this, min = nil, max = nil;

      min = table.$first().$first();
      if ((($a = ($rb_lt(number, min))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return min};
      max = table.$last().$first();
      if ((($a = ($rb_gt(number, max))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return max};
      return number;
    }, TMP_8.$$arity = 2);

    Opal.defn(self, '$getSpecialResult', TMP_9 = function $$getSpecialResult() {
    ...
    Opal.defn(self, '$getCookResult', TMP_27 = function $$getCookResult(lv) {
      var TMP_26, self = this;

      Opal.def(self, '$cook', TMP_26 = function $$cook(lv, num) {try {

        var $a, $b, TMP_10, $c, TMP_11, $d, TMP_12, $e, TMP_13, $f, TMP_14, $g, TMP_15, $h, TMP_16, $i, TMP_17, $j, TMP_18, $k, TMP_19, $l, TMP_20, $m, TMP_21, $n, TMP_22, $o, TMP_23, $p, TMP_24, $q, TMP_25, $r, self = this, $case = nil, table = nil, result = nil, number = nil;

        $case = lv;if ((1)['$===']($case)) {table = ["おべんとミートボール", "パリパリ小魚", "キャロットタルト", "おにぎり", ($a = ($b = self).$lambda, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;

        Opal.ret(self.$cook(2, 5))}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $a).call($b), ($a = ($c = self).$lambda, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

        Opal.ret(self.$cook(2, 6))}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $a).call($c)]}else if ((2)['$===']($case)) {table = ["カリカリミミズ肉", "竹つきチクワ", "トロピカルジュース", "イナリ寿司", ($a = ($d = self).$lambda, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

        Opal.ret(self.$cook(3, 5))}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $a).call($d), ($a = ($e = self).$lambda, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

        Opal.ret(self.$cook(3, 6))}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $a).call($e)]}else if ((3)['$===']($case)) {table = ["ホットミートパイ", "魔界魚の目玉", "パンプキンプリン", "スタミナ丼", ($a = ($f = self).$lambda, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

        Opal.ret(self.$cook(4, 5))}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $a).call($f), ($a = ($g = self).$lambda, $a.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this;

        Opal.ret(self.$cook(4, 6))}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15), $a).call($g)]}else if ((4)['$===']($case)) {table = ["ジャンボ串焼き", "シルヴァまっしぐら", "フラウアイスクリーム", "ピクニックランチ", ($a = ($h = self).$lambda, $a.$$p = (TMP_16 = function(){var self = TMP_16.$$s || this;

        Opal.ret(self.$cook(5, 5))}, TMP_16.$$s = self, TMP_16.$$arity = 0, TMP_16), $a).call($h), ($a = ($i = self).$lambda, $a.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this;

        Opal.ret(self.$cook(5, 6))}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17), $a).call($i)]}else if ((5)['$===']($case)) {table = ["グラント風香草焼き", "エドマエスシ", "スターフルーツパフェ", "具沢山本格カレー", ($a = ($j = self).$lambda, $a.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this;

        Opal.ret(self.$cook(6, 5))}, TMP_18.$$s = self, TMP_18.$$arity = 0, TMP_18), $a).call($j), ($a = ($k = self).$lambda, $a.$$p = (TMP_19 = function(){var self = TMP_19.$$s || this;

        Opal.ret(self.$cook(6, 6))}, TMP_19.$$s = self, TMP_19.$$arity = 0, TMP_19), $a).call($k)]}else if ((6)['$===']($case)) {table = ["ドラゴンステーキ", "刺身盛り合わせ", "エデンのアップルパイ", "フォートレス炒飯", ($a = ($l = self).$lambda, $a.$$p = (TMP_20 = function(){var self = TMP_20.$$s || this;

        Opal.ret(self.$cook(7, 5))}, TMP_20.$$s = self, TMP_20.$$arity = 0, TMP_20), $a).call($l), ($a = ($m = self).$lambda, $a.$$p = (TMP_21 = function(){var self = TMP_21.$$s || this;

        Opal.ret(self.$cook(7, 6))}, TMP_21.$$s = self, TMP_21.$$arity = 0, TMP_21), $a).call($m)]}else if ((7)['$===']($case)) {table = ["マツザカスペシャル", "オオトロスシ", "スノーホワイトボンブ", "よもつへぐい", ($a = ($n = self).$lambda, $a.$$p = (TMP_22 = function(){var self = TMP_22.$$s || this;

        Opal.ret(self.$cook(8, 5))}, TMP_22.$$s = self, TMP_22.$$arity = 0, TMP_22), $a).call($n), ($a = ($o = self).$lambda, $a.$$p = (TMP_23 = function(){var self = TMP_23.$$s || this;

        Opal.ret(self.$cook(8, 6))}, TMP_23.$$s = self, TMP_23.$$arity = 0, TMP_23), $a).call($o)]}else if ((8)['$===']($case)) {table = ["超特大マンガ肉", "特上うな丼", "魔将樹のかき氷", "ヘブンズランチ", ($a = ($p = self).$lambda, $a.$$p = (TMP_24 = function(){var self = TMP_24.$$s || this;

        Opal.ret(self.$cook(9, 5))}, TMP_24.$$s = self, TMP_24.$$arity = 0, TMP_24), $a).call($p), ($a = ($q = self).$lambda, $a.$$p = (TMP_25 = function(){var self = TMP_25.$$s || this;

        Opal.ret(self.$cook(9, 6))}, TMP_25.$$s = self, TMP_25.$$arity = 0, TMP_25), $a).call($q)]}else if ((9)['$===']($case)) {table = ["世界樹のサラダ", "世界樹のサラダ", "世界樹のサラダ", "黄金のラダマン鍋", "黄金のラダマン鍋", "黄金のラダマン鍋"]};
        $r = self.$get_table_by_1d6(table), $a = Opal.to_ary($r), result = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $r;
        if ((($a = (result.$class().$name()['$==']("Array"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          number = result['$[]'](1);
          result = result['$[]'](0);};
        number = "" + (num) + (number);
    ...
    Opal.defn(self, '$getLotResult', TMP_46 = function $$getLotResult(type) {
      var TMP_36, TMP_45, $a, self = this;

      Opal.def(self, '$normal', TMP_36 = function $$normal(phase, num) {try {

        var $a, $b, TMP_28, $c, TMP_29, $d, TMP_30, $e, TMP_31, $f, TMP_32, $g, TMP_33, $h, TMP_34, $i, TMP_35, $j, self = this, $case = nil, table = nil, result = nil, number = nil;

        $case = phase;if ((1)['$===']($case)) {table = ["イレブンチキン", "イレブンチキン", "イレブンチキン", ($a = ($b = self).$lambda, $a.$$p = (TMP_28 = function(){var self = TMP_28.$$s || this;

        Opal.ret(self.$normal(2, 4))}, TMP_28.$$s = self, TMP_28.$$arity = 0, TMP_28), $a).call($b), ($a = ($c = self).$lambda, $a.$$p = (TMP_29 = function(){var self = TMP_29.$$s || this;

        Opal.ret(self.$normal(2, 5))}, TMP_29.$$s = self, TMP_29.$$arity = 0, TMP_29), $a).call($c), ($a = ($d = self).$lambda, $a.$$p = (TMP_30 = function(){var self = TMP_30.$$s || this;

        Opal.ret(self.$normal(3, 6))}, TMP_30.$$s = self, TMP_30.$$arity = 0, TMP_30), $a).call($d)]}else if ((2)['$===']($case)) {table = ["バロールたわし", "イグニスジッポ", "ヤコ仮面or梟の文鎮(選択可)", "ナレッジのハンモックorジンジャビースト", ($a = ($e = self).$lambda, $a.$$p = (TMP_31 = function(){var self = TMP_31.$$s || this;

        Opal.ret(self.$normal(3, 5))}, TMP_31.$$s = self, TMP_31.$$arity = 0, TMP_31), $a).call($e), ($a = ($f = self).$lambda, $a.$$p = (TMP_32 = function(){var self = TMP_32.$$s || this;

        Opal.ret(self.$normal(3, 6))}, TMP_32.$$s = self, TMP_32.$$arity = 0, TMP_32), $a).call($f)]}else if ((3)['$===']($case)) {table = ["特性HPポーション", "特性MPポーション", "黒い甲冑", "天体望遠鏡", "金獅子の剥製", ($a = ($g = self).$lambda, $a.$$p = (TMP_33 = function(){var self = TMP_33.$$s || this;

        Opal.ret(self.$normal(4, 6))}, TMP_33.$$s = self, TMP_33.$$arity = 0, TMP_33), $a).call($g)]}else if ((4)['$===']($case)) {table = ["特性スタミナポーション", "戦乙女の兜", "フェンリルの首輪", "フェニックスカーペット", "動くアダマンゴーレム", ($a = ($h = self).$lambda, $a.$$p = (TMP_34 = function(){var self = TMP_34.$$s || this;

        Opal.ret(self.$normal(5, 6))}, TMP_34.$$s = self, TMP_34.$$arity = 0, TMP_34), $a).call($h)]}else if ((5)['$===']($case)) {table = ["キャンディークッション", "屑鉄の金床", "薪割り王の斧", "ロジエの水差し", "箱舟の模型", ($a = ($i = self).$lambda, $a.$$p = (TMP_35 = function(){var self = TMP_35.$$s || this;

        Opal.ret(self.$premium(5, 6))}, TMP_35.$$s = self, TMP_35.$$arity = 0, TMP_35), $a).call($i)]};
        $j = self.$get_table_by_1d6(table), $a = Opal.to_ary($j), result = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $j;
        if ((($a = (result.$class().$name()['$==']("Array"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          number = result['$[]'](1);
          result = result['$[]'](0);};
        number = "" + (num) + (number);
      ...
      Opal.def(self, '$premium', TMP_45 = function $$premium(phase, num) {try {

        var $a, $b, TMP_37, $c, TMP_38, $d, TMP_39, $e, TMP_40, $f, TMP_41, $g, TMP_42, $h, TMP_43, $i, TMP_44, $j, self = this, $case = nil, table = nil, result = nil, number = nil;

        $case = phase;if ((1)['$===']($case)) {table = ["プレミアムチキン", "プレミアムチキン", "プレミアムチキン", ($a = ($b = self).$lambda, $a.$$p = (TMP_37 = function(){var self = TMP_37.$$s || this;

        Opal.ret(self.$normal(3, 4))}, TMP_37.$$s = self, TMP_37.$$arity = 0, TMP_37), $a).call($b), ($a = ($c = self).$lambda, $a.$$p = (TMP_38 = function(){var self = TMP_38.$$s || this;

        Opal.ret(self.$premium(2, 5))}, TMP_38.$$s = self, TMP_38.$$arity = 0, TMP_38), $a).call($c), ($a = ($d = self).$lambda, $a.$$p = (TMP_39 = function(){var self = TMP_39.$$s || this;

        Opal.ret(self.$premium(2, 6))}, TMP_39.$$s = self, TMP_39.$$arity = 0, TMP_39), $a).call($d)]}else if ((2)['$===']($case)) {table = ["親衛隊バッジ", "ハタモトチャブダイ", "星のコンパス", "白銀の甲冑", ($a = ($e = self).$lambda, $a.$$p = (TMP_40 = function(){var self = TMP_40.$$s || this;

        Opal.ret(self.$normal(4, 5))}, TMP_40.$$s = self, TMP_40.$$arity = 0, TMP_40), $a).call($e), ($a = ($f = self).$lambda, $a.$$p = (TMP_41 = function(){var self = TMP_41.$$s || this;

        Opal.ret(self.$premium(3, 6))}, TMP_41.$$s = self, TMP_41.$$arity = 0, TMP_41), $a).call($f)]}else if ((3)['$===']($case)) {table = ["特性クイックHPポーション", "特性クイックMPポーション", "特製クイックスタミナポーション", "火龍のフィギュアor氷龍のフィギュア(選択可)", "ヒメショーグンドレス", ($a = ($g = self).$lambda, $a.$$p = (TMP_42 = function(){var self = TMP_42.$$s || this;

        Opal.ret(self.$premium(4, 6))}, TMP_42.$$s = self, TMP_42.$$arity = 0, TMP_42), $a).call($g)]}else if ((4)['$===']($case)) {table = ["クイックユグドラポーション", "銀河龍のフィギュア/ドラゴン", "銀河龍のフィギュア/魔族", "魔族チェスセット", "イグニスコンロ", ($a = ($h = self).$lambda, $a.$$p = (TMP_43 = function(){var self = TMP_43.$$s || this;

        Opal.ret(self.$premium(5, 6))}, TMP_43.$$s = self, TMP_43.$$arity = 0, TMP_43), $a).call($h)]}else if ((5)['$===']($case)) {table = ["グレヴディバリウス", "天使の望遠鏡orデスの目覚まし時計(選択可)", "世界樹の蔦", "死神の飾りドレス", "ザバーニヤ等身大フィギュア", ($a = ($i = self).$lambda, $a.$$p = (TMP_44 = function(){var self = TMP_44.$$s || this;

        Opal.ret(self.$premium(6, 6))}, TMP_44.$$s = self, TMP_44.$$arity = 0, TMP_44), $a).call($i)]}else if ((6)['$===']($case)) {table = ["イレブンチキン", "イレブンチキン(2ピース)", "イレブンチキン(3ピース)", "イレブンチキン(6ピース)", "イレブンチキン(12ピース)", "wish star"]};
        $j = self.$get_table_by_1d6(table), $a = Opal.to_ary($j), result = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $j;
        if ((($a = (result.$class().$name()['$==']("Array"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          number = result['$[]'](1);
          result = result['$[]'](0);};
    ...
    Opal.defn(self, '$getTresureResult', TMP_47 = function $$getTresureResult(command) {
      var $a, $b, self = this, rank = nil, modify = nil, tableName = nil, $case = nil, table = nil, result = nil, number = nil;

      if ((($a = (/TRS(\d+)([\+\-]\d)?/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
    ...
    Opal.defn(self, '$getTrapResult', TMP_48 = function $$getTrapResult(command) {
      var $a, $b, self = this, dif = nil, tableName = nil, $case = nil, difficultyText = nil, difficulty = nil, table = nil, result = nil, number = nil;

      if ((($a = (/TRAP(E|N|H|L)/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      dif = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      tableName = "トラップ表";
      $case = dif;if ("E"['$===']($case)) {difficultyText = "初級";
      difficulty = 0;}else if ("N"['$===']($case)) {difficultyText = "中級";
      difficulty = 1;}else if ("H"['$===']($case)) {difficultyText = "上級";
      difficulty = 2;}else if ("L"['$===']($case)) {difficultyText = "悪夢";
      difficulty = 3;}else {return nil};
    ...
    Opal.defn(self, '$getRandomOptionResult', TMP_49 = function $$getRandomOptionResult(command) {
      var $a, $b, self = this, dif = nil, tableName = nil, $case = nil, difficultyText = nil, difficulty = nil, table = nil, result = nil, number = nil, _ = nil;

      if ((($a = (/ROP(E|N|H|L)/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      dif = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
    ...
    Opal.defn(self, '$getRandomEventResult', TMP_50 = function $$getRandomEventResult(command) {
      ...
      if ((($a = (/RAND(E|N|H|L)([1-6])?/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dif = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      ...
      } else if ((($a = (/RENC(E|N|H|L)([1-6])?/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dif = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
        area = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
        if ((($a = ((($b = $gvars['~']) === nil ? nil : $b['$[]'](2))['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          $b = self.$roll(1, 6), $a = Opal.to_ary($b), area = ($a[0] == null ? nil : $a[0]), $b};
    ...
    return (Opal.defn(self, '$getRandomEnemyDataResult', TMP_51 = function $$getRandomEnemyDataResult(command) {
      ...
      if ((($a = (/RED(E|N|H|L)(256|265|465|665|666)/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dif = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
        area = 0;
        event = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
        number = event;
      } else if ((($a = (/RED(E|N|H|L)([1-6])4([1-6])/['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dif = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
        area = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
      ...
      $case = $rb_divide(event, 100);if ((1)['$===']($case)) {areaText = "洞窟"}else if ((2)['$===']($case)) {areaText = "遺跡"}else if ((3)['$===']($case)) {areaText = "山岳"}else if ((4)['$===']($case)) {areaText = "水辺"}else if ((5)['$===']($case)) {areaText = "森林"}else if ((6)['$===']($case)) {areaText = "墓場"}else {return nil};}else {return nil};
      result = self.$get_table_by_number(event, table);
      return "" + (tableName) + "(" + (number) + "):" + (areaText) + "<" + (difficultyText) + ">:" + (result['$[]'](difficulty));
    }, TMP_51.$$arity = 1), nil) && 'getRandomEnemyDataResult';
