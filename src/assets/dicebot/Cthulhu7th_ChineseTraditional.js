...
if (more_difficlty == null) more_difficlty = nil;
    ...
    Opal.defn(self, '$getSuccessListImpaleBulletList', TMP_20 = function $$getSuccessListImpaleBulletList(more_difficlty) {
      ...
      successList = [];
      impaleBulletList = [];
      $case = more_difficlty;if ((0)['$===']($case)) {successList = ["困難的成功", "通常成功"];
      impaleBulletList = ["決定性的成功", "極限的成功"];}else if ((1)['$===']($case)) {successList = ["困難的成功"];
      impaleBulletList = ["決定性的成功", "極限的成功"];}else if ((2)['$===']($case)) {successList = [];
      impaleBulletList = ["決定性的成功", "極限的成功"];}else if ((3)['$===']($case)) {successList = ["決定性的成功"];
      impaleBulletList = [];};
