...
Opal.modules["diceBot/GardenOrder"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_4 = function $$rollDiceCommand(command) {
      ...
      $case = command;if (/GO(\d+)(\/(\d+))?(@(\d+))?/i['$===']($case)) {success_rate = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
      repeat_count = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](3))) !== false && $a !== nil && $a != null) ? $a : 1)).$to_i();
      critical_border_text = (($a = $gvars['~']) === nil ? nil : $a['$[]'](5));
      critical_border = self.$get_critical_border(critical_border_text, success_rate);
      return self.$check_roll_repeat_attack(success_rate, repeat_count, critical_border);}else if (/^DC(SL|BL|IM|BR|RF|EL)(\d+)/i['$===']($case)) {type = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      damage_value = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
      return self.$look_up_damage_chart(type, damage_value);};
      return nil;
    }, TMP_4.$$arity = 1);

    Opal.defn(self, '$get_critical_border', TMP_5 = function $$get_critical_border(critical_border_text, success_rate) {
      var $a, self = this, critical_border = nil;

      if ((($a = critical_border_text['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
    ...
    Opal.defn(self, '$check_roll', TMP_7 = function $$check_roll(success_rate, critical_border) {
      var $a, $b, self = this, fumble_border = nil, dice_value = nil, result = nil, text = nil;

      fumble_border = ((function() {if ((($a = $rb_lt(success_rate, 100)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return 96
        } else {
        return 99
      }; return nil; })());
    ...
    Opal.defn(self, '$get_check_result', TMP_8 = function $$get_check_result(dice_value, success_rate, critical_border, fumble_border) {
      var $a, self = this;

      if ((($a = $rb_le(dice_value, critical_border)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "クリティカル"};
      if ((($a = $rb_ge(dice_value, fumble_border)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "ファンブル"};
      if ((($a = $rb_le(dice_value, success_rate)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "成功"};
      return "失敗";
    }, TMP_8.$$arity = 4);

    Opal.defn(self, '$look_up_damage_chart', TMP_9 = function $$look_up_damage_chart(type, damage_value) {
...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$rollDiceCommand', TMP_4 = function $$rollDiceCommand(command) {
      var $a, $b, self = this, $case = nil, success_rate = nil, repeat_count = nil, critical_border_text = nil, critical_border = nil, type = nil, damage_value = nil;

      $case = command;if (/(AK|AKG)(\d+)(\/(\d+))?(@(\d+))?/i['$===']($case)) {success_rate = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
      repeat_count = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](4))) !== false && $a !== nil && $a != null) ? $a : 1)).$to_i();
      ...
      return self.$look_up_damage_chart(type, damage_value);};
      return nil;
    }, TMP_4.$$arity = 1), nil) && 'rollDiceCommand';
  })($scope.base, $scope.get('GardenOrder'));
})(Opal);
