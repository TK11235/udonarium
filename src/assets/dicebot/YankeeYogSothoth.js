...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$getTableDiceCommandResult', TMP_8 = function $$getTableDiceCommandResult(command) {
      ...
      return self.$get_table_by_d66_swap(table);}else {return nil}})(), $a = Opal.to_ary($b), text = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $b;
