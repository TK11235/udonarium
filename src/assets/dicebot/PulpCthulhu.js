...
Opal.loaded(["diceBot/Cthulhu7th"]);
/* Generated by Opal 0.11.4 */
(function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  ...
  return (function($base, $super, $parent_nesting) {
    function $PulpCthulhu(){};
    var self = $PulpCthulhu = $klass($base, $super, 'PulpCthulhu', $PulpCthulhu);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_PulpCthulhu_gameName_1, TMP_PulpCthulhu_gameType_2, TMP_PulpCthulhu_getHelpMessage_3, TMP_PulpCthulhu_rollDiceCommand_4, TMP_PulpCthulhu_roll_1d20_table_5, TMP_PulpCthulhu_roll_bmr_table_6, TMP_PulpCthulhu_roll_bms_table_7;

    
    self.$setPrefixes(["CC\\(\\d+\\)", "CC.*", "CBR\\(\\d+,\\d+\\)", "FAR.*", "BMR", "BMS", "FCE", "PH", "MA", "IT"]);
    
    Opal.defn(self, '$gameName', TMP_PulpCthulhu_gameName_1 = function $$gameName() {
      var self = this;

      return "パルプ・クトゥルフ"
    }, TMP_PulpCthulhu_gameName_1.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_PulpCthulhu_gameType_2 = function $$gameType() {
      var self = this;

      return "PulpCthulhu"
    }, TMP_PulpCthulhu_gameType_2.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_PulpCthulhu_getHelpMessage_3 = function $$getHelpMessage() {
      var self = this;
    ...
    }, TMP_PulpCthulhu_getHelpMessage_3.$$arity = 0);
    
    Opal.defn(self, '$rollDiceCommand', TMP_PulpCthulhu_rollDiceCommand_4 = function $$rollDiceCommand(command) {
      var self = this, $case = nil;
      ...
      else if (/^FCE/i['$===']($case)) {return self.$roll_1d20_table("キャスティング・ロール失敗表", Opal.const_get_relative($nesting, 'FAILED_CASTING_EFFECTS_TABLE'))}
      else if (/^PH/i['$===']($case)) {return self.$roll_1d100_table("恐怖症表", Opal.const_get_relative($nesting, 'PHOBIAS_TABLE'))}
      else if (/^MA/i['$===']($case)) {return self.$roll_1d100_table("マニア表", Opal.const_get_relative($nesting, 'MANIAS_TABLE'))}
      else if (/^IT/i['$===']($case)) {return self.$roll_1d20_table("狂気のタレント表", Opal.const_get_relative($nesting, 'INSANE_TALENTS_TABLE'))}
      else {return nil}})()
    }, TMP_PulpCthulhu_rollDiceCommand_4.$$arity = 1);
    self.$private();
    
    Opal.defn(self, '$roll_1d20_table', TMP_PulpCthulhu_roll_1d20_table_5 = function $$roll_1d20_table(table_name, table) {
      var $a, $b, self = this, total_n = nil, index = nil, text = nil;
      ...
      text = table['$[]'](index);
      return "" + (table_name) + "(" + (total_n) + ") ＞ " + (text);
    }, TMP_PulpCthulhu_roll_1d20_table_5.$$arity = 2);
    
    Opal.defn(self, '$roll_bmr_table', TMP_PulpCthulhu_roll_bmr_table_6 = function $$roll_bmr_table() {
      var $a, $b, self = this, total_n = nil, text = nil, time_n = nil;
      ...
      $b = self.$roll(1, 10), $a = Opal.to_ary($b), (time_n = ($a[0] == null ? nil : $a[0])), $b;
      return "" + "狂気の発作（リアルタイム）(" + (total_n) + ") ＞ " + (text) + "(1D10＞" + (time_n) + "ラウンド)";
    }, TMP_PulpCthulhu_roll_bmr_table_6.$$arity = 0);
    ...
    Opal.defn(self, '$roll_bms_table', TMP_PulpCthulhu_roll_bms_table_7 = function $$roll_bms_table() {
      var $a, $b, self = this, total_n = nil, text = nil, time_n = nil;
      ...
      $b = self.$roll(1, 10), $a = Opal.to_ary($b), (time_n = ($a[0] == null ? nil : $a[0])), $b;
      return "" + "狂気の発作（サマリー）(" + (total_n) + ") ＞ " + (text) + "(1D10＞" + (time_n) + "時間)";
    }, TMP_PulpCthulhu_roll_bms_table_7.$$arity = 0);
  ...
  })($nesting[0], Opal.const_get_relative($nesting, 'Cthulhu7th'), $nesting);
})(Opal);
