...
(function(Opal) {
  ...
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $gvars = Opal.gvars, $hash2 = Opal.hash2, $hash = Opal.hash, $range = Opal.range;
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_13, TMP_14, TMP_18, TMP_19, TMP_20, TMP_21, TMP_22, TMP_23, TMP_24;
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_4 = function $$rollDiceCommand(command) {
      ...
      $case = command;if (/^DLH(\d+([\+\-]\d+)*)/i['$===']($case)) {expressions = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      return self.$rollJudge(expressions);}else if (/^DC(L||S|C)(\d+)/i['$===']($case)) {type = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      minusScore = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
      chartName = (function() {$case = type;if ("L"['$===']($case)) {return "肉体"}else if ("S"['$===']($case)) {return "精神"}else if ("C"['$===']($case)) {return "環境"}else { return nil }})();
      return self.$fetchDeathChart(chartName, minusScore);}else if (/^RNC([JO])/i['$===']($case)) {type = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      chartName = ((function() {if ((($a = (type['$==']("J"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "日本"
        } else {
        return "海外"
      }; return nil; })());
      ...
      return text;}else if (/^HNC/i['$===']($case)) {result = self.$rollHeroNameTemplateChart();
    ...
    Opal.defn(self, '$rollJudge', TMP_5 = function $$rollJudge(expressions) {
      ...
      if ((($a = $rb_gt(target, 100)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        target = 100};
      if ((($a = $rb_lt(target, 0)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        target = 0};
      $b = self.$rollD100(), $a = Opal.to_ary($b), dice10 = ($a[0] == null ? nil : $a[0]), dice01 = ($a[1] == null ? nil : $a[1]), diceTotal = ($a[2] == null ? nil : $a[2]), $b;
      text = "行為判定(成功率:" + (target) + "％)";
      text = $rb_plus(text, " ＞ 1D100[" + (dice10) + "," + (dice01) + "]=" + ("%02d"['$%']([diceTotal])));
      text = $rb_plus(text, " ＞ " + ("%02d"['$%']([diceTotal])));
      if ((($a = $rb_le(diceTotal, target)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        text = $rb_plus(text, " ＞ 成功");
        if ((($a = self['$isRepdigit?'](dice10, dice01)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$rollD100', TMP_6 = function $$rollD100() {
    ...
    Opal.defn(self, '$isRepdigit?', TMP_7 = function(diceA, diceB) {
      var self = this;

      return diceA['$=='](diceB);
    }, TMP_7.$$arity = 2);

    Opal.defn(self, '$fetchDeathChart', TMP_8 = function $$fetchDeathChart(chartName, minusScore) {
...
if (i == null) i = nil;
    ...
    Opal.defn(self, '$rollHeroNameBaseChart', TMP_20 = function $$rollHeroNameBaseChart(chartName) {
      ...
      if ((($a = result['$[]']("result")['$=~'](/［(.+)］/)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        ($a = "result", $b = result, $b['$[]=']($a, $rb_plus($b['$[]']($a), " ＞ 1D10[" + (innerResult['$[]']("dice")) + "] ＞ " + (innerResult['$[]']("name")) + "（意味：" + (innerResult['$[]']("mean")) + "）")));};
      return result;
    }, TMP_20.$$arity = 1);

    Opal.defn(self, '$rollHeroNameElementChart', TMP_21 = function $$rollHeroNameElementChart(chartName) {
    ...
    Opal.defn(self, '$getHeroNameTemplateChart', TMP_22 = function $$getHeroNameTemplateChart() {
      var $a, self = this;

      return (($a = Opal.cvars['@@heroNameTemplates']) == null ? nil : $a);
    }, TMP_22.$$arity = 0);

    Opal.defn(self, '$getHeroNameBaseChartByName', TMP_23 = function $$getHeroNameBaseChartByName(chartName) {
      var $a, self = this;

      return (($a = Opal.cvars['@@heroNameBaseCharts']) == null ? nil : $a)['$[]'](chartName);
    }, TMP_23.$$arity = 1);

    Opal.defn(self, '$getHeroNameElementChartByName', TMP_24 = function $$getHeroNameElementChartByName(chartName) {
      var $a, self = this;

      return (($a = Opal.cvars['@@heroNameElementCharts']) == null ? nil : $a)['$[]'](chartName);
    }, TMP_24.$$arity = 1);

    (Opal.cvars['@@heroNameTemplates'] = $hash(1, $hash2(["text", "elements"], {"text": "ベースＡ＋ベースＢ", "elements": ["ベースＡ", "ベースＢ"]}), 2, $hash2(["text", "elements"], {"text": "ベースＢ", "elements": ["ベースＢ"]}), 3, $hash2(["text", "elements"], {"text": "ベースＢ×２回", "elements": ["ベースＢ", "ベースＢ"]}), 4, $hash2(["text", "elements"], {"text": "ベースＢ＋ベースＣ", "elements": ["ベースＢ", "ベースＣ"]}), 5, $hash2(["text", "elements"], {"text": "ベースＡ＋ベースＢ＋ベースＣ", "elements": ["ベースＡ", "ベースＢ", "ベースＣ"]}), 6, $hash2(["text", "elements"], {"text": "ベースＡ＋ベースＢ×２回", "elements": ["ベースＡ", "ベースＢ", "ベースＢ"]}), 7, $hash2(["text", "elements"], {"text": "ベースＢ×２回＋ベースＣ", "elements": ["ベースＢ", "ベースＢ", "ベースＣ"]}), 8, $hash2(["text", "elements"], {"text": "（ベースＢ）・オブ・（ベースＢ）", "elements": ["ベースＢ", "・オブ・", "ベースＢ"]}), 9, $hash2(["text", "elements"], {"text": "（ベースＢ）・ザ・（ベースＢ）", "elements": ["ベースＢ", "・ザ・", "ベースＢ"]}), 10, $hash2(["text", "elements"], {"text": "任意", "elements": ["任意"]})));

    (Opal.cvars['@@heroNameBaseCharts'] = $hash2(["ベースＡ", "ベースＢ", "ベースＣ"], {"ベースＡ": $hash(1, "ザ・", 2, "キャプテン・", 3, "ミスター／ミス／ミセス・", 4, "ドクター／プロフェッサー・", 5, "ロード／バロン／ジェネラル・", 6, "マン・オブ・", 7, "［強さ］", 8, "［色］", 9, "マダム／ミドル・", 10, "数字（１～10）・"), "ベースＢ": $hash(1, "［神話／夢］", 2, "［武器］", 3, "［動物］", 4, "［鳥］", 5, "［虫／爬虫類］", 6, "［部位］", 7, "［光］", 8, "［攻撃］", 9, "［その他］", 10, "数字（１～10）・"), "ベースＣ": $hash(1, "マン／ウーマン", 2, "ボーイ／ガール", 3, "マスク／フード", 4, "ライダー", 5, "マスター", 6, "ファイター／ソルジャー", 7, "キング／クイーン", 8, "［色］", 9, "ヒーロー／スペシャル", 10, "ヒーロー／スペシャル")}));

    return (Opal.cvars['@@heroNameElementCharts'] = $hash2(["部位", "武器", "色", "動物", "神話／夢", "攻撃", "その他", "鳥", "光", "虫／爬虫類", "強さ"], {"部位": $hash(1, ["ハート", "心臓"], 2, ["フェイス", "顔"], 3, ["アーム", "腕"], 4, ["ショルダー", "肩"], 5, ["ヘッド", "頭"], 6, ["アイ", "眼"], 7, ["フィスト", "拳"], 8, ["ハンド", "手"], 9, ["クロウ", "爪"], 10, ["ボーン", "骨"]), "武器": $hash(1, ["ナイヴス", "短剣"], 2, ["ソード", "剣"], 3, ["ハンマー", "鎚"], 4, ["ガン", "銃"], 5, ["スティール", "刃"], 6, ["タスク", "牙"], 7, ["ニューク", "核"], 8, ["アロー", "矢"], 9, ["ソウ", "ノコギリ"], 10, ["レイザー", "剃刀"]), "色": $hash(1, ["ブラック", "黒"], 2, ["グリーン", "緑"], 3, ["ブルー", "青"], 4, ["イエロー", "黃"], 5, ["レッド", "赤"], 6, ["バイオレット", "紫"], 7, ["シルバー", "銀"], 8, ["ゴールド", "金"], 9, ["ホワイト", "白"], 10, ["クリア", "透明"]), "動物": $hash(1, ["バニー", "ウサギ"], 2, ["タイガー", "虎"], 3, ["シャーク", "鮫"], 4, ["キャット", "猫"], 5, ["コング", "ゴリラ"], 6, ["ドッグ", "犬"], 7, ["フォックス", "狐"], 8, ["パンサー", "豹"], 9, ["アス", "ロバ"], 10, ["バット", "蝙蝠"]), "神話／夢": $hash(1, ["アポカリプス", "黙示録"], 2, ["ウォー", "戦争"], 3, ["エターナル", "永遠"], 4, ["エンジェル", "天使"], 5, ["デビル", "悪魔"], 6, ["イモータル", "死なない"], 7, ["デス", "死神"], 8, ["ドリーム", "夢"], 9, ["ゴースト", "幽霊"], 10, ["デッド", "死んでいる"]), "攻撃": $hash(1, ["ストローク", "一撃"], 2, ["クラッシュ", "壊す"], 3, ["ブロウ", "吹き飛ばす"], 4, ["ヒット", "打つ"], 5, ["パンチ", "殴る"], 6, ["キック", "蹴る"], 7, ["スラッシュ", "斬る"], 8, ["ペネトレイト", "貫く"], 9, ["ショット", "撃つ"], 10, ["キル", "殺す"]), "その他": $hash(1, ["ヒューマン", "人間"], 2, ["エージェント", "代理人"], 3, ["ブースター", "泥棒"], 4, ["アイアン", "鉄"], 5, ["サンダー", "雷"], 6, ["ウォッチャー", "監視者"], 7, ["プール", "水たまり"], 8, ["マシーン", "機械"], 9, ["コールド", "冷たい"], 10, ["サイド", "側面"]), "鳥": $hash(1, ["ホーク", "鷹"], 2, ["ファルコン", "隼"], 3, ["キャナリー", "カナリア"], 4, ["ロビン", "コマツグミ"], 5, ["イーグル", "鷲"], 6, ["オウル", "フクロウ"], 7, ["レイブン", "ワタリガラス"], 8, ["ダック", "アヒル"], 9, ["ペンギン", "ペンギン"], 10, ["フェニックス", "不死鳥"]), "光": $hash(1, ["ライト", "光"], 2, ["シャドウ", "影"], 3, ["ファイアー", "炎"], 4, ["ダーク", "暗い"], 5, ["ナイト", "夜"], 6, ["ファントム", "幻影"], 7, ["トーチ", "灯火"], 8, ["フラッシュ", "閃光"], 9, ["ランタン", "手さげランプ"], 10, ["サン", "太陽"]), "虫／爬虫類": $hash(1, ["ビートル", "甲虫"], 2, ["バタフライ／モス", "蝶／蛾"], 3, ["スネーク／コブラ", "蛇"], 4, ["アリゲーター", "ワニ"], 5, ["ローカスト", "バッタ"], 6, ["リザード", "トカゲ"], 7, ["タートル", "亀"], 8, ["スパイダー", "蜘蛛"], 9, ["アント", "アリ"], 10, ["マンティス", "カマキリ"]), "強さ": $hash(1, ["スーパー／ウルトラ", "超"], 2, ["ワンダー", "驚異的"], 3, ["アルティメット", "究極の"], 4, ["ファンタスティック", "途方もない"], 5, ["マイティ", "強い"], 6, ["インクレディブル", "凄い"], 7, ["アメージング", "素晴らしい"], 8, ["ワイルド", "狂乱の"], 9, ["グレイテスト", "至高の"], 10, ["マーベラス", "驚くべき"])}));
