...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      var $a, $b, TMP_4, self = this, prefixsRegText = nil, pattern = nil, waponCommand = nil, base = nil, diff = nil, waponInfo = nil, output_msg = nil;

      prefixsRegText = ($a = ($b = self.$prefixs()).$collect, $a.$$p = (TMP_4 = function(i){var self = TMP_4.$$s || this;
if (i == null) i = nil;
      return i.$sub(/\.\*/, "")}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4), $a).call($b).$join("|");
    ...
    Opal.defn(self, '$rollJudge', TMP_7 = function $$rollJudge(base, diff, waponInfo) {
      var $a, $b, TMP_6, self = this, waponName = nil, waponTable = nil, diceList = nil, total = nil, allTotal = nil, diffText = nil, result = nil;
      ...
      total = ($a = ($b = diceList).$inject, $a.$$p = (TMP_6 = function(value, i){var self = TMP_6.$$s || this;
if (value == null) value = nil;if (i == null) i = nil;
      return value = $rb_plus(value, i)}, TMP_6.$$s = self, TMP_6.$$arity = 2, TMP_6), $a).call($b);
      allTotal = $rb_plus(total, base);
      diffText = (function() {if ((($a = diff['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ""
        } else {
        return ">=" + (diff)
      }; return nil; })();
      result = "(" + (waponName) + "：" + (base) + (diffText) + ") ＞ 1D100+" + (base) + " ＞ " + (total);
      if ((($a = ($rb_ge(diceList.$length(), 2))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$getJudgeDiceList', TMP_8 = function $$getJudgeDiceList() {
      ...
      if ((($b = (rank01['$=='](0))) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        } else {
        break;
      };};
      return diceList;
    ...
    Opal.defn(self, '$getSuccessText', TMP_9 = function $$getSuccessText(allTotal, diff, diceList, isWapon) {
      var $a, $b, self = this, first = nil, result = nil, skillText = nil, success = nil;

      first = diceList.$first();
      if ((($a = (first['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ""};
      if ((($a = ($rb_le(first, 9))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return " ＞ ファンブル"};
      if ((($a = (($b = diff['$nil?'](), $b !== false && $b !== nil && $b != null ?(first['$!='](10)) : $b))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ""};
      result = "";
      ...
      if ((($a = (diff['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        if ((($a = (skillText['$empty?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          result = $rb_plus(result, " ＞ ")};
        success = ((function() {if ((($a = $rb_ge(allTotal, diff.$to_i())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return "成功"
          } else {
          return "失敗"
        }; return nil; })());
    ...
    Opal.defn(self, '$getSkillText', TMP_10 = function $$getSkillText(first, diff, isWapon) {
      var $a, self = this, result = nil;

      result = "";
      if ((($a = (isWapon)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return result};
      result = " ＞ ";
      if ((($a = (first['$=='](10))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return result
      };
    ...
    Opal.defn(self, '$getWaponTable', TMP_11 = function $$getWaponTable(waponCommand) {
      var self = this, $case = nil;

      self.$debug("getWaponTable waponCommand", waponCommand);
      $case = waponCommand.$upcase();if ("SW"['$===']($case)) {return self.$getWaponTableSword()}else if ("CSW"['$===']($case)) {return self.$getWaponTableSwordCounter()}else if ("LS"['$===']($case)) {return self.$getWaponTableLongSword()}else if ("CLS"['$===']($case)) {return self.$getWaponTableLongSwordCounter()}else if ("SS"['$===']($case)) {return self.$getWaponTableShortSword()}else if ("CSS"['$===']($case)) {return self.$getWaponTableShortSwordCounter()}else if ("SP"['$===']($case)) {return self.$getWaponTableSpear()}else if ("CSP"['$===']($case)) {return self.$getWaponTableSpearCounter()}else if ("AX"['$===']($case)) {return self.$getWaponTableAx()}else if ("CAX"['$===']($case)) {return self.$getWaponTableAxCounter()}else if ("CL"['$===']($case)) {return self.$getWaponTableClub()}else if ("CCL"['$===']($case)) {return self.$getWaponTableClubCounter()}else if ("BW"['$===']($case)) {return self.$getWaponTableBow()}else if ("MA"['$===']($case)) {return self.$getWaponTableMartialArt()}else if ("CMA"['$===']($case)) {return self.$getWaponTableMartialArtCounter()}else if ("BX"['$===']($case)) {return self.$getWaponTableBoxing()}else if ("CBX"['$===']($case)) {return self.$getWaponTableBoxingCounter()}else if ("PR"['$===']($case)) {return self.$getWaponTableProWrestling()}else if ("CPR"['$===']($case)) {return self.$getWaponTableProWrestlingCounter()}else if ("ST"['$===']($case)) {return self.$getWaponTableStand()}else if ("CST"['$===']($case)) {return self.$getWaponTableStandCounter()};
      return $hash2(["name", "table"], {"name": "判定", "table": nil});
    }, TMP_11.$$arity = 1);

    Opal.defn(self, '$getWaponTableSword', TMP_12 = function $$getWaponTableSword() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableSwordCounter', TMP_13 = function $$getWaponTableSwordCounter() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableLongSword', TMP_14 = function $$getWaponTableLongSword() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableLongSwordCounter', TMP_15 = function $$getWaponTableLongSwordCounter() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableShortSword', TMP_16 = function $$getWaponTableShortSword() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableShortSwordCounter', TMP_17 = function $$getWaponTableShortSwordCounter() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableSpear', TMP_18 = function $$getWaponTableSpear() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableSpearCounter', TMP_19 = function $$getWaponTableSpearCounter() {
      var self = this;

      return $hash2(["name", "table"], {"name": "槍カウンター", "table": [[55, "風車", "カウンター、ダメージ２倍"], [66, nil, nil], [77, nil, nil], [88, nil, nil], [99, nil, nil], [0, nil, nil]]});
    }, TMP_19.$$arity = 0);

    Opal.defn(self, '$getWaponTableAx', TMP_20 = function $$getWaponTableAx() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableAxCounter', TMP_21 = function $$getWaponTableAxCounter() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableClub', TMP_22 = function $$getWaponTableClub() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableClubCounter', TMP_23 = function $$getWaponTableClubCounter() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableBow', TMP_24 = function $$getWaponTableBow() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableMartialArt', TMP_25 = function $$getWaponTableMartialArt() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableMartialArtCounter', TMP_26 = function $$getWaponTableMartialArtCounter() {
      var self = this;
    ...
    Opal.defn(self, '$getRandMartialArtCounter', TMP_27 = function $$getRandMartialArtCounter() {
      ...
      if ((($a = (value['$=='](110))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dice = 100};
    ...
    Opal.defn(self, '$getWaponTableBoxing', TMP_28 = function $$getWaponTableBoxing() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableBoxingCounter', TMP_29 = function $$getWaponTableBoxingCounter() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableProWrestling', TMP_30 = function $$getWaponTableProWrestling() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableProWrestlingCounter', TMP_31 = function $$getWaponTableProWrestlingCounter() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableStand', TMP_32 = function $$getWaponTableStand() {
      var self = this;
    ...
    Opal.defn(self, '$getWaponTableStandCounter', TMP_33 = function $$getWaponTableStandCounter() {
      var self = this;
    ...
    return (Opal.defn(self, '$getWaponSkillText', TMP_35 = function $$getWaponSkillText(waponTable, dice) {try {

      var $a, $b, TMP_34, self = this, preName = nil, preEffect = nil;

      self.$debug("getWaponSkillText", dice);
      if ((($a = (waponTable['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ""};
      preName = "";
      preEffect = "";
      ($a = ($b = waponTable).$each, $a.$$p = (TMP_34 = function(index, name, effect){var self = TMP_34.$$s || this, $c;
if (index == null) index = nil;if (name == null) name = nil;if (effect == null) effect = nil;
      ((($c = name) !== false && $c !== nil && $c != null) ? $c : name = preName);
        preName = name;
        ((($c = effect) !== false && $c !== nil && $c != null) ? $c : effect = preEffect);
        preEffect = effect;
        if ((($c = (index['$==']((dice['$%'](100))))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          } else {
          return nil;
        };
        Opal.ret(" ＞ 「" + (name) + "」" + (effect));}, TMP_34.$$s = self, TMP_34.$$arity = 3, TMP_34), $a).call($b);
      return "";
      } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
    }, TMP_35.$$arity = 2), nil) && 'getWaponSkillText';
