...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_7 = function $$rollDiceCommand(command) {
      ...
      tableName = "";
      result = "";
      $case = command;if ("MT"['$===']($case)) {$b = self.$getMeetingTableResult(), $a = Opal.to_ary($b), tableName = ($a[0] == null ? nil : $a[0]), result = ($a[1] == null ? nil : $a[1]), number = ($a[2] == null ? nil : $a[2]), $b}else if (/^.+FT$/i['$===']($case)) {$b = self.$getFeelingTableResult(command), $a = Opal.to_ary($b), tableName = ($a[0] == null ? nil : $a[0]), result = ($a[1] == null ? nil : $a[1]), number = ($a[2] == null ? nil : $a[2]), $b}else if (/^.*CT$/i['$===']($case)) {$b = self.$getCountryTableResult(command), $a = Opal.to_ary($b), tableName = ($a[0] == null ? nil : $a[0]), result = ($a[1] == null ? nil : $a[1]), number = ($a[2] == null ? nil : $a[2]), $b}else {self.$debug("rollDiceCommand commandNOT matched -> command:", command);
      return "";};
      text = "" + (tableName) + "(" + (number) + ") ＞ " + (result);
      return text;
    }, TMP_7.$$arity = 1);

    Opal.defn(self, '$getMeetingTableResult', TMP_8 = function $$getMeetingTableResult() {
    ...
    return (Opal.defn(self, '$getCountryTableResult', TMP_10 = function $$getCountryTableResult(command) {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil, $case = nil;

      self.$debug("getCountryTableResult command", command);
      tableName = "";
      table = [];
      if ((($a = (((($b = /^CT$/i['$=~'](command)) !== false && $b !== nil && $b != null) ? $b : /^CategoryCT$/i['$=~'](command)))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      return [tableName, result, number];
    }, TMP_10.$$arity = 1), nil) && 'getCountryTableResult';
