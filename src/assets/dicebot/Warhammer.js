...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$upcase', '$===', '$getAtackResult', '$getCriticalResult', '$==', '$<=', '$/', '$-', '$=~', '$to_i', '$>', '$<', '$roll', '$*', '$[]', '$+', '$>=', '$debug', '$!=', '$each', '$get_wh_atpos_message', '$step', '$length', '$check_suc', '$%', '$wh_atpos']);
  return (function($base, $super) {
    function $Warhammer(){};
    var self = $Warhammer = $klass($base, $super, 'Warhammer', $Warhammer);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_9, TMP_11, TMP_12;
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      output_msg = nil;
      $case = command.$upcase();if (/^(WH\d+(@[\dWH]*)?)/i['$===']($case)) {atackCommand = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      output_msg = self.$getAtackResult(atackCommand);}else if (/^(WH[HABTLW]\d+)/i['$===']($case)) {criticalCommand = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      output_msg = self.$getCriticalResult(criticalCommand);};
      return output_msg;
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$check_1D100', TMP_6 = function $$check_1D100(total_n, dice_n, signOfInequality, diff, dice_cnt, dice_max, n1, n_max) {
      var $a, self = this;
      ...
      if ((($a = ($rb_le(total_n, diff))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return " ＞ 成功(成功度" + (($rb_divide(($rb_minus(diff, total_n)), 10))) + ")"};
      return " ＞ 失敗(失敗度" + (($rb_divide(($rb_minus(total_n, diff)), 10))) + ")";
    }, TMP_6.$$arity = 8);

    Opal.defn(self, '$getCriticalResult', TMP_7 = function $$getCriticalResult(string) {
      ...
      output = "1";
      if ((($a = (/WH([HABTLW])(\d+)/['$=~'](string))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return "1"
      };
      partsWord = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      criticalValue = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
      if ((($a = ($rb_gt(criticalValue, 10))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        criticalValue = 10};
      if ((($a = ($rb_lt(criticalValue, 1))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        criticalValue = 1};
      whpp = "";
      whppp = "";
      $case = partsWord;if (/H/i['$===']($case)) {whpp = "頭部";
      whppp = whh;}else if (/A/i['$===']($case)) {whpp = "腕部";
      whppp = wha;}else if (/[TB]/i['$===']($case)) {whpp = "胴体";
      whppp = whb;}else if (/L/i['$===']($case)) {whpp = "脚部";
      whppp = whl;}else if (/W/i['$===']($case)) {whpp = "翼部";
      whppp = whw;};
      ...
      if ((($a = ($rb_ge(crit_num, 5))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$wh_atpos', TMP_9 = function $$wh_atpos(pos_num, pos_type) {
      var $a, $b, TMP_8, self = this, pos_2l = nil, pos_2lw = nil, pos_4l = nil, pos_4la = nil, pos_4lw = nil, pos_b = nil, wh_pos = nil, pos_t = nil, $case = nil, output = nil, pos_i = nil;
      ...
      if ((($a = (pos_type['$!='](""))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        $case = pos_type;if (/\@(2W|W2)/i['$===']($case)) {pos_t = 1}else if (/\@(4W|W4)/i['$===']($case)) {pos_t = 4}else if (/\@(4H|H4)/i['$===']($case)) {pos_t = 3}else if (/\@4/i['$===']($case)) {pos_t = 2}else if (/\@W/i['$===']($case)) {pos_t = 5}else {if ((($a = (/\@(2H|H2|2)/i['$=~'](pos_type))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          pos_t = -1
        }}};
      output = "";
      self.$debug("pos_t", pos_t);
      if ((($a = ($rb_lt(pos_t, 0))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ($a = ($b = wh_pos).$each, $a.$$p = (TMP_8 = function(pos_i){var self = TMP_8.$$s || this;
if (pos_i == null) pos_i = nil;
        return output = $rb_plus(output, self.$get_wh_atpos_message(pos_i, pos_num))}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8), $a).call($b)
        } else {
        pos_i = wh_pos['$[]'](pos_t);
    ...
    Opal.defn(self, '$get_wh_atpos_message', TMP_11 = function $$get_wh_atpos_message(pos_i, pos_num) {
      var $a, $b, TMP_10, self = this, output = nil;

      output = "";
      output = $rb_plus(output, $rb_plus($rb_plus(" ", pos_i['$[]'](0)), ":"));
      (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = (1)).$step, $a.$$p = (TMP_10 = function(i){var self = TMP_10.$$s || this, $c;
if (i == null) i = nil;
      if ((($c = ($rb_le(pos_num, pos_i['$[]'](i)))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          output = $rb_plus(output, pos_i['$[]']($rb_plus(i, 1)));
          
          Opal.brk(nil, $brk);
          } else {
          return nil
        }}, TMP_10.$$s = self, TMP_10.$$brk = $brk, TMP_10.$$arity = 1, TMP_10), $a).call($b, $rb_plus(pos_i.$length(), 1), 2)
      } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
      return output;
    }, TMP_11.$$arity = 2);

    return (Opal.defn(self, '$getAtackResult', TMP_12 = function $$getAtackResult(string) {
      var $a, $b, self = this, pos_type = nil, diff = nil, total_n = nil, output = nil, pos_num = nil;

      self.$debug("getAtackResult begin string", string);
      pos_type = "";
      if ((($a = (/(.+)(@.*)/['$=~'](string))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        string = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
        pos_type = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2));
        self.$debug("pos_type", pos_type);};
      if ((($a = (/WH(\d+)/i['$=~'](string))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return "1"
      };
      ...
      return output;
    }, TMP_12.$$arity = 1), nil) && 'getAtackResult';
