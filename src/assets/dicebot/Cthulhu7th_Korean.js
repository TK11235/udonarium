...
if (more_difficlty == null) more_difficlty = nil;
    ...
    Opal.defn(self, '$getSuccessListImpaleBulletList', TMP_20 = function $$getSuccessListImpaleBulletList(more_difficlty) {
      ...
      successList = [];
      impaleBulletList = [];
      $case = more_difficlty;if ((0)['$===']($case)) {successList = ["어려운 성공", "보통 성공"];
      impaleBulletList = ["대성공", "대단한 성공"];}else if ((1)['$===']($case)) {successList = ["어려운 성공"];
      impaleBulletList = ["대성공", "대단한 성공"];}else if ((2)['$===']($case)) {successList = [];
      impaleBulletList = ["대성공", "대단한 성공"];}else if ((3)['$===']($case)) {successList = ["대성공"];
      impaleBulletList = [];};
