...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$changeText', TMP_5 = function $$changeText(string) {
      var $a, $b, $c, TMP_6, self = this, $iter = TMP_5.$$p, $yield = $iter || nil;
      ...
      string = ($a = ($b = self, Opal.find_super_dispatcher(self, 'changeText', TMP_5, false)), $a.$$p = null, $a).call($b, string);
      self.$debug("parren_killer_add before string", string);
      string = ($a = ($c = string).$gsub, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $d, value = nil;

      value = (($d = $gvars['~']) === nil ? nil : $d['$[]'](1)).$to_i();
        if ((($d = $rb_ge(value, 0)) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
          return "a[+" + (value) + "]"
          } else {
          return "a[" + (value) + "]"
        };}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($c, /#([\+\-]?[\d]+)/i);
      self.$debug("parren_killer_add after string", string);
      return string;
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$getRatingCommandStrings', TMP_7 = function $$getRatingCommandStrings() {
      var $a, $b, self = this, $iter = TMP_7.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil, $zuper_length = nil;
      ...
      return $rb_plus(($a = ($b = self, Opal.find_super_dispatcher(self, 'getRatingCommandStrings', TMP_7, false)), $a.$$p = $iter, $a).apply($b, $zuper), "aA");
    }, TMP_7.$$arity = 0);

    Opal.defn(self, '$getAdditionalString', TMP_8 = function $$getAdditionalString(string, output) {
      var $a, $b, $c, $d, self = this, $iter = TMP_8.$$p, $yield = $iter || nil, values = nil, keptDiceChangeModify = nil;

      TMP_8.$$p = null;
      $b = ($c = ($d = self, Opal.find_super_dispatcher(self, 'getAdditionalString', TMP_8, false)), $c.$$p = null, $c).call($d, string, output), $a = Opal.to_ary($b), output = ($a[0] == null ? nil : $a[0]), values = ($a[1] == null ? nil : $a[1]), $b;
      ...
      if ((($a = (keptDiceChangeModify['$!='](0))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        output = $rb_plus(output, "a[" + (keptDiceChangeModify) + "]")};
      return [output, values];
    }, TMP_8.$$arity = 2);

    Opal.defn(self, '$getAdditionalDiceValue', TMP_9 = function $$getAdditionalDiceValue(dice, values) {
      var $a, $b, self = this, keptDiceChangeModify = nil, value = nil;

      keptDiceChangeModify = values['$[]']("keptDiceChangeModify").$to_i();
      value = 0;
      if ((($a = (($b = keptDiceChangeModify['$!='](0), $b !== false && $b !== nil && $b != null ?dice['$!='](2) : $b))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        value = $rb_plus(value, keptDiceChangeModify.$to_i())};
      return value;
    }, TMP_9.$$arity = 2);

    return (Opal.defn(self, '$getKeptDiceChangesFromString', TMP_10 = function $$getKeptDiceChangesFromString(string) {
    ...
    }, TMP_10.$$arity = 1), nil) && 'getKeptDiceChangesFromString';
  })($scope.base, $scope.get('SwordWorld2_0'));
})(Opal);
