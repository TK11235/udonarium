...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$checkRoll', '$empty?', '$debug', '$rollTableCommand', '$=~', '$to_i', '$nil?', '$parren_killer', '$roll', '$+', '$>=', '$<=', '$===', '$mm_emotion_table_ver2', '$mm_emotion_table', '$mm_omens_table', '$mm_distortion_table_ver2', '$mm_world_distortion_table', '$mm_distortion_table', '$!=', '$get_table_by_d66', '$get_table_by_2d6']);
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollTableCommand', TMP_7 = function $$rollTableCommand(command) {
      ...
      output = "";
      type = "";
      $case = command;if (/ET2/i['$===']($case)) {type = "감정표2.0";
      $b = self.$mm_emotion_table_ver2(), $a = Opal.to_ary($b), output = ($a[0] == null ? nil : $a[0]), total_n = ($a[1] == null ? nil : $a[1]), $b;}else if (/ET/i['$===']($case)) {type = "감정표";
      $b = self.$mm_emotion_table(), $a = Opal.to_ary($b), output = ($a[0] == null ? nil : $a[0]), total_n = ($a[1] == null ? nil : $a[1]), $b;}else if (/OT/i['$===']($case)) {type = "징조표";
      $b = self.$mm_omens_table(), $a = Opal.to_ary($b), output = ($a[0] == null ? nil : $a[0]), total_n = ($a[1] == null ? nil : $a[1]), $b;}else if (/DT2/i['$===']($case)) {type = "일그러짐표ver2.0";
      $b = self.$mm_distortion_table_ver2(), $a = Opal.to_ary($b), output = ($a[0] == null ? nil : $a[0]), total_n = ($a[1] == null ? nil : $a[1]), $b;}else if (/WDT/i['$===']($case)) {type = "세계왜곡표";
      $b = self.$mm_world_distortion_table(), $a = Opal.to_ary($b), output = ($a[0] == null ? nil : $a[0]), total_n = ($a[1] == null ? nil : $a[1]), $b;}else if (/DT/i['$===']($case)) {type = "징조표";
    ...
    return (Opal.defn(self, '$mm_world_distortion_table', TMP_13 = function $$mm_world_distortion_table() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_2d6(table);
    }, TMP_13.$$arity = 0), nil) && 'mm_world_distortion_table';
