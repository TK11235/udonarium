...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$getFumbleTextAndTotal', TMP_4 = function $$getFumbleTextAndTotal(base, modify, dice_str) {
      var self = this, total = nil, text = nil;
      ...
      return [text, total];
    }, TMP_4.$$arity = 3), nil) && 'getFumbleTextAndTotal';
  })($scope.base, $scope.get('NightWizard'));
})(Opal);
