...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$check_1D100', TMP_4 = function $$check_1D100(total_n, dice_n, signOfInequality, diff, dice_cnt, dice_max, n1, n_max) {
      var $a, self = this, dig10 = nil, dig1 = nil;
    ...
    Opal.defn(self, '$isD9', TMP_5 = function $$isD9() {
      var self = this;
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_8 = function $$rollDiceCommand(command) {
      var $a, $b, TMP_6, $c, TMP_7, self = this, string = nil, table = nil, ttype = nil, type = nil, dice = nil, mod = nil, head = nil, diceText = nil, diceArray = nil, diceOriginalText = nil, output = nil;
...
if (i == null) i = nil;
      if ((($d = ($rb_lt(i, 10))) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
