...
if (e == null) e = nil;
    ...
    Opal.defn(self, '$getPrefixedMagickItemDiceCommandResult', TMP_37 = function $$getPrefixedMagickItemDiceCommandResult(command) {
      ...
      table = nil;
      $case = rank;if ((1)['$===']($case)) {tableName = $rb_plus(tableName, "（매직 그레이드１）");
      table = table_1;}else if ((2)['$===']($case)) {tableName = $rb_plus(tableName, "（매직 그레이드２）");
      table = table_2;}else if ((3)['$===']($case)) {tableName = $rb_plus(tableName, "（매직그레이드３）");
      table = table_3;};
      $b = self.$get_table_by_d66(table), $a = Opal.to_ary($b), result = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $b;
      text = "" + (tableName) + "([" + (number) + "]) ＞ " + (result);
      return text;
...
if (char$ == null) char$ = nil;
      $e = self.$roll(1, 6), $d = Opal.to_ary($e), dice_result = ($d[0] == null ? nil : $d[0]), dice_str = ($d[1] == null ? nil : $d[1]), $e;
        number['$<<'](dice_str);
        return result['$<<']((function() {$case = char$;if ("A"['$===']($case) || "M"['$===']($case)) {return ($d = ($e = ["빛나고 돌며 소리가 울리는", "무언가를 자각한", "단단하고 강한", "굉장히 빠르거나 거친", "대량 생산이 가능한", "좋은 감촉의"]).$map, $d.$$p = (TMP_41 = function(e){var self = TMP_41.$$s || this;
if (e == null) e = nil;
        return $rb_plus(((function() {if (is_single !== false && is_single !== nil && is_single != null) {
            return "특징A(장점)："
            } else {
            return ""
          }; return nil; })()), e)}, TMP_41.$$s = self, TMP_41.$$arity = 1, TMP_41), $d).call($e)}else if ("B"['$===']($case) || "D"['$===']($case)) {return ($d = ($f = ["중독성 있는", "굉장히 무거운", "굉장히 냄새나는", "망가지기 쉬운", "설명할 것이 많은", "버려도 버려도 되돌아오는\t"]).$map, $d.$$p = (TMP_42 = function(e){var self = TMP_42.$$s || this;
if (e == null) e = nil;
        return $rb_plus(((function() {if (is_single !== false && is_single !== nil && is_single != null) {
            return "특징B(단점)："
            } else {
            return ""
          }; return nil; })()), e)}, TMP_42.$$s = self, TMP_42.$$arity = 1, TMP_42), $d).call($f)}else if ("L"['$===']($case)) {return ($d = ($g = ["아름다운", "소박한", "풍류있는", "참신한", "형언할 수 없는", "목숨을 깍는 형태를 한"]).$map, $d.$$p = (TMP_43 = function(e){var self = TMP_43.$$s || this;
if (e == null) e = nil;
        return $rb_plus(((function() {if (is_single !== false && is_single !== nil && is_single != null) {
            return "형용："
            } else {
            return ""
          }; return nil; })()), e)}, TMP_43.$$s = self, TMP_43.$$arity = 1, TMP_43), $d).call($g)}else if ("T"['$===']($case)) {return ($d = ($h = ["무기", "방어구", "악세사리", "식량", "약품", "장난감"]).$map, $d.$$p = (TMP_44 = function(e){var self = TMP_44.$$s || this;
if (e == null) e = nil;
        return $rb_plus(((function() {if (is_single !== false && is_single !== nil && is_single != null) {
            return "발명품의 종류："
            } else {
    ...
    Opal.defn(self, '$getTroubleInAkibaStreetDiceCommandResult', TMP_47 = function $$getTroubleInAkibaStreetDiceCommandResult(command) {
      ...
      number = [];
      result = [];
      ($a = ($b = [["〈로그 호라이즌〉이", "〈초승달 동맹〉이", "〈Ｄ．Ｄ．Ｄ〉가", "〈흑검기사단〉이", "〈서풍여단〉이", "〈로데릭 상회〉가"], ["길드 회관에서", "무위도식 골목에서", "거리 한가운데에서", "수풍관에서", "공중목욕탕에서", "하수구에서"], ["불합리한", "겸손", "달콤한", "부자연스러운", "위험한", "머리 나쁜"], ["싸움", "연애소식", "장난", "음모", "사고", "분실물"]]).$each, $a.$$p = (TMP_46 = function(table){var self = TMP_46.$$s || this, $c, $d, dice_result = nil, dice_str = nil;
if (table == null) table = nil;
    ...
    Opal.defn(self, '$getAbandonedChildDiceCommandResult', TMP_55 = function $$getAbandonedChildDiceCommandResult(command) {
      ...
      number = [];
      result = [];
      ($a = ($b = [($c = ($d = ["꽃의 이름", "별의 이름", "색깔 종류", "돌의 이름", "동물 이름", "번호"]).$map, $c.$$p = (TMP_49 = function(e){var self = TMP_49.$$s || this;
if (e == null) e = nil;
      return $rb_plus("이름：", e)}, TMP_49.$$s = self, TMP_49.$$arity = 1, TMP_49), $c).call($d), ($c = ($e = ["폐 건물", "길가", "식객", "나무 위", "공원", "하수도"]).$map, $c.$$p = (TMP_50 = function(e){var self = TMP_50.$$s || this;
if (e == null) e = nil;
      return $rb_plus("주거：", e)}, TMP_50.$$s = self, TMP_50.$$arity = 1, TMP_50), $c).call($e), ($c = ($f = ["무언가를 찾기", "요리", "노래", "장사", "손재주있는", "약삭빠른 행동"]).$map, $c.$$p = (TMP_51 = function(e){var self = TMP_51.$$s || this;
if (e == null) e = nil;
      return $rb_plus("특기：", e)}, TMP_51.$$s = self, TMP_51.$$arity = 1, TMP_51), $c).call($f), ($c = ($g = ["깡마른", "키작은", "발육이 좋은", "키가 큰", "부드럽고 탄력있는", "근육질의"]).$map, $c.$$p = (TMP_52 = function(e){var self = TMP_52.$$s || this;
if (e == null) e = nil;
      return $rb_plus("체형：", e)}, TMP_52.$$s = self, TMP_52.$$arity = 1, TMP_52), $c).call($g), ($c = ($h = ["과일", "고기", "신선한 야채", "생선", "과자", "벌레"]).$map, $c.$$p = (TMP_53 = function(e){var self = TMP_53.$$s || this;
if (e == null) e = nil;
      return $rb_plus("좋아하는 음식：", e)}, TMP_53.$$s = self, TMP_53.$$arity = 1, TMP_53), $c).call($h), ($c = ($i = ["말이 서툰", "사투리", "일반적인 말투", "사극체", "3인칭", "귀국자녀"]).$map, $c.$$p = (TMP_54 = function(e){var self = TMP_54.$$s || this;
if (e == null) e = nil;
      return $rb_plus("말투：", e)}, TMP_54.$$s = self, TMP_54.$$arity = 1, TMP_54), $c).call($i)]).$each, $a.$$p = (TMP_48 = function(table){var self = TMP_48.$$s || this, $c, $d, dice_result = nil, dice_str = nil;
if (table == null) table = nil;
      $d = self.$roll(1, 6), $c = Opal.to_ary($d), dice_result = ($c[0] == null ? nil : $c[0]), dice_str = ($c[1] == null ? nil : $c[1]), $d;
        number['$<<'](dice_str);
