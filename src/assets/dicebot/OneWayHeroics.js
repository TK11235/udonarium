...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_11, TMP_12, TMP_14, TMP_15, TMP_17, TMP_18, TMP_19, TMP_20, TMP_21, TMP_23, TMP_25, TMP_27;
    ...
    Opal.defn(self, '$getCommandTablesResult', TMP_6 = function $$getCommandTablesResult(command) {
      ...
      info = $scope.get('TABLES')['$[]'](command.$upcase());
      ...
      table = info['$[]']("table");
      hasGap = info['$[]']("hasGap");
      $b = (function() {$case = type;if (/^(\d+)D6$/i['$===']($case)) {count = (($c = $gvars['~']) === nil ? nil : $c['$[]'](1)).$to_i();
      $d = self.$roll(count, 6), $c = Opal.to_ary($d), dice = ($c[0] == null ? nil : $c[0]), $d;
      return self.$getTableResult(table, dice, hasGap);}else if ("D66"['$===']($case)) {isSwap = (self.d66Type['$=='](2));
      dice = self.$getD66(isSwap);
      return self.$getTableResult(table, dice, hasGap);}else {return nil}})(), $a = Opal.to_ary($b), number = ($a[0] == null ? nil : $a[0]), text = ($a[1] == null ? nil : $a[1]), $b;
      if ((($a = (text['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil};
      return "" + (name) + "(" + (number) + ") ＞ " + (text);
    }, TMP_6.$$arity = 1);

    Opal.defn(self, '$getRollDiceCommandResult', TMP_7 = function $$getRollDiceCommandResult(command) {
      ...
      if ((($a = /^(\d*)JD(\d*)(\+(\d*))?(,(\d+))?$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      diceCount = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      if ((($a = diceCount['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        diceCount = 2};
      ...
      if ((($a = target['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        target = target.$to_i()
      };
      modifyText = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](3))) !== false && $a !== nil && $a != null) ? $a : ""));
      if (modifyText['$==']("+")) {
        modifyText = "+1"};
    ...
    Opal.defn(self, '$rollJudgeDice', TMP_8 = function $$rollJudgeDice(diceCount) {
      ...
      if ((($a = (diceCount['$=='](2))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$getJudgeReusltText', TMP_9 = function $$getJudgeReusltText(dice, total, target) {
      var $a, self = this;
      ...
      if ((($a = target['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ""};
      if ((($a = $rb_ge(total, target)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "成功"};
      return "失敗";
    }, TMP_9.$$arity = 3);

    Opal.defn(self, '$getTableResult', TMP_11 = function $$getTableResult(table, dice, hasGap) {
      ...
      if ((($a = ($b = number['$nil?'](), $b !== false && $b !== nil && $b != null ?hasGap : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        params = nil;
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = table).$each, $a.$$p = (TMP_10 = function(data){var self = TMP_10.$$s || this, $c;
if (data == null) data = nil;
        if ((($c = $rb_gt(data.$first(), dice)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            
            Opal.brk(nil, $brk)};
          return params = data;}, TMP_10.$$s = self, TMP_10.$$brk = $brk, TMP_10.$$arity = 1, TMP_10), $a).call($b)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
        $a = Opal.to_a(params), number = ($a[0] == null ? nil : $a[0]), text = ($a[1] == null ? nil : $a[1]), command = ($a[2] == null ? nil : $a[2]), $a;};
      if ((($a = command['$respond_to?']("call")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        $case = command.$arity();if ((0)['$===']($case)) {text = $rb_plus(text, command.$call())}else if ((1)['$===']($case)) {text = $rb_plus(text, command.$call(self))}};
      return [number, text];
    }, TMP_11.$$arity = -3);

    Opal.defn(self, '$getAddRoll', TMP_12 = function $$getAddRoll(command) {
      var $a, self = this, text = nil;

      if ((($a = /^\s/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return command};
    ...
    Opal.defn(self, '$getAddRollProc', TMP_14 = function $$getAddRollProc(command) {
      var $a, $b, TMP_13, self = this;

      return ($a = ($b = self).$lambda, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

      return self.$getAddRoll(command)}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $a).call($b);
    }, TMP_14.$$arity = 1);

    Opal.defn(self, '$getRandomEventAddText', TMP_15 = function $$getRandomEventAddText(day, command1, command2) {
      var $a, $b, self = this, dice = nil, text = nil;

      $b = self.$roll(1, 6), $a = Opal.to_ary($b), dice = ($a[0] == null ? nil : $a[0]), $b;
      text = " ＞ \n 1D6[" + (dice) + "]";
      if ((($a = $rb_le(dice, day)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$getRandomEventAddTextProc', TMP_17 = function $$getRandomEventAddTextProc(day, command1, command2) {
      var $a, $b, TMP_16, self = this;

      return ($a = ($b = self).$lambda, $a.$$p = (TMP_16 = function(){var self = TMP_16.$$s || this;

      return self.$getRandomEventAddText(day, command1, command2)}, TMP_16.$$s = self, TMP_16.$$arity = 0, TMP_16), $a).call($b);
    }, TMP_17.$$arity = 3);

    Opal.defn(self, '$getRandomEventDiceCommandResult', TMP_18 = function $$getRandomEventDiceCommandResult(command) {
      var $a, $b, self = this, day = nil, name = nil, table = nil, dice = nil, number = nil, text = nil;

      if ((($a = /^RET(\d+)$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
    ...
    Opal.defn(self, '$getRandomEventPlusDiceCommandResult', TMP_19 = function $$getRandomEventPlusDiceCommandResult(command) {
      var $a, $b, self = this, day = nil, name = nil, table = nil, dice = nil, number = nil, text = nil;

      if ((($a = /^RETP(\d+)$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      day = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
    ...
    Opal.defn(self, '$getDungeonTableDiceCommandResult', TMP_20 = function $$getDungeonTableDiceCommandResult(command) {
      var $a, $b, self = this, day = nil, name = nil, table = nil, dice = nil, hasGap = nil, number = nil, text = nil;

      if ((($a = /^DNGN(\d+)$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      day = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
      ...
      $b = self.$roll(1, 6), $a = Opal.to_ary($b), dice = ($a[0] == null ? nil : $a[0]), $b;
      if ((($a = $rb_ge(day, 4)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dice = $rb_plus(dice, 1)};
      hasGap = true;
    ...
    Opal.defn(self, '$getDungeonPlusTableDiceCommandResult', TMP_21 = function $$getDungeonPlusTableDiceCommandResult(command) {
      var $a, $b, self = this, day = nil, name = nil, table = nil, dice = nil, hasGap = nil, number = nil, text = nil;

      if ((($a = /^DNGNP(\d+)$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      day = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
