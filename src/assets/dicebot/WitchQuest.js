...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_7, TMP_8, TMP_9, TMP_11, TMP_13, TMP_15, TMP_16, TMP_17;
    ...
    Opal.defn(self, '$changeText', TMP_4 = function $$changeText(string) {
      var self = this;
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      $case = command;if (/WQ(\d+)/['$===']($case)) {number = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
      return self.$challenge(number);}else if (/SET(\d+)/['$===']($case)) {number = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
      return self.$getStructureEncounter(number);};
      return nil;
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$challenge', TMP_7 = function $$challenge(number) {
      var $a, $b, TMP_6, self = this, success = nil, results = nil, successText = nil;

      success = 0;
      results = [];
      ($a = ($b = number).$times, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $c, $d, value1 = nil, value2 = nil;

      $d = self.$roll(1, 6), $c = Opal.to_ary($d), value1 = ($c[0] == null ? nil : $c[0]), $d;
        $d = self.$roll(1, 6), $c = Opal.to_ary($d), value2 = ($c[0] == null ? nil : $c[0]), $d;
        if ((($c = (value1['$=='](value2))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          success = $rb_plus(success, 1)};
        return results['$<<']("" + (value1) + "," + (value2));}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b);
      successText = $rb_plus("(" + (results.$join(" / ")) + ") ＞ ", self.$getSuccessText(success));
      return successText;
    }, TMP_7.$$arity = 1);

    Opal.defn(self, '$getSuccessText', TMP_8 = function $$getSuccessText(success) {
      ...
      if ((($a = ($rb_ge(success, table.$last().$first()))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return table.$last().$last()};
      return self.$get_table_by_number(success, table);
    }, TMP_8.$$arity = 1);

    Opal.defn(self, '$getStructureEncounter', TMP_9 = function $$getStructureEncounter(number) {
    ...
    Opal.defn(self, '$getPersonTable1', TMP_11 = function $$getPersonTable1() {
      var $a, $b, TMP_10, self = this, gotoNextTable = nil, table = nil;

      gotoNextTable = ($a = ($b = self).$lambda, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;

      return $rb_plus("表２へ", self.$getPersonTable2())}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $a).call($b);
    ...
    Opal.defn(self, '$getPersonTable2', TMP_13 = function $$getPersonTable2() {
      var $a, $b, TMP_12, self = this, gotoNextTable = nil, table = nil;

      gotoNextTable = ($a = ($b = self).$lambda, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

      return $rb_plus("表３へ", self.$getPersonTable3())}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $a).call($b);
    ...
    Opal.defn(self, '$getPersonTable3', TMP_15 = function $$getPersonTable3() {
      var $a, $b, TMP_14, self = this, gotoNextTable = nil, table = nil;

      gotoNextTable = ($a = ($b = self).$lambda, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

      return $rb_plus("表４へ", self.$getPersonTable4())}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $a).call($b);
    ...
    Opal.defn(self, '$getPersonTable4', TMP_16 = function $$getPersonTable4() {
    ...
    return (Opal.defn(self, '$getPersonTable', TMP_17 = function $$getPersonTable(table) {
    ...
    }, TMP_17.$$arity = 1), nil) && 'getPersonTable';
