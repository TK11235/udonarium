...
Opal.loaded(["diceBot/NightWizard.js"]);
/* Generated by Opal 1.0.3 */
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $SevenFortressMobius_initialize$1, $SevenFortressMobius_changeText$2, $SevenFortressMobius_dice_command_xRn$4;

    self.$$prototype.nightWizardDiceBot = nil;
    ...
    Opal.def(self, '$initialize', $SevenFortressMobius_initialize$1 = function $$initialize() {
      ...
      return (self.nightWizardDiceBot = $$($nesting, 'NightWizard').$new());
    }, $SevenFortressMobius_initialize$1.$$arity = 0);
    
    Opal.def(self, '$changeText', $SevenFortressMobius_changeText$2 = function $$changeText(string) {
      var $$3, self = this;

      
      string = $send(string, 'sub', [/(\d*)SFM/i], ($$3 = function(){var self = $$3.$$s || this;

      return "" + ($$($nesting, 'Regexp').$last_match(1)) + "NW"}, $$3.$$s = self, $$3.$$arity = 0, $$3));
      return (string = self.nightWizardDiceBot.$changeText(string));
    }, $SevenFortressMobius_changeText$2.$$arity = 1);
    return (Opal.def(self, '$dice_command_xRn', $SevenFortressMobius_dice_command_xRn$4 = function $$dice_command_xRn(string, nick_e) {
      var self = this;

      return self.nightWizardDiceBot.$checkRoll(string, nick_e)
    }, $SevenFortressMobius_dice_command_xRn$4.$$arity = 2), nil) && 'dice_command_xRn';
  })($nesting[0], $$($nesting, 'DiceBot'), $nesting);
})(Opal);
