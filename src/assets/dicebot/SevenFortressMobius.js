...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$setPrefixes', '$new', '$sub', '$last_match', '$changeText', '$checkRoll']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defn(self, '$changeText', TMP_SevenFortressMobius_changeText_6 = function $$changeText(string) {
      ...
      string = $send(string, 'sub', [/(\d*)SFM/i], (TMP_5 = function(){var self = TMP_5.$$s || this;

      return "" + (Opal.const_get_relative($nesting, 'Regexp').$last_match(1)) + "NW"}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5));
