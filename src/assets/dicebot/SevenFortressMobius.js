...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
      ...
      ($a = ($b = self, Opal.find_super_dispatcher(self, 'initialize', TMP_1, false)), $a.$$p = $iter, $a).apply($b, $zuper);
      return self.nightWizardDiceBot = $scope.get('NightWizard').$new();
    }, TMP_1.$$arity = 0);
    ...
    Opal.defn(self, '$changeText', TMP_6 = function $$changeText(string) {
      ...
      return "" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1))) + "NW"}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $a).call($b, /(\d*)SFM/i);
      return string = self.nightWizardDiceBot.$changeText(string);
    }, TMP_6.$$arity = 1);

    return (Opal.defn(self, '$dice_command_xRn', TMP_7 = function $$dice_command_xRn(string, nick_e) {
      var self = this;

      return self.nightWizardDiceBot.$checkRoll(string, nick_e);
    }, TMP_7.$$arity = 2), nil) && 'dice_command_xRn';
  })($scope.base, $scope.get('DiceBot'));
})(Opal);
