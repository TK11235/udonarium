...
(function(Opal) {
  ...
  Opal.add_stubs(['$judgeRoll', '$nil?', '$upcase', '$===', '$getRandomSkillTableResult', '$getTableDiceCommandResult', '$=~', '$to_i', '$==', '$getChangedModifyText', '$[]', '$parren_killer', '$+', '$roll', '$collect', '$split', '$min', '$<=', '$length', '$first', '$check_success', '$each_with_index', '$clone', '$delete_at', '$max', '$-', '$<<', '$uniq!', '$join', '$each', '$>=', '$check_hit', '$get_table_by_2d6', '$get_table_by_1d6', '$getD66Table', '$get_table_by_d66_swap', '$raise', '$map', '$kind_of?', '$!=', '$size', '$inspect', '$setPrefixes', '$keys']);
  return (function($base, $super) {
    function $HatsuneMiku(){};
    var self = $HatsuneMiku = $klass($base, $super, 'HatsuneMiku', $HatsuneMiku);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_8, TMP_10, TMP_11, TMP_12, TMP_14, $a;
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      var $a, self = this, text = nil, string = nil, $case = nil;
    ...
    Opal.defn(self, '$judgeRoll', TMP_8 = function $$judgeRoll(command) {
      var $a, $b, TMP_6, $c, TMP_7, self = this, skillRank = nil, modifyText = nil, signOfInequality = nil, targetText = nil, specialNum = nil, specialText = nil, commandText = nil, rankDiceList = nil, diceCount = nil, modify = nil, target = nil, isSort = nil, _ = nil, diceText = nil, diceList = nil, message = nil, dice = nil, total = nil, result = nil, texts = nil;

      if ((($a = (/^(R([A-DS]|\d+)([\+\-\d,]*))(@(\d))?((>(=)?)([\+\-\d]*))?(@(\d))?$/i['$=~'](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      skillRank = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2));
      modifyText = (($a = $gvars['~']) === nil ? nil : $a['$[]'](3));
      signOfInequality = ((function() {if ((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](7))['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ">="
        } else {
        return (($a = $gvars['~']) === nil ? nil : $a['$[]'](7))
      }; return nil; })());
      targetText = ((function() {if ((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](9))['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "4"
        } else {
        return (($a = $gvars['~']) === nil ? nil : $a['$[]'](9))
      }; return nil; })());
      specialNum = (($a = $gvars['~']) === nil ? nil : $a['$[]'](5));
      ((($a = specialNum) !== false && $a !== nil && $a != null) ? $a : specialNum = (($b = $gvars['~']) === nil ? nil : $b['$[]'](11)));
      ((($a = specialNum) !== false && $a !== nil && $a != null) ? $a : specialNum = 6);
      ...
      if ((($a = /^\d+$/['$==='](skillRank)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
...
if (i == null) i = nil;
      ...
      if ((($a = (skillRank['$==']("D"))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        diceList = [diceList.$min()]};
      message = "(" + (commandText) + (specialText) + (signOfInequality) + (targetText) + ") ＞ [" + (diceText) + "]" + (modifyText) + " ＞ ";
      if ((($a = $rb_le(diceList.$length(), 1)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        dice = diceList.$first();
        ...
        texts = [];
        ($a = ($c = diceList).$each_with_index, $a.$$p = (TMP_7 = function(pickup_dice, index){var self = TMP_7.$$s || this, rests = nil, colorList = nil, color = nil;
if (pickup_dice == null) pickup_dice = nil;if (index == null) index = nil;
        rests = diceList.$clone();
          ...
          return texts['$<<']("　ネイロに" + (pickup_dice) + "(" + (color) + ")を取得した場合 " + (total) + ":" + (result));}, TMP_7.$$s = self, TMP_7.$$arity = 2, TMP_7), $a).call($c);
        texts['$uniq!']();
    ...
    Opal.defn(self, '$getChangedModifyText', TMP_10 = function $$getChangedModifyText(text) {
      var $a, $b, TMP_9, self = this, modifyText = nil, values = nil;

      modifyText = "";
      values = text.$split(/,/);
      ($a = ($b = values).$each, $a.$$p = (TMP_9 = function(value){var self = TMP_9.$$s || this, $case = nil;
if (value == null) value = nil;
      return (function() {$case = value;if ("++"['$===']($case)) {return modifyText = $rb_plus(modifyText, "+2")}else if ("+"['$===']($case)) {return modifyText = $rb_plus(modifyText, "+1")}else {return modifyText = $rb_plus(modifyText, value)}})()}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9), $a).call($b);
      return modifyText;
    }, TMP_10.$$arity = 1);

    Opal.defn(self, '$check_success', TMP_11 = function $$check_success(total_n, dice_n, signOfInequality, diff, special_n) {
      var $a, self = this, success = nil;

      if ((($a = (dice_n['$=='](1))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "ファンブル"};
      if ((($a = ($rb_ge(dice_n, special_n))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "スペシャル"};
      success = (($a = Opal.cvars['@@bcdice']) == null ? nil : $a).$check_hit(total_n, signOfInequality, diff);
      if ((($a = ($rb_ge(success, 1))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return "成功"};
      return "失敗";
    }, TMP_11.$$arity = 5);

    Opal.defn(self, '$getTableDiceCommandResult', TMP_12 = function $$getTableDiceCommandResult(command) {
      ...
      type = info['$[]']("type");
      table = info['$[]']("table");
      $b = (function() {$case = type;if ("2D6"['$===']($case)) {return self.$get_table_by_2d6(table)}else if ("1D6"['$===']($case)) {return self.$get_table_by_1d6(table)}else if ("D66"['$===']($case) || "D66S"['$===']($case)) {table = self.$getD66Table(table);
      return self.$get_table_by_d66_swap(table);}else {return self.$raise("invaolid dice Type " + (command))}})(), $a = Opal.to_ary($b), text = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $b;
      if ((($a = (text['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil};
      return "" + (name) + "(" + (number) + ") ＞ " + (text);
    }, TMP_12.$$arity = 1);

    Opal.defn(self, '$getD66Table', TMP_14 = function $$getD66Table(table) {
      var $a, $b, TMP_13, self = this, newTable = nil;

      newTable = ($a = ($b = table).$map, $a.$$p = (TMP_13 = function(item){var self = TMP_13.$$s || this, $c, $d;
