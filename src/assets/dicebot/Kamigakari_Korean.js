...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      rank = rank.$to_i();
      $b = self.$getGetMaterialTableResult(rank), $a = Opal.to_ary($b), tableName = ($a[0] == null ? nil : $a[0]), result = ($a[1] == null ? nil : $a[1]), number = ($a[2] == null ? nil : $a[2]), $b;}else if ("ET"['$===']($case)) {$b = self.$getEmotionTableResult(), $a = Opal.to_ary($b), tableName = ($a[0] == null ? nil : $a[0]), result = ($a[1] == null ? nil : $a[1]), number = ($a[2] == null ? nil : $a[2]), $b}else if ("NT"['$===']($case)) {$b = self.$getNameTableResult(), $a = Opal.to_ary($b), tableName = ($a[0] == null ? nil : $a[0]), result = ($a[1] == null ? nil : $a[1]), number = ($a[2] == null ? nil : $a[2]), $b}else if ("KT"['$===']($case)) {$b = self.$getKyoukaiTableResult(), $a = Opal.to_ary($b), tableName = ($a[0] == null ? nil : $a[0]), result = ($a[1] == null ? nil : $a[1]), number = ($a[2] == null ? nil : $a[2]), $b}else {self.$debug("rollDiceCommand commandNOT matched -> command:", command);
      return "";};
    ...
    Opal.defn(self, '$getEmotionTableResult', TMP_7 = function $$getEmotionTableResult() {
    ...
    Opal.defn(self, '$getNameTableResult', TMP_8 = function $$getNameTableResult() {
      var self = this, tableName = nil, table = nil, isSwap = nil, number = nil, result = nil;
    ...
    Opal.defn(self, '$getKyoukaiTableResult', TMP_9 = function $$getKyoukaiTableResult() {
      var self = this, tableName = nil, table = nil, isSwap = nil, number = nil, result = nil;
    ...
    Opal.defn(self, '$getGetMaterialTableResult', TMP_10 = function $$getGetMaterialTableResult(rank) {
    ...
    Opal.defn(self, '$getMaterialEffect', TMP_11 = function $$getMaterialEffect(rank) {
    ...
    Opal.defn(self, '$getMaterialEffectNomal', TMP_12 = function $$getMaterialEffectNomal(rank) {
    ...
    Opal.defn(self, '$getMaterialEffectPower', TMP_13 = function $$getMaterialEffectPower(rank) {
    ...
    Opal.defn(self, '$getMaterialEffectRare', TMP_14 = function $$getMaterialEffectRare() {
    ...
    Opal.defn(self, '$getAttribute', TMP_15 = function $$getAttribute() {
    ...
    return (Opal.defn(self, '$getPrice', TMP_16 = function $$getPrice(effect) {
      var $a, self = this, power = nil, $case = nil, table = nil, price = nil;

      power = 0;
      $case = effect;if (/\+(\d+)/['$===']($case)) {power = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i()}else if (/부여/['$===']($case)) {power = 3}else if (/반감/['$===']($case)) {power = 4}else {power = 0};
      table = [nil, "500G(효과치:1)", "1000G(효과치:2)", "1500G(효과치:3)", "2000G(효과치:4)", "3000G(효과치:5)"];
      price = table['$[]'](power);
      return price;
    }, TMP_16.$$arity = 1), nil) && 'getPrice';
