...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Alshard_gameName_1, TMP_Alshard_gameType_2;

    
    self.$setPrefixes(["2D6.*", "AL.*"]);
    self.$set_aliases_for_srs_roll("AL");
    
    Opal.defn(self, '$gameName', TMP_Alshard_gameName_1 = function $$gameName() {
      var self = this;

      return "アルシャード"
    }, TMP_Alshard_gameName_1.$$arity = 0);
    return (Opal.defn(self, '$gameType', TMP_Alshard_gameType_2 = function $$gameType() {
      var self = this;

      return "Alshard"
    }, TMP_Alshard_gameType_2.$$arity = 0), nil) && 'gameType';
