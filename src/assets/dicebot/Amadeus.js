...
(function(Opal) {
  ...
  Opal.add_stubs(['$amadeusDice', '$nil?', '$[]', '$upcase', '$===', '$get_table_by_1d6', '$get_table_by_2d6', '$get_table_by_d66_swap', '$=~', '$|', '$to_i', '$parren_killer', '$+', '$roll', '$collect', '$split', '$==', '$min', '$each', '$>', '$length', '$check_success', '$>=', '$check_hit', '$setPrefixes', '$keys']);
  return (function($base, $super) {
    function $Amadeus(){};
    var self = $Amadeus = $klass($base, $super, 'Amadeus', $Amadeus);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_8, TMP_9, $a;
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      type = info['$[]']("type");
      table = info['$[]']("table");
      $b = (function() {$case = type;if ("1D6"['$===']($case)) {return self.$get_table_by_1d6(table)}else if ("2D6"['$===']($case)) {return self.$get_table_by_2d6(table)}else if ("D66"['$===']($case)) {return self.$get_table_by_d66_swap(table)}else {return nil}})(), $a = Opal.to_ary($b), text = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $b;
      if ((($a = (text['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil};
      return "" + (name) + "(" + (number) + ") ＞ " + (text);
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$amadeusDice', TMP_8 = function $$amadeusDice(command) {
      var $a, $b, TMP_6, $c, $d, TMP_7, self = this, commandText = nil, skillRank = nil, modifyText = nil, signOfInequality = nil, targetText = nil, specialNum = nil, diceCount = nil, modify = nil, target = nil, _ = nil, diceText = nil, diceList = nil, specialText = nil, message = nil, is_loop = nil, dice = nil, achieve = nil, result = nil;

      if ((($a = (/^(R([A-DS])([\+\-\d]*))(@(\d))?((>(=)?)([\+\-\d]*))?(@(\d))?$/i['$=~'](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      ...
      if ((($a = (nil['$|']((($b = $gvars['~']) === nil ? nil : $b['$[]'](5))))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        specialNum = (($a = $gvars['~']) === nil ? nil : $a['$[]'](5)).$to_i()
      } else if ((($a = (nil['$|']((($b = $gvars['~']) === nil ? nil : $b['$[]'](11))))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        specialNum = (($a = $gvars['~']) === nil ? nil : $a['$[]'](11)).$to_i()
        } else {
        specialNum = 6
      };
      diceCount = (($a = Opal.cvars['@@checkDiceCount']) == null ? nil : $a)['$[]'](skillRank);
...
if (i == null) i = nil;
      ...
      is_loop = false;
      ($c = ($d = diceList).$each, $c.$$p = (TMP_7 = function($a){var self = TMP_7.$$s || this, $e;
if ($a == null) $a = nil;
      dice = $a;
        if ((($e = (is_loop)) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
          message = $rb_plus(message, " / ")
        } else if ((($e = ($rb_gt(diceList.$length(), 1))) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
          is_loop = true};
        achieve = $rb_plus(dice, modify);
        result = self.$check_success(achieve, dice, signOfInequality, target, specialNum);
        if ((($e = (is_loop)) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
          return message = $rb_plus(message, "" + (achieve) + "_" + (result) + "[" + (dice) + ((($e = Opal.cvars['@@checkInga']) == null ? nil : $e)['$[]'](dice)) + "]")
          } else {
          return message = $rb_plus(message, "" + (achieve) + "_" + (result) + "[" + (dice) + "]")
        };}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7), $c).call($d);
      return message;
    }, TMP_8.$$arity = 1);

    Opal.defn(self, '$check_success', TMP_9 = function $$check_success(total_n, dice_n, signOfInequality, diff, special_n) {
