...
if (i == null) i = nil;
      ...
      getaString = "";
      $case = (diceList['$[]'](0));if ((1)['$===']($case)) {getaString = "裏：あめ"}else if ((2)['$===']($case)) {getaString = "表：はれ"}else if ((3)['$===']($case)) {getaString = "裏：あめ"}else if ((4)['$===']($case)) {getaString = "表：はれ"}else if ((5)['$===']($case)) {getaString = "裏：あめ"}else if ((6)['$===']($case)) {getaString = "表：はれ"}else if ((7)['$===']($case)) {getaString = "横：くもり"};
