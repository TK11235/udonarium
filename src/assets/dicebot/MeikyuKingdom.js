...
if (_i == null) _i = nil;
    ...
    Opal.defn(self, '$mk_item_aptitude_table', TMP_MeikyuKingdom_mk_item_aptitude_table_77 = function $$mk_item_aptitude_table(num) {
      ...
      return $rb_plus(self.$mk_gender_table($rb_plus(self.$rand(6), 1)), "性")}, TMP_76.$$s = self, TMP_76.$$arity = 0, TMP_76))], [4, "上級ジョブ"], [5, "怪獸スキルを修得"], [6, "童貞、もしくは処女"]];
      return $rb_plus("" + "[" + (num) + "]", self.$get_table_by_number(num, table));
...
if (_i == null) _i = nil;
    ...
    Opal.defn(self, '$getAftersearchBreakTable', TMP_MeikyuKingdom_getAftersearchBreakTable_125 = function $$getAftersearchBreakTable() {
      ...
      return self.$get_table_by_2d6(["「おつとめ、ご苦労様です」同行する民たちが感謝の言葉をかける。《民の声》が1点回復する。", "「おい、サボるな」と仲間から怒られた。いやいや、こっちは今までマジメにやってましたよ。宮廷の中から好きな角色1人を選ぶ。自分のその角色に対する《敵意》が1点上昇する。", "大漁大漁！　色々な素材が見つかる。肉、牙、革、木、鉄の素材（角色卡の上の段の素材）を1個ずつ獲得する。", "そこは、もう、使い魔が探索してくれていたようだ。サンキュー相棒！　この捜索の判定に【使い魔】を利用していれば、行動済みにならず、さらにもう1回行動を行うことができる。", "危険なトラップを見つけたが、なんとか無力化できた。任務完了。自分の《気力》が1点回復する。", "何も見つからなかったか、と思っていたら「いつも、ありがとう」と宮廷の仲間から声をかけられた。まぁ、何もない方がいいか。宮廷の中から好きな角色1人を選ぶ。自分のその角色に対する《好意》が1点上昇する。", "「さすが！　素晴らしいお手並みだ」鮮やかな捜索に、仲間の見る目が変わる。宮廷の中から好きな角色1人を選ぶ。その角色の自分に対する《好意》が1点上昇する。", "よしよし、これはいいものが見つかった。好きな素材を1d6個獲得する。この捜索の判定に【使い魔】を使用していれば、獲得数が1d6個上昇する。", "大漁大漁！　色々な素材が見つかる。衣料、魔素、機械、火薬、情報の素材（角色卡の上の段の素材）を1個ずつ獲得する。", "うわ！　罠だ。余計なものまで見つけてしまった。宮廷全員は1d6点のダメージを受ける。", "「へぇ、こんなヤツだったのか」仲間の意外な一面を見つける。宮廷の中から好きな角色1人を選ぶ。自分のその角色に対する《好意》か《敵意》を1点上昇させ、その属性を好きなものに変更できる。"])
