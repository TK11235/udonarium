...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      ...
      result = "";
      secret_flg = false;
      $case = command;if (/^BIO(\d+)?$/i['$===']($case)) {roll_times = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 1)).$to_i();
      result = self.$checkInfection(roll_times);
      secret_flg = true;}else if (/^ZMB(\+(\d+))?$/i['$===']($case)) {value = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i();
      result = self.$rollZombie(value);
      secret_flg = true;};
      return [result, secret_flg];
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$checkInfection', TMP_7 = function $$checkInfection(roll_times) {
      var $a, $b, TMP_6, self = this, result = nil;

      result = "感染度表";
      ($a = ($b = roll_times).$times, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $c, $d, d1 = nil, d2 = nil, index1 = nil, index2 = nil, table = nil;
      ...
      $d = self.$roll(1, 6), $c = Opal.to_ary($d), d1 = ($c[0] == null ? nil : $c[0]), $d;
        ...
        return result = $rb_plus(result, table['$[]'](index1)['$[]'](index2));}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b);
      return result;
    }, TMP_7.$$arity = 1);

    return (Opal.defn(self, '$rollZombie', TMP_8 = function $$rollZombie(value) {
