...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_13, TMP_14, TMP_15, TMP_17, TMP_18, TMP_19, TMP_20, TMP_21, TMP_22;
    ...
    Opal.defn(self, '$changeText', TMP_13 = function $$changeText(string) {
      var $a, $b, TMP_5, $c, TMP_6, $d, TMP_7, $e, TMP_8, $f, TMP_9, $g, TMP_10, $h, TMP_11, $i, TMP_12, self = this;

      string = ($a = ($b = string).$gsub, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $c;

      return "2R10" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](2))) + ">=" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1))) + "[" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](4))) + "," + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](6))) + "]"}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $a).call($b, /EM(\d+)([\+\-][\+\-\d]+)(@(\d+))(\#(\d+))/i);
      string = ($a = ($c = string).$gsub, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $d;

      return "2R10" + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](2))) + ">=" + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](1))) + "[20," + ((($d = $gvars['~']) === nil ? nil : $d['$[]'](4))) + "]"}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($c, /EM(\d+)([\+\-][\+\-\d]+)(\#(\d+))/i);
      string = ($a = ($d = string).$gsub, $a.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this, $e;

      return "2R10" + ((($e = $gvars['~']) === nil ? nil : $e['$[]'](2))) + ">=" + ((($e = $gvars['~']) === nil ? nil : $e['$[]'](1))) + "[" + ((($e = $gvars['~']) === nil ? nil : $e['$[]'](4))) + ",2]"}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $a).call($d, /EM(\d+)([\+\-][\+\-\d]+)(@(\d+))/i);
      string = ($a = ($e = string).$gsub, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $f;

      return "2R10" + ((($f = $gvars['~']) === nil ? nil : $f['$[]'](2))) + ">=" + ((($f = $gvars['~']) === nil ? nil : $f['$[]'](1))) + "[20,2]"}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $a).call($e, /EM(\d+)([\+\-][\+\-\d]+)/i);
      string = ($a = ($f = string).$gsub, $a.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this, $g;

      return "2R10>=" + ((($g = $gvars['~']) === nil ? nil : $g['$[]'](1))) + "[" + ((($g = $gvars['~']) === nil ? nil : $g['$[]'](3))) + "," + ((($g = $gvars['~']) === nil ? nil : $g['$[]'](5))) + "]"}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $a).call($f, /EM(\d+)(@(\d+))(\#(\d+))/i);
      string = ($a = ($g = string).$gsub, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this, $h;

      return "2R10>=" + ((($h = $gvars['~']) === nil ? nil : $h['$[]'](1))) + "[20," + ((($h = $gvars['~']) === nil ? nil : $h['$[]'](3))) + "]"}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $a).call($g, /EM(\d+)(\#(\d+))/i);
      string = ($a = ($h = string).$gsub, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this, $i;

      return "2R10>=" + ((($i = $gvars['~']) === nil ? nil : $i['$[]'](1))) + "[" + ((($i = $gvars['~']) === nil ? nil : $i['$[]'](3))) + ",2]"}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $a).call($h, /EM(\d+)(@(\d+))/i);
      return string = ($a = ($i = string).$gsub, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this, $j;

      return "2R10>=" + ((($j = $gvars['~']) === nil ? nil : $j['$[]'](1))) + "[20,2]"}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $a).call($i, /EM(\d+)/i);
    }, TMP_13.$$arity = 1);

    Opal.defn(self, '$dice_command_xRn', TMP_14 = function $$dice_command_xRn(string, nick_e) {
      var self = this;

      return self.$checkRoll(string, nick_e);
    }, TMP_14.$$arity = 2);

    Opal.defn(self, '$check_nD10', TMP_15 = function $$check_nD10(total_n, dice_n, signOfInequality, diff, dice_cnt, dice_max, n1, n_max) {
      var $a, self = this;
      ...
      if ((($a = ($rb_le(dice_n, 2))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return " ＞ ファンブル"
      } else if ((($a = ($rb_ge(dice_n, 20))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return " ＞ クリティカル"
    ...
    Opal.defn(self, '$checkRoll', TMP_17 = function $$checkRoll(string, nick_e) {
      ...
      output = "1";
      if ((($a = (/(^|\s)S?(2[rR]10([\+\-\d]+)?([>=]+(\d+))(\[(\d+),(\d+)\]))(\s|$)/i['$=~'](string))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return output
      };
      ...
      if ((($a = ((($b = $gvars['~']) === nil ? nil : $b['$[]'](8)))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      dice_arr = ($a = ($b = dice_str.$split(/,/)).$collect, $a.$$p = (TMP_16 = function(i){var self = TMP_16.$$s || this;
if (i == null) i = nil;
      return i.$to_i()}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16), $a).call($b);
      big_dice = dice_arr['$[]'](1);
      ...
      if ((($a = ($rb_le(dice_now, fumble))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        output = $rb_plus(output, " ＞ ファンブル")
      } else if ((($a = ($rb_ge(dice_now, crit))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_18 = function $$rollDiceCommand(command) {
      ...
      type = "";
      number = 0;
      $case = command;if (/HLT/i['$===']($case)) {type = "命中部位";
      $b = self.$roll(2, 10), $a = Opal.to_ary($b), number = ($a[0] == null ? nil : $a[0]), $b;
      output = self.$get_hit_location_table(number);}else if (/SFT/i['$===']($case)) {type = "射撃ファンブル";
      $b = self.$roll(2, 10), $a = Opal.to_ary($b), number = ($a[0] == null ? nil : $a[0]), $b;
      output = self.$get_shoot_fumble_table(number);}else if (/MFT/i['$===']($case)) {type = "白兵ファンブル";
      $b = self.$roll(2, 10), $a = Opal.to_ary($b), number = ($a[0] == null ? nil : $a[0]), $b;
    ...
    Opal.defn(self, '$get_hit_location_table', TMP_19 = function $$get_hit_location_table(num) {
    ...
    Opal.defn(self, '$get_shoot_fumble_table', TMP_20 = function $$get_shoot_fumble_table(num) {
      var $a, self = this, output = nil, table = nil, dc = nil;
      ...
      dc = 2;
      if ((($a = (table['$[]']($rb_minus(num, dc)))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        output = table['$[]']($rb_minus(num, dc))};
      return output;
    }, TMP_20.$$arity = 1);

    Opal.defn(self, '$get_melee_fumble_table', TMP_21 = function $$get_melee_fumble_table(num) {
      var $a, self = this, output = nil, table = nil, dc = nil;
    ...
    return (Opal.defn(self, '$get_hit_level_table', TMP_22 = function $$get_hit_level_table(num) {
      var self = this, table = nil;

      table = [[6, "命中レベルC"], [9, "命中レベルB"], [10, "命中レベルA"]];
      return self.$get_table_by_number(num, table);
    }, TMP_22.$$arity = 1), nil) && 'get_hit_level_table';
