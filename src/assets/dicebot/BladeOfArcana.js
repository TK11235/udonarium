...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$upcase', '$===', '$to_i', '$!=', '$empty?', '$!', '$==', '$rollAct', '$tableText', '$<', '$<=', '$>', '$-', '$roll', '$min', '$map', '$to_proc', '$split', '$+', '$>=', '$[]']);
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_5 = function $$rollDiceCommand(command) {
      var $a, $b, $c, self = this, $case = nil, counts = nil, judgment = nil, option1 = nil, argument1 = nil, option2 = nil, argument2 = nil, critical = nil, fumble = nil, sign = nil, title = nil, table = nil;

      $case = command.$upcase();if (/^(\d+)A(\d*)([CF]?)(\d*)([CF]?)(\d*)$/['$===']($case)) {counts = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i();
      ...
      if ((($a = ((($b = ((($c = option1['$empty?']()['$!='](argument1['$empty?']())) !== false && $c !== nil && $c != null) ? $c : option2['$empty?']()['$!='](argument2['$empty?']()))) !== false && $b !== nil && $b != null) ? $b : (($c = option2['$empty?']()['$!'](), $c !== false && $c !== nil && $c != null ?option1['$=='](option2) : $c)))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil};
      if (option1['$==']("C")) {
      ...
      return self.$rollAct(counts, judgment, critical, fumble);}else if (/^CT3([\+\-]?)$/['$===']($case)) {sign = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      title = "因縁表(The 3rd)　『BoA3』P292";
      table = ["【他生】", "【師弟】", "【忘却】", "【兄姉】", "【貸し】", "【慕情】", "【主従】", "【強敵】", "【秘密】", "【恩人】", "【告発】", "【友人】", "【仇敵】", "【父母】", "【借り】", "【信頼】", "【幼子】", "【取引】", "【地縁】", "【同志】", "【不審】", "【自身】"];
      return self.$tableText(title, table, sign);}else if (/^CTR([\+\-]?)$/['$===']($case)) {sign = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      title = "因縁表(リインカーネイション)　『BAR』P51、299";
      table = ["【他生】", "【師弟】", "【忘却】", "【兄姉】", "【貸し】", "【憧憬】", "【主従】", "【強敵】", "【秘密】", "【恩人】", "【取引】", "【友人】", "【怨敵】", "【後援】", "【借り】", "【信頼】", "【弟妹】", "【商売】", "【奇縁】", "【同志】", "【有為】", "【自身】"];
      return self.$tableText(title, table, sign);}else if (/^DJV(\-?)$/['$===']($case)) {sign = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      ...
      return self.$tableText(title, table, sign);}else if (/^AKST([\+\-]?)$/['$===']($case)) {sign = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
    ...
    Opal.defn(self, '$rollAct', TMP_6 = function $$rollAct(counts, judgment, critical, fumble) {
      ...
      if ((($a = $rb_lt(critical, 1)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        critical = 1};
      if ((($a = $rb_le(judgment, 0)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        judgment = critical
      } else if ((($a = $rb_gt(critical, judgment)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        critical = judgment};
      if ((($a = $rb_le(fumble, 0)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        fumble = 20};
      ...
      if ((($a = $rb_lt(fumble, 2)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        fumble = 2
      } else if ((($a = $rb_gt(fumble, 20)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        fumble = 20};
      ...
      if (counts['$=='](1)) {
        ...
        value = ($a = ($b = string.$split(",")).$map, $a.$$p = "to_i".$to_proc(), $a).call($b).$min();
        text = $rb_plus(text, "" + (value) + " ＞ ");
      };
      if ((($a = $rb_ge(value, fumble)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        text = $rb_plus(text, "ファンブル")
      } else if ((($a = $rb_le(value, critical)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        text = $rb_plus(text, "クリティカル")
      } else if ((($a = $rb_gt(value, judgment)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    return (Opal.defn(self, '$tableText', TMP_7 = function $$tableText(title, table, sign) {
      ...
      text = "" + (title) + " ＞ " + (index);
      if ((($a = sign['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        text = $rb_plus(text, "[" + (number) + (sign) + "1]")
      };
      return $rb_plus($rb_plus(text, " ＞ "), table['$[]'](index));
    }, TMP_7.$$arity = -3), nil) && 'tableText';
