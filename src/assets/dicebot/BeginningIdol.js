...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$check_nD6', '$==', '$<=', '$>=', '$upcase', '$===', '$to_i', '$rollPerformance', '$textFrom1D6Table', '$textFromD66Table', '$roll', '$%', '$getD66', '$assoc', '$getSkillList', '$badStatus', '$+', '$[]', '$-', '$getSkillText', '$=~', '$getItem', '$get_table_by_1d6', '$index', '$nil?', '$push', '$setArrayFromD66Table', '$sort!', '$each', '$gsub', '$length', '$include?', '$costume', '$<', '$>', '$!', '$empty?', '$split', '$count', '$join', '$uniq', '$inject', '$map', '$to_proc', '$delete', '$to_s', '$sort', '$checkChance', '$replaceBadStatus', '$slice', '$get_table_by_2d6', '$times', '$clone']);
  return (function($base, $super) {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_8 = function $$rollDiceCommand(command) {
      var $a, $b, TMP_7, $c, self = this, $case = nil, counts = nil, residual = nil, adjust = nil, title = nil, table = nil, value = nil, number = nil, name = nil, isSwap = nil, dice = nil, outcome = nil, text = nil, page = nil, table1 = nil, table2 = nil, skillTitle = nil, skillTable = nil, nameTable = nil, articleTitle = nil, articleTable = nil, describeTitle = nil, describeTable = nil, sceneTitle = nil, sceneTable = nil, materialTitle = nil, materialTable = nil, actionTitle = nil, actionTable = nil, nameNumber = nil, nameParts = nil, articleIndex = nil, numberString = nil, bookTitle = nil, degrees = nil, total = nil, string = nil, sure = nil, remove = nil, result = nil;
      ...
      return self.$textFrom1D6Table(title, table);}else if ("BWT"['$===']($case)) {title = "大手芸能プロダクション仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("LWT"['$===']($case)) {title = "弱小芸能プロダクション仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("TWT"['$===']($case)) {title = "ライブシアター仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("CWT"['$===']($case)) {title = "アイドル部仕事表";
      ...
      return self.$textFromD66Table(title, table, value);}else if ("SU"['$===']($case)) {title = "情熱の夏仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("WI"['$===']($case)) {title = "ぬくもりの冬仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("NA"['$===']($case)) {title = "大自然仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("WT"['$===']($case)) {title = "仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("VA"['$===']($case)) {title = "バラエティ仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("MU"['$===']($case)) {title = "音楽関係仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("DR"['$===']($case)) {title = "ドラマ関係仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("VI"['$===']($case)) {title = "ビジュアル関係仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("SP"['$===']($case)) {title = "スポーツ仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("CHR"['$===']($case)) {title = "クリスマス仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("PAR"['$===']($case)) {title = "パートナー関係仕事表";
      ...
      return self.$textFromD66Table(title, table);}else if ("RE"['$===']($case)) {title = "ランダムイベント";
      ...
      return "" + (title) + " ＞ (1D6) ＞ " + (number) + "\n" + (name) + " ＞ [" + (outcome) + "] ＞ " + (text) + "（『ビギニングロード』" + (page) + "ページ）";}else if ("HA"['$===']($case)) {title = "ハプニング表";
      ...
      return self.$badStatus(counts);}else if ("SGT"['$===']($case)) {title = "アイドルスキル修得表(チャレンジガールズ)";
      ...
      return self.$textFrom1D6Table(title, table);}else if ("RS"['$===']($case)) {title = "アイドルスキル修得表(ロードトゥプリンス)";
...
if (index == null) index = nil;if (src == null) src = nil;if (text1 == null) text1 = nil;if (number1 == null) number1 = nil;
      ...
      return self.$textFrom1D6Table(title, table);}else if ("CHO"['$===']($case)) {title = "サビ表";
      ...
      return self.$textFromD66Table(title, table);}else if ("SCH"['$===']($case)) {title = "情熱の夏サビ表";
      ...
      return self.$textFrom1D6Table(title, table);}else if ("WCH"['$===']($case)) {title = "ぬくもりの冬サビ表";
      ...
      return self.$textFrom1D6Table(title, table);}else if ("NCH"['$===']($case)) {title = "大自然サビ表";
      ...
      return self.$textFrom1D6Table(title, table);}else if ("GCH"['$===']($case)) {title = "女性向けサビ表";
      ...
      return self.$textFromD66Table(title, table);}else if ("PCH"['$===']($case)) {title = "力強いサビ表";
      ...
      return self.$textFromD66Table(title, table);}else if (/^IT(\d+)?$/['$===']($case)) {counts = (((($a = (($c = $gvars['~']) === nil ? nil : $c['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 1)).$to_i();
      ...
      return $rb_plus($rb_plus(text, "\n"), self.$costume($rb_plus($rb_plus("衣装(", bookTitle), ")"), true));}else if ("ACE"['$===']($case)) {title = "アクセサリー効果表";
      ...
      return self.$textFromD66Table(title, table);}else if ("DT"['$===']($case)) {return self.$costume("衣装(チャレンジガールズ)")}else if ("RC"['$===']($case)) {return self.$costume("衣装(ロードトゥプリンス)")}else if ("FC"['$===']($case)) {return self.$costume("衣装(フォーチュンスターズ)")}else if ("CBT"['$===']($case)) {title = "キャラ空白表(チャレンジガールズ)";
      ...
      return self.$textFromD66Table(title, table);}else if ("RCB"['$===']($case)) {title = "キャラ空白表(ロードトゥプリンス)";
      ...
      return self.$textFromD66Table(title, table);}else if ("HBT"['$===']($case)) {title = "趣味空白表(チャレンジガールズ)";
      ...
      return self.$textFromD66Table(title, table);}else if ("RHB"['$===']($case)) {title = "趣味空白表(ロードトゥプリンス)";
      ...
      return self.$textFrom1D6Table(title, table);}else if ("BVT"['$===']($case)) {title = "大手芸能プロダクション会場表";
      ...
      return self.$textFrom1D6Table(title, table);}else if ("TVT"['$===']($case)) {title = "ライブシアター会場表";
      table = ["ライブシアター", "ライブシアター", "ライブシアター", "ライブシアター", "ライブシアター", "ライブシアター"];
      return self.$textFrom1D6Table(title, table);}else if ("CVT"['$===']($case)) {title = "アイドル部会場表";
      table = ["運動場", "体育館", "屋上", "街中", "地元のイベント", "学園アイドル大会"];
      return self.$textFrom1D6Table(title, table);}else if ("BST"['$===']($case)) {title = "大手芸能プロダクション場所表";
      table = ["社内プロジェクトルーム", "社内カフェ", "社内プール", "社内レッスンルーム", "ショッピングセンター", "社内エステルーム"];
      return self.$textFrom1D6Table(title, table);}else if ("LST"['$===']($case)) {title = "弱小芸能プロダクション場所表";
      table = ["給湯室", "客間", "居間", "屋上", "社長室", "近所の公演"];
      return self.$textFrom1D6Table(title, table);}else if ("TST"['$===']($case)) {title = "ライブシアター場所表";
      table = ["私たちの舞台", "控室", "売店", "シアター前", "レッスンルーム", "舞台袖"];
      return self.$textFrom1D6Table(title, table);}else if ("CST"['$===']($case)) {title = "アイドル部場所表";
      table = ["部室", "音楽室", "教室", "屋上", "運動場", "体育館"];
      return self.$textFrom1D6Table(title, table);}else if ("BPT"['$===']($case)) {title = "大手芸能プロダクションプレッシャー種別決定表";
      table = ["先輩アイドルたちの期待", "後輩アイドルたちからの憧れ", "社長の視察", "同期アイドルたちとの競い合い", "大物ゲスト登場", "TV番組のプロデューサー"];
      return self.$textFrom1D6Table(title, table);}else if ("LPT"['$===']($case)) {title = "弱小芸能プロダクションプレッシャー種別決定表";
      table = ["熱心にライブに来てくれるファン", "とても悪い条件でのステージ", "大手プロダクションの視察", "ドレスデザイナーの品定め", "新曲を提供したミュージシャン", "取材に来た芸能記者"];
      return self.$textFrom1D6Table(title, table);}else if ("TPT"['$===']($case)) {title = "ライブシアタープレッシャー種別決定表";
      table = ["ライブシアターに毎日来てくれるファン", "ライブシアターで働くスタッフ", "シアター経営者の視察", "シアターに偶然立ち寄った大勢の観客", "並行して行われるイベントのファン", "ライバルライブシアターのアイドルユニット"];
      return self.$textFrom1D6Table(title, table);}else if ("CPT"['$===']($case)) {title = "アイドル部プレッシャー種別決定表";
      table = ["ライバルチーム「海原校」の挑戦", "最強チーム「Tiara's」の偵察", "PTAの視察", "PCの親", "仲の良い同級生", "ライバルチーム「聖国際女学園」の挑戦"];
      return self.$textFrom1D6Table(title, table);}else if ("BIT"['$===']($case)) {title = "大手芸能プロダクション道具表";
      table = ["栄養ドリンク", "自動販売機", "先輩アイドルのポスター", "先輩アイドルのCD", "アイドル雑誌", "台本"];
      return self.$textFrom1D6Table(title, table);}else if ("LIT"['$===']($case)) {title = "弱小芸能プロダクション道具表";
      table = ["セロハンテープ", "冷蔵庫", "百円玉", "ボロボロのソファー", "おにぎり", "キッチン"];
      return self.$textFrom1D6Table(title, table);}else if ("TIT"['$===']($case)) {title = "ライブシアター道具表";
      table = ["舞台の照明", "企画書", "PCのグッズ", "ホワイトボード", "ライブポスター", "うどん"];
      return self.$textFrom1D6Table(title, table);}else if ("CIT"['$===']($case)) {title = "アイドル部道具表";
...
if ($a == null) $a = nil;
    ...
    Opal.defn(self, '$checkChance', TMP_12 = function $$checkChance(text, skill, chance) {
      ...
      if ((($a = chance['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return [text, skill]};
      if ((($a = /チャンスが(\d{1,2})以下ならオフ。/['$==='](text)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return [text, skill]
      };
    ...
    Opal.defn(self, '$textFrom1D6Table', TMP_13 = function $$textFrom1D6Table(title, table1, table2) {
      ...
      if ((($a = /ランダムに決定した特技が指定特技のアイドルスキル\(身長分野、(属性|才能)分野、出身分野が出たら振り直し\)$/['$=~'](text)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        category = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
        while ((($b = true) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        skill = self.$getSkillList();
        text = $rb_plus(text, "\n" + (skill));
        if ((($b = ((($c = ((($d = skill['$include?']("身長")) !== false && $d !== nil && $d != null) ? $d : skill['$include?'](category))) !== false && $c !== nil && $c != null) ? $c : skill['$include?']("出身"))) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
          } else {
          break;
        };
...
if (i == null) i = nil;
    ...
    return (Opal.defn(self, '$costume', TMP_22 = function $$costume(title, brandOnly) {
      ...
      table = [];
      if ((($a = title['$include?']("チャレンジガールズ")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      } else if ((($a = title['$include?']("ロードトゥプリンス")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
