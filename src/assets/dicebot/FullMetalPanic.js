...
Opal.modules["diceBot/MetallicGuadian"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$changeText', TMP_6 = function $$changeText(string) {
      ...
      return "" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1))) + "2D6"}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $a).call($b, /^(S)?MG/i);
      return string;
...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$changeText', TMP_6 = function $$changeText(string) {
      ...
      return "" + ((($c = $gvars['~']) === nil ? nil : $c['$[]'](1))) + "2D6"}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $a).call($b, /^(S)?(MG|FP)/i);
      return string;
    }, TMP_6.$$arity = 1), nil) && 'changeText';
  })($scope.base, $scope.get('MetallicGuadian'));
})(Opal);
