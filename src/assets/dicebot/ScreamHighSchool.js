...
Opal.loaded(["diceBot/GardenOrder"]);
/* Generated by Opal 0.11.4 */
(function(Opal) {
  function $rb_lt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs < rhs : lhs['$<'](rhs);
  ...
  return (function($base, $super, $parent_nesting) {
    function $ScreamHighSchool(){};
    var self = $ScreamHighSchool = $klass($base, $super, 'ScreamHighSchool', $ScreamHighSchool);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ScreamHighSchool_gameName_1, TMP_ScreamHighSchool_gameType_2, TMP_ScreamHighSchool_getHelpMessage_3, TMP_ScreamHighSchool_rollDiceCommand_4, TMP_ScreamHighSchool_check_roll_sh_5, TMP_ScreamHighSchool_get_supplementary_6;

    
    self.$setPrefixes(["(SH|SHS)(\\-?\\d+)(\\/\\d+)?(@\\d+)?", "(EM|TR|FE)(\\-?\\d+)(@\\d+)?", "DC(SL|BL|IM|BR|RF|EL).+"]);
    
    Opal.defn(self, '$gameName', TMP_ScreamHighSchool_gameName_1 = function $$gameName() {
      var self = this;

      return "スクリームハイスクール"
    }, TMP_ScreamHighSchool_gameName_1.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_ScreamHighSchool_gameType_2 = function $$gameType() {
      var self = this;

      return "ScreamHighSchool"
    }, TMP_ScreamHighSchool_gameType_2.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_ScreamHighSchool_getHelpMessage_3 = function $$getHelpMessage() {
      var self = this;
    ...
    }, TMP_ScreamHighSchool_getHelpMessage_3.$$arity = 0);
    
    Opal.defn(self, '$rollDiceCommand', TMP_ScreamHighSchool_rollDiceCommand_4 = function $$rollDiceCommand(command) {
      ...
      command_type = Opal.const_get_relative($nesting, 'Regexp').$last_match(1).$upcase();
      success_rate = Opal.const_get_relative($nesting, 'Regexp').$last_match(2).$to_i();
      critical_border_text = Opal.const_get_relative($nesting, 'Regexp').$last_match(4);
      critical_border = self.$get_critical_border(critical_border_text, success_rate);
      ...
      return self.$look_up_damage_chart(type, damage_value);};
      return nil;
    }, TMP_ScreamHighSchool_rollDiceCommand_4.$$arity = 1);
    
    Opal.defn(self, '$check_roll_sh', TMP_ScreamHighSchool_check_roll_sh_5 = function $$check_roll_sh(success_rate, critical_border, command_type) {
      ...
      return text;
    }, TMP_ScreamHighSchool_check_roll_sh_5.$$arity = 3);
    return (Opal.defn(self, '$get_supplementary', TMP_ScreamHighSchool_get_supplementary_6 = function $$get_supplementary(command_type, result) {
    ...
    }, TMP_ScreamHighSchool_get_supplementary_6.$$arity = 2), nil) && 'get_supplementary';
