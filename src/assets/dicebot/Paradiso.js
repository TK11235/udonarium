...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    function $Paradiso(){};
    var self = $Paradiso = $klass($base, $super, 'Paradiso', $Paradiso);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Paradiso_gameName_1, TMP_Paradiso_gameType_2, TMP_Paradiso_getHelpMessage_3, TMP_Paradiso_rollDiceCommand_4, TMP_Paradiso_getJudgeResult_6, TMP_Paradiso_getDamageResult_9, TMP_Paradiso_get_radiomarietta_table_10, TMP_Paradiso_get_takeoff_table_11, TMP_Paradiso_get_exploration_table_12, TMP_Paradiso_get_flightsupply_table_13;

    
    self.$setPrefixes(["(\\d+)*D20<=.*", "(\\d+)*CP.*", "RMT", "TOT", "EXT", "SUT", "DC(\\d+).*"]);
    
    Opal.defn(self, '$gameName', TMP_Paradiso_gameName_1 = function $$gameName() {
      var self = this;

      return "チェレステ色のパラディーゾ"
    }, TMP_Paradiso_gameName_1.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_Paradiso_gameType_2 = function $$gameType() {
      var self = this;

      return "Paradiso"
    }, TMP_Paradiso_gameType_2.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_Paradiso_getHelpMessage_3 = function $$getHelpMessage() {
      var self = this;

      return "" + "◆判定　(nCPt[f]@c)、(nD20<=t[f]@c)　n:ダイス数（省略時:1）　t:目標値（省略時:14）　f:絶不調の追加ファンブル値　c:人機一体の追加クリティカル値\n" + "　例）CP12　CP(13+1)　3CP12[18,19]@7\n" + "◆各種表\n" + "　・ラジオ・マリエッタ表　RMT\n" + "　・移動表　TOT\n" + "　・探索表　EXT\n" + "　・補給表　SUT\n" + "◆ダメージチェック　(DCa[20,30])　a:【攻撃力】、[20]:20mm機銃追加、[30]:30mmガンポッド追加\n" + "　例）DC4:【攻撃力】4でダメージチェック　DC5[20]:【攻撃力】5でダメージチェック、うち1つは20mm機銃　DC5[20,30]:【攻撃力】5でダメージチェック、うち1つは20mm機銃、うち1つは30mmガンポッド\n"
    }, TMP_Paradiso_getHelpMessage_3.$$arity = 0);
    
    Opal.defn(self, '$rollDiceCommand', TMP_Paradiso_rollDiceCommand_4 = function $$rollDiceCommand(command) {
    ...
    }, TMP_Paradiso_rollDiceCommand_4.$$arity = 1);
    
    Opal.defn(self, '$getJudgeResult', TMP_Paradiso_getJudgeResult_6 = function $$getJudgeResult(command) {
      var $a, TMP_5, self = this, $case = nil, number = nil, target = nil, fumble1 = nil, fumble2 = nil, critical = nil, dice = nil, dicetext = nil, crit_flg = nil, fumb_flg = nil, succ_flg = nil, result = nil, text = nil;

      
      $case = command;
      if (/^(\d+)*D20<=(\d+)?(\[(\d+)(,(\d+))?\])?(\@(\d+))?$/i['$===']($case)) {
      number = ($truthy($a = Opal.const_get_relative($nesting, 'Regexp').$last_match(1)) ? $a : 1).$to_i();
      target = ($truthy($a = Opal.const_get_relative($nesting, 'Regexp').$last_match(2)) ? $a : 14).$to_i();
      fumble1 = ($truthy($a = Opal.const_get_relative($nesting, 'Regexp').$last_match(4)) ? $a : 21).$to_i();
      fumble2 = ($truthy($a = Opal.const_get_relative($nesting, 'Regexp').$last_match(6)) ? $a : 21).$to_i();
      critical = ($truthy($a = Opal.const_get_relative($nesting, 'Regexp').$last_match(8)) ? $a : 21).$to_i();}
      ...
      fumb_flg = false;
      succ_flg = false;
      $send(number, 'times', [], (TMP_5 = function(){var self = TMP_5.$$s || this;
      ...
      return text;
    }, TMP_Paradiso_getJudgeResult_6.$$arity = 1);
    
    Opal.defn(self, '$getDamageResult', TMP_Paradiso_getDamageResult_9 = function $$getDamageResult(command) {
      var $a, TMP_7, TMP_8, self = this, biggun = nil, $case = nil, attack = nil, $writer = nil, dice = nil, dicetext = nil, damage = nil, doubledam = nil, tripledam = nil, result = nil, text = nil;

      
      biggun = [0, 0, 0];
      $case = command;
      if (/^DC(\d+)(\[(\d+)(,(\d+))?(,(\d+))?\])?$/i['$===']($case)) {
      attack = ($truthy($a = Opal.const_get_relative($nesting, 'Regexp').$last_match(1)) ? $a : 1).$to_i();
      
      $writer = [0, ($truthy($a = Opal.const_get_relative($nesting, 'Regexp').$last_match(3)) ? $a : 0).$to_i()];
      $send(biggun, '[]=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [1, ($truthy($a = Opal.const_get_relative($nesting, 'Regexp').$last_match(5)) ? $a : 0).$to_i()];
      $send(biggun, '[]=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [2, ($truthy($a = Opal.const_get_relative($nesting, 'Regexp').$last_match(7)) ? $a : 0).$to_i()];
      $send(biggun, '[]=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;}
      else {return nil};
      dice = 0;
      dicetext = "";
      damage = Opal.const_get_relative($nesting, 'Array').$new(20, 0);
      doubledam = 0;
      tripledam = 0;
      $send(biggun, 'each', [], (TMP_7 = function(bg){var self = TMP_7.$$s || this;
if (bg == null) bg = nil;
      return (function() {$case = bg;
        ...
        else { return nil }})()}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7));
      $send(attack, 'times', [], (TMP_8 = function(){var self = TMP_8.$$s || this;
        ...
        };}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8));
      ...
      return text;
    }, TMP_Paradiso_getDamageResult_9.$$arity = 1);
    
    Opal.defn(self, '$get_radiomarietta_table', TMP_Paradiso_get_radiomarietta_table_10 = function $$get_radiomarietta_table() {
    ...
    }, TMP_Paradiso_get_radiomarietta_table_10.$$arity = 0);
    
    Opal.defn(self, '$get_takeoff_table', TMP_Paradiso_get_takeoff_table_11 = function $$get_takeoff_table() {
      var self = this, dice = nil, $case = nil, text = nil;
    ...
    }, TMP_Paradiso_get_takeoff_table_11.$$arity = 0);
    
    Opal.defn(self, '$get_exploration_table', TMP_Paradiso_get_exploration_table_12 = function $$get_exploration_table() {
      var self = this, dice = nil, $case = nil, text = nil;
    ...
    }, TMP_Paradiso_get_exploration_table_12.$$arity = 0);
    return (Opal.defn(self, '$get_flightsupply_table', TMP_Paradiso_get_flightsupply_table_13 = function $$get_flightsupply_table() {
      var self = this, dice = nil, $case = nil, text = nil;
    ...
    }, TMP_Paradiso_get_flightsupply_table_13.$$arity = 0), nil) && 'get_flightsupply_table';
