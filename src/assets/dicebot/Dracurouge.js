...
(function(Opal) {
  ...
  Opal.add_stubs(['$debug', '$analyzeDiceCommandResultMethod', '$===', '$to_i', '$==', '$rollDiceList', '$getGloryDiceCount', '$times', '$<<', '$getThirstyAddedResult', '$empty?', '$+', '$join', '$roll', '$sort', '$collect', '$split', '$countTargetDice', '$/', '$count', '$select', '$rindex', '$<=', '$nil?', '$each_with_index', '$to_s', '$[]=', '$[]', '$getReactionText', '$getReactionInfoBlood', '$getReactionInfoStyle', '$getHeresyReactionInfoBlood', '$getHeresyReactionInfoStyle', '$checkTypeText', '$<', '$-', '$*', '$getReactionTextFull', '$find', '$getReactionTex', '$include?', '$each', '$get_table_by_number', '$get_table_by_2d6', '$get_table_by_1d6', '$get_table_by_d66', '$getSourceSceneTable', '$getTitleD66TableResult', '$getPassionTable', '$getConfermentTable', '$getYearTableResult', '$getConfermentAfterTable', '$getElderPastTable', '$getOriginalSinTable', '$getRecentStateTable', '$getPeacefulPastTable', '$getYear', '$gsub', '$getD6xResult', '$length', '$parren_killer', '$setPrefixes', '$keys']);
  return (function($base, $super) {
    function $Dracurouge(){};
    var self = $Dracurouge = $klass($base, $super, 'Dracurouge', $Dracurouge);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_7, TMP_9, TMP_10, TMP_12, TMP_15, TMP_16, TMP_17, TMP_18, TMP_20, TMP_22, TMP_24, TMP_25, TMP_26, TMP_27, TMP_28, TMP_29, TMP_30, TMP_31, TMP_32, TMP_33, TMP_34, TMP_35, TMP_36, TMP_37, TMP_38, TMP_39, TMP_40, TMP_41, TMP_43, TMP_46, TMP_47, TMP_48, TMP_49, TMP_50, TMP_51, TMP_52, TMP_53, TMP_54, $a;
    ...
    Opal.defn(self, '$getConductDiceCommandResult', TMP_7 = function $$getConductDiceCommandResult(command) {
...
if (item == null) item = nil;if (index == null) index = nil;
    ...
    Opal.defn(self, '$getResistDiceCommandResult', TMP_16 = function $$getResistDiceCommandResult(command) {
    ...
    Opal.defn(self, '$getReactionDiceCommandResult', TMP_17 = function $$getReactionDiceCommandResult(command) {
      var $a, self = this, typeText1 = nil, typeText2 = nil, name = nil;

      if ((($a = /^RT((\w)(\w))?/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
    ...
    Opal.defn(self, '$getHeresyReactionDiceCommandResult', TMP_18 = function $$getHeresyReactionDiceCommandResult(command) {
      var $a, self = this, typeText1 = nil, typeText2 = nil, name = nil;

      if ((($a = /^HRT((\w)(\w))?/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      typeText1 = (($a = $gvars['~']) === nil ? nil : $a['$[]'](2));
    ...
    Opal.defn(self, '$getReactionText', TMP_20 = function $$getReactionText(name, typeText1, typeText2, infos1, infos2) {
      ...
      if ((($a = self.$checkTypeText(typeText1, infos1)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      if ((($a = self.$checkTypeText(typeText2, infos2)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      ...
      infos = (function() {if (isBefore !== false && isBefore !== nil && isBefore != null) {
        return infos1
        } else {
        return infos2
      }; return nil; })();
      ...
      index = $rb_plus(($rb_minus(one_value, 1)), $rb_times(((function() {if (isBefore !== false && isBefore !== nil && isBefore != null) {
      ...
      if ((($a = typeText['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        info = ($a = ($b = infos).$find, $a.$$p = (TMP_19 = function(i){var self = TMP_19.$$s || this;
if (i == null) i = nil;
        return i['$[]']("type")['$=='](typeText)}, TMP_19.$$s = self, TMP_19.$$arity = 1, TMP_19), $a).call($b);
    ...
    Opal.defn(self, '$checkTypeText', TMP_22 = function $$checkTypeText(typeText, infos) {
      var $a, $b, TMP_21, self = this, keys = nil;

      if ((($a = typeText['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return true};
      keys = ($a = ($b = infos).$collect, $a.$$p = (TMP_21 = function(i){var self = TMP_21.$$s || this;
if (i == null) i = nil;
      return i['$[]']("type")}, TMP_21.$$s = self, TMP_21.$$arity = 1, TMP_21), $a).call($b);
      return keys['$include?'](typeText);
    }, TMP_22.$$arity = 2);

    Opal.defn(self, '$getReactionTextFull', TMP_24 = function $$getReactionTextFull(infos, index) {
      var $a, $b, TMP_23, self = this, resultTexts = nil;

      resultTexts = [];
      ($a = ($b = infos).$each, $a.$$p = (TMP_23 = function(info){var self = TMP_23.$$s || this;
if (info == null) info = nil;
      return resultTexts['$<<'](self.$getReactionTex(info, index))}, TMP_23.$$s = self, TMP_23.$$arity = 1, TMP_23), $a).call($b);
      return resultTexts.$join("／");
    }, TMP_24.$$arity = 2);

    Opal.defn(self, '$getReactionTex', TMP_25 = function $$getReactionTex(info, index) {
    ...
    Opal.defn(self, '$getReactionInfoBlood', TMP_26 = function $$getReactionInfoBlood() {
    ...
    Opal.defn(self, '$getReactionInfoStyle', TMP_27 = function $$getReactionInfoStyle() {
      var self = this, infos = nil;
    ...
    Opal.defn(self, '$getHeresyReactionInfoBlood', TMP_28 = function $$getHeresyReactionInfoBlood() {
      var self = this, infos = nil;
    ...
    Opal.defn(self, '$getHeresyReactionInfoStyle', TMP_29 = function $$getHeresyReactionInfoStyle() {
      var self = this, infos = nil;
    ...
    Opal.defn(self, '$getCorruptionDiceCommandResult', TMP_30 = function $$getCorruptionDiceCommandResult(command) {
      var $a, $b, self = this, modify = nil, name = nil, table = nil, number = nil, number_text = nil, index = nil, text = nil;

      if ((($a = /^CT(\d+)$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
    ...
    Opal.defn(self, '$getTableDiceCommandResult', TMP_31 = function $$getTableDiceCommandResult(command) {
      ...
      type = info['$[]']("type");
      table = info['$[]']("table");
      $b = (function() {$case = type;if ("2D6"['$===']($case)) {return self.$get_table_by_2d6(table)}else if ("1D6"['$===']($case)) {return self.$get_table_by_1d6(table)}else if ("D66"['$===']($case)) {return self.$get_table_by_d66(table)}else {return nil}})(), $a = Opal.to_ary($b), text = ($a[0] == null ? nil : $a[0]), number = ($a[1] == null ? nil : $a[1]), $b;
      if ((($a = (text['$nil?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil};
      return "" + (name) + "(" + (number) + ") ＞ " + (text);
    }, TMP_31.$$arity = 1);

    Opal.defn(self, '$getSourceSceneDiceCommandResult', TMP_32 = function $$getSourceSceneDiceCommandResult(command) {
      var $a, self = this, name = nil, table = nil;

      if ((($a = /^ST$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "原風景表";
    ...
    Opal.defn(self, '$getPassionDiceCommandResult', TMP_33 = function $$getPassionDiceCommandResult(command) {
      var $a, self = this, name = nil, table = nil;

      if ((($a = /^PN$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "受難表";
    ...
    Opal.defn(self, '$getTitleD66TableResult', TMP_34 = function $$getTitleD66TableResult(name, table) {
      ...
      if ((($a = item['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil};
      $b = item, $a = Opal.to_ary($b), title = ($a[0] == null ? nil : $a[0]), text = ($a[1] == null ? nil : $a[1]), $b;
      return "" + (name) + "(" + (index) + ") ＞ " + (title) + "：" + (text);
    }, TMP_34.$$arity = 2);

    Opal.defn(self, '$getConfermentDiceCommandResult', TMP_35 = function $$getConfermentDiceCommandResult(command) {
      var $a, self = this, name = nil, table = nil, yearTitle = nil;

      if ((($a = /^CO$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "叙勲表";
    ...
    Opal.defn(self, '$getConfermentAfterDiceCommandResult', TMP_36 = function $$getConfermentAfterDiceCommandResult(command) {
      var $a, self = this, name = nil, table = nil, yearTitle = nil;

      if ((($a = /^CA$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "叙勲後表";
    ...
    Opal.defn(self, '$getElderPastDiceCommandResult', TMP_37 = function $$getElderPastDiceCommandResult(command) {
      var $a, self = this, name = nil, table = nil, yearTitle = nil;

      if ((($a = /^EP$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "遥か過去表";
    ...
    Opal.defn(self, '$getOriginalSinDiceCommandResult', TMP_38 = function $$getOriginalSinDiceCommandResult(command) {
      var $a, self = this, name = nil, table = nil, yearTitle = nil;

      if ((($a = /^OS$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "原罪表";
    ...
    Opal.defn(self, '$getRecentStateDiceCommandResult', TMP_39 = function $$getRecentStateDiceCommandResult(command) {
      var $a, self = this, name = nil, table = nil, yearTitle = nil;

      if ((($a = /^RS$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "近況表";
    ...
    Opal.defn(self, '$getPeacefulPastDiceCommandResult', TMP_40 = function $$getPeacefulPastDiceCommandResult(command) {
      var $a, self = this, name = nil, table = nil, yearTitle = nil;

      if ((($a = /^PP$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "平和な過去表";
    ...
    Opal.defn(self, '$getYearTableResult', TMP_41 = function $$getYearTableResult(name, table, yearTitle) {
    ...
    Opal.defn(self, '$getYear', TMP_43 = function $$getYear(yearText) {
      var $a, $b, TMP_42, self = this, text = nil, year = nil;

      text = ($a = ($b = yearText).$gsub, $a.$$p = (TMP_42 = function(){var self = TMP_42.$$s || this, $c;

      return self.$getD6xResult((($c = $gvars['~']) === nil ? nil : $c['$[]'](1)).$to_i(), (($c = $gvars['~']) === nil ? nil : $c['$[]'](2)).$length())}, TMP_42.$$s = self, TMP_42.$$arity = 0, TMP_42), $a).call($b, /(\d+)D(6+)/);
      text = "(" + (text) + ")";
      year = self.$parren_killer(text.$gsub(/×/, "*"));
      return [year, text];
    }, TMP_43.$$arity = 1);

    Opal.defn(self, '$getD6xResult', TMP_46 = function $$getD6xResult(count, dice6Count) {
      var $a, $b, TMP_44, self = this, total = nil;

      total = 0;
      ($a = ($b = count).$times, $a.$$p = (TMP_44 = function(i){var self = TMP_44.$$s || this, $c, $d, TMP_45, number = nil;
if (i == null) i = nil;
      number = 0;
        ($c = ($d = dice6Count).$times, $c.$$p = (TMP_45 = function(i){var self = TMP_45.$$s || this, $e, $f, dice = nil;
if (i == null) i = nil;
        number = $rb_times(number, 10);
          $f = self.$roll(1, 6), $e = Opal.to_ary($f), dice = ($e[0] == null ? nil : $e[0]), $f;
          return number = $rb_plus(number, dice);}, TMP_45.$$s = self, TMP_45.$$arity = 1, TMP_45), $c).call($d);
        return total = $rb_plus(total, number);}, TMP_44.$$s = self, TMP_44.$$arity = 1, TMP_44), $a).call($b);
      return total.$to_s();
    }, TMP_46.$$arity = 2);

    Opal.defn(self, '$getSourceSceneTable', TMP_47 = function $$getSourceSceneTable() {
    ...
    Opal.defn(self, '$getConfermentTable', TMP_48 = function $$getConfermentTable() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$getConfermentAfterTable', TMP_49 = function $$getConfermentAfterTable() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$getElderPastTable', TMP_50 = function $$getElderPastTable() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$getOriginalSinTable', TMP_51 = function $$getOriginalSinTable() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$getPassionTable', TMP_52 = function $$getPassionTable() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$getRecentStateTable', TMP_53 = function $$getRecentStateTable() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$getPeacefulPastTable', TMP_54 = function $$getPeacefulPastTable() {
      var self = this, table = nil;
