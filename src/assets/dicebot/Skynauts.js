...
(function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_12, TMP_15, TMP_16, TMP_17, TMP_18, TMP_19, TMP_22;
    ...
    Opal.defn(self, '$getJudgeResult', TMP_6 = function $$getJudgeResult(command) {
      var $a, $b, self = this, target = nil, total = nil, diceText = nil, result = nil, text = nil;

      if ((($a = ((($b = /^2D6<=(\d)$/i['$==='](command)) !== false && $b !== nil && $b != null) ? $b : /^SN(\d*)$/i['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      self.$debug("====getJudgeResult====");
      target = (function() {if ((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return 7
        } else {
        return (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i()
      }; return nil; })();
      self.$debug("目標値", target);
      $b = self.$roll(2, 6), $a = Opal.to_ary($b), total = ($a[0] == null ? nil : $a[0]), diceText = ($a[1] == null ? nil : $a[1]), $b;
      if ((($a = $rb_le(total, 2)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = "ファンブル"
      } else if ((($a = $rb_le(total, target)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = "成功"
        } else {
        result = "失敗"
      };
    ...
    Opal.defn(self, '$navigationResult', TMP_7 = function $$navigationResult(command) {
      var $a, $b, self = this, bonus = nil, total = nil, movePointBase = nil, movePoint = nil, text = nil;

      if ((($a = /^NV(\+(\d+))?$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
    ...
    Opal.defn(self, '$getFireResult', TMP_9 = function $$getFireResult(command) {
      ...
      if ((($a = ballistics['$!='](0)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$getFirePoint', TMP_12 = function $$getFirePoint(fireRange, fireCount) {
      var $a, $b, TMP_10, self = this, firePoint = nil;

      self.$debug("====getFirePoint====");
      firePoint = [];
      ($a = ($b = fireCount).$times, $a.$$p = (TMP_10 = function(count){var self = TMP_10.$$s || this, $c, $d, TMP_11, yPos = nil, xPos = nil, position = nil;
if (count == null) count = nil;
      self.$debug("\n砲撃回数", $rb_plus(count, 1));
        firePoint['$<<']([]);
        $d = self.$roll(1, 6), $c = Opal.to_ary($d), yPos = ($c[0] == null ? nil : $c[0]), $d;
        $d = self.$roll(2, 6), $c = Opal.to_ary($d), xPos = ($c[0] == null ? nil : $c[0]), $d;
        position = [xPos, yPos];
        firePoint['$[]'](-1)['$<<'](position);
        self.$debug("着弾点", firePoint);
        return ($c = ($d = fireRange.$split(/(?:)/)).$each, $c.$$p = (TMP_11 = function(rangeText){var self = TMP_11.$$s || this, position_diff = nil;
if (rangeText == null) rangeText = nil;
        self.$debug("範囲", rangeText);
          ...
          firePoint['$[]'](-1)['$<<'](position);
          return self.$debug("着弾点:範囲", firePoint);}, TMP_11.$$s = self, TMP_11.$$arity = 1, TMP_11), $c).call($d);}, TMP_10.$$s = self, TMP_10.$$arity = 1, TMP_10), $a).call($b);
      self.$debug("\n最終着弾点", firePoint);
      return firePoint;
    }, TMP_12.$$arity = 2);

    Opal.defn(self, '$getFirePointText', TMP_15 = function $$getFirePointText(firePoint, fireCount, direction) {
      var $a, $b, TMP_13, self = this, fireTextList = nil, fireText = nil;
      ...
      fireTextList = [];
      ($a = ($b = firePoint).$each, $a.$$p = (TMP_13 = function(point){var self = TMP_13.$$s || this, $c, $d, TMP_14, text = nil;
if (point == null) point = nil;
      text = "";
        ($c = ($d = point).$each, $c.$$p = (TMP_14 = function(x, y){var self = TMP_14.$$s || this, $e, $f;
if (x == null) x = nil;if (y == null) y = nil;
        $f = self.$getMovePoint(x, y, direction), $e = Opal.to_ary($f), x = ($e[0] == null ? nil : $e[0]), y = ($e[1] == null ? nil : $e[1]), $f;
          text = $rb_plus(text, ((function() {if ((($e = self.$isInMapPosition(x, y)) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
            return "[縦" + (y) + ",横" + (x) + "]"
            } else {
            return "([縦" + (y) + ",横" + (x) + "])"
          }; return nil; })()));
          return self.$debug("着弾点テキスト", text);}, TMP_14.$$s = self, TMP_14.$$arity = 2, TMP_14), $c).call($d);
        return fireTextList['$<<'](text);}, TMP_13.$$s = self, TMP_13.$$arity = 1, TMP_13), $a).call($b);
      fireText = fireTextList.$join(",");
      self.$debug("\n最終着弾点テキスト", fireText);
      return fireText;
    }, TMP_15.$$arity = -3);

    Opal.defn(self, '$isInMapPosition', TMP_16 = function $$isInMapPosition(x, y) {
      var $a, $b, self = this;

      return ($a = ((($b = $rb_le(1, y)) ? $rb_le(y, 6) : $rb_le(1, y))), $a !== false && $a !== nil && $a != null ?((($b = $rb_le(2, x)) ? $rb_le(x, 12) : $rb_le(2, x))) : $a);
    }, TMP_16.$$arity = 2);

    Opal.defn(self, '$getMovePoint', TMP_17 = function $$getMovePoint(x, y, direction) {
    ...
    Opal.defn(self, '$getBomberResult', TMP_18 = function $$getBomberResult(command) {
      var $a, self = this, target = nil, direction = nil, text = nil, fireCommand = nil;

      if ((($a = /^BOM(\d*)?\/D([1-4, 6-9]*)(\[.+\])*\/(\d+)(@([2,4,6,8]))?$/i['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      self.$debug("====getBomberResult====", command);
      target = (($a = $gvars['~']) === nil ? nil : $a['$[]'](1));
      direction = (($a = $gvars['~']) === nil ? nil : $a['$[]'](6)).$to_i();
      self.$debug("弾道学方向", direction);
      text = "" + (command) + " ＞ ";
      text = $rb_plus(text, self.$getJudgeResult($rb_plus("SN", target)));
      if ((($a = /成功/['$==='](text)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return text
      };
    ...
    Opal.defn(self, '$getAvoidResult', TMP_19 = function $$getAvoidResult(command) {
      var $a, self = this, direction = nil, judgeCommand = nil, text = nil, pointCommand = nil, firePoint = nil, fireCount = nil;

      if ((($a = /^AVO(\d*)?(@([2,4,6,8]))(\(?\[縦\d+,横\d+\]\)?,?)+$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      self.$debug("====getAvoidResult====", command);
      direction = (($a = $gvars['~']) === nil ? nil : $a['$[]'](3)).$to_i();
      self.$debug("回避方向", direction);
      judgeCommand = command.$slice(/^AVO(\d*)?(@([2,4,6,8]))/);
      text = "" + (judgeCommand) + " ＞ 《回避運動》";
      text = $rb_plus(text, self.$getJudgeResult($rb_plus("SN", (($a = $gvars['~']) === nil ? nil : $a['$[]'](1)))));
      if ((($a = /成功/['$==='](text)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return text
      };
    ...
    return (Opal.defn(self, '$scanFirePoints', TMP_22 = function $$scanFirePoints(command) {
      var $a, $b, TMP_20, self = this, firePoint = nil;

      self.$debug("====scanFirePoints====", command);
      command = command.$gsub(/\(|\)/, "");
      firePoint = [];
      ($a = ($b = command.$split(/\],/)).$each, $a.$$p = (TMP_20 = function(pointText){var self = TMP_20.$$s || this, $c, $d, TMP_21;
if (pointText == null) pointText = nil;
      self.$debug("pointText", pointText);
        firePoint['$<<']([]);
        return ($c = ($d = pointText.$split(/\]/)).$each, $c.$$p = (TMP_21 = function(point){var self = TMP_21.$$s || this, $e, y = nil, x = nil;
if (point == null) point = nil;
        self.$debug("point", point);
          firePoint['$[]'](-1)['$<<']([]);
          if ((($e = /[^\d]*(\d+),[^\d]*(\d+)/['$==='](point)) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
            } else {
            return nil;
          };
          y = (($e = $gvars['~']) === nil ? nil : $e['$[]'](1)).$to_i();
          x = (($e = $gvars['~']) === nil ? nil : $e['$[]'](2)).$to_i();
          firePoint['$[]'](-1)['$[]='](-1, [x, y]);
          return self.$debug("着弾点", firePoint);}, TMP_21.$$s = self, TMP_21.$$arity = 1, TMP_21), $c).call($d);}, TMP_20.$$s = self, TMP_20.$$arity = 1, TMP_20), $a).call($b);
      return firePoint;
    }, TMP_22.$$arity = 1), nil) && 'scanFirePoints';
