...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ColossalHunter_initialize_1, TMP_ColossalHunter_gameName_2, TMP_ColossalHunter_gameType_3, TMP_ColossalHunter_getHelpMessage_4, TMP_ColossalHunter_rollDiceCommand_5, TMP_ColossalHunter_getCheckRollDiceCommandResult_6, TMP_ColossalHunter_getJudgeResultString_7, TMP_ColossalHunter_getValue_8, TMP_ColossalHunter_isCritical_9, TMP_ColossalHunter_isFamble_10, TMP_ColossalHunter_getSourceSceneDiceCommandResult_11, TMP_ColossalHunter_getYearTableResult_12, TMP_ColossalHunter_getYear_14, TMP_ColossalHunter_getD6xResult_17, TMP_ColossalHunter_getBig6Table_18, TMP_ColossalHunter_getCreateNpcDiceCommandResult_19, TMP_ColossalHunter_getD66Item_20, TMP_ColossalHunter_getTableDiceCommandResult_21, $a;
    ...
    Opal.defn(self, '$getCheckRollDiceCommandResult', TMP_ColossalHunter_getCheckRollDiceCommandResult_6 = function $$getCheckRollDiceCommandResult(command) {
      ...
      return result;
    }, TMP_ColossalHunter_getCheckRollDiceCommandResult_6.$$arity = 1);
    
    Opal.defn(self, '$getJudgeResultString', TMP_ColossalHunter_getJudgeResultString_7 = function $$getJudgeResultString(difficulty, total) {
      var self = this;
      ...
      if ($truthy($rb_ge(total, difficulty))) {
        return " ＞ 成功"};
      return " ＞ 失敗";
    }, TMP_ColossalHunter_getJudgeResultString_7.$$arity = 2);
    
    Opal.defn(self, '$getValue', TMP_ColossalHunter_getValue_8 = function $$getValue(text, defaultValue) {
      var $a, self = this;
    ...
    }, TMP_ColossalHunter_getValue_8.$$arity = 2);
    
    Opal.defn(self, '$isCritical', TMP_ColossalHunter_isCritical_9 = function $$isCritical(total) {
      var self = this;

      
      return $rb_ge(total, 16);
    }, TMP_ColossalHunter_isCritical_9.$$arity = 1);
    
    Opal.defn(self, '$isFamble', TMP_ColossalHunter_isFamble_10 = function $$isFamble(total) {
      var self = this;

      
      return $rb_le(total, 5);
    }, TMP_ColossalHunter_isFamble_10.$$arity = 1);
    
    Opal.defn(self, '$getSourceSceneDiceCommandResult', TMP_ColossalHunter_getSourceSceneDiceCommandResult_11 = function $$getSourceSceneDiceCommandResult(command) {
    ...
    }, TMP_ColossalHunter_getSourceSceneDiceCommandResult_11.$$arity = 1);
    
    Opal.defn(self, '$getYearTableResult', TMP_ColossalHunter_getYearTableResult_12 = function $$getYearTableResult(name, table, yearTitle) {
      ...
      return result;
    }, TMP_ColossalHunter_getYearTableResult_12.$$arity = 3);
    
    Opal.defn(self, '$getYear', TMP_ColossalHunter_getYear_14 = function $$getYear(yearText) {
      var TMP_13, self = this, text = nil, calculateText = nil, year = nil;

      
      text = $send(yearText, 'gsub', [/(\d+)D(6+)/], (TMP_13 = function(){var self = TMP_13.$$s || this;

      return self.$getD6xResult(Opal.const_get_relative($nesting, 'Regexp').$last_match(1).$to_i(), Opal.const_get_relative($nesting, 'Regexp').$last_match(2).$length())}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13));
      calculateText = "" + "(" + (text) + ")";
    ...
    }, TMP_ColossalHunter_getYear_14.$$arity = 1);
    
    Opal.defn(self, '$getD6xResult', TMP_ColossalHunter_getD6xResult_17 = function $$getD6xResult(count, dice6Count) {
      var TMP_15, self = this, total = nil;

      
      total = 0;
      $send(count, 'times', [], (TMP_15 = function(_i){var self = TMP_15.$$s || this, TMP_16, number = nil;
if (_i == null) _i = nil;
      
        number = 0;
        $send(dice6Count, 'times', [], (TMP_16 = function(_i){var self = TMP_16.$$s || this, $a, $b, dice = nil;
if (_i == null) _i = nil;
        
          number = $rb_times(number, 10);
          $b = self.$roll(1, 6), $a = Opal.to_ary($b), (dice = ($a[0] == null ? nil : $a[0])), $b;
          return (number = $rb_plus(number, dice));}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16));
        return (total = $rb_plus(total, number));}, TMP_15.$$s = self, TMP_15.$$arity = 1, TMP_15));
      return total.$to_s();
    }, TMP_ColossalHunter_getD6xResult_17.$$arity = 2);
    
    Opal.defn(self, '$getBig6Table', TMP_ColossalHunter_getBig6Table_18 = function $$getBig6Table() {
      ...
      return table;
    }, TMP_ColossalHunter_getBig6Table_18.$$arity = 0);
    
    Opal.defn(self, '$getCreateNpcDiceCommandResult', TMP_ColossalHunter_getCreateNpcDiceCommandResult_19 = function $$getCreateNpcDiceCommandResult(command) {
      ...
      return result;
    }, TMP_ColossalHunter_getCreateNpcDiceCommandResult_19.$$arity = 1);
    
    Opal.defn(self, '$getD66Item', TMP_ColossalHunter_getD66Item_20 = function $$getD66Item(table, index) {
    ...
    }, TMP_ColossalHunter_getD66Item_20.$$arity = 2);
    
    Opal.defn(self, '$getTableDiceCommandResult', TMP_ColossalHunter_getTableDiceCommandResult_21 = function $$getTableDiceCommandResult(command) {
    ...
    }, TMP_ColossalHunter_getTableDiceCommandResult_21.$$arity = 1);
