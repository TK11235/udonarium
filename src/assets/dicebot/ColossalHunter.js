...
(function(Opal) {
  ...
  Opal.add_stubs(['$+', '$keys', '$analyzeDiceCommandResultMethod', '$debug', '$===', '$to_i', '$getValue', '$roll', '$sort', '$collect', '$split', '$nil?', '$isFamble', '$isCritical', '$getJudgeResultString', '$>=', '$==', '$empty?', '$parren_killer', '$<=', '$getBig6Table', '$getYearTableResult', '$get_table_by_d66', '$getYear', '$gsub', '$getD6xResult', '$length', '$times', '$*', '$to_s', '$getD66Item', '$[]', '$get_table_by_2d6', '$get_table_by_1d6', '$setPrefixes']);
  return (function($base, $super) {
    function $ColossalHunter(){};
    var self = $ColossalHunter = $klass($base, $super, 'ColossalHunter', $ColossalHunter);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_16, TMP_19, TMP_20, TMP_21, TMP_22, TMP_23, $a;
    ...
    Opal.defn(self, '$prefixs', TMP_2 = function $$prefixs() {
      ...
      return $rb_plus(["CH.*", "B6T", "CNP"], (($a = Opal.cvars['@@tables']) == null ? nil : $a).$keys());
    }, TMP_2.$$arity = 0);
    ...
    Opal.defn(self, '$getCheckRollDiceCommandResult', TMP_8 = function $$getCheckRollDiceCommandResult(command) {
      var $a, $b, TMP_7, self = this, diceCount = nil, modifyText = nil, difficultyText = nil, modify = nil, difficulty = nil, dice = nil, dice_str = nil, diceList = nil, total = nil, result = nil;

      self.$debug("getCheckRollDiceCommandResult command", command);
      if ((($a = (/(\d+)?CH([\+\-\d]*)(>=([\+\-\d]*))?$/i['$==='](command))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      diceCount = (((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : 3)).$to_i();
      ...
      diceList = ($a = ($b = dice_str.$split(/,/)).$collect, $a.$$p = (TMP_7 = function(i){var self = TMP_7.$$s || this;
if (i == null) i = nil;
      ...
      if ((($a = (self.$isFamble(dice))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        result = $rb_plus(result, " ＞ ファンブル")
      } else if ((($a = (self.$isCritical(total))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$getJudgeResultString', TMP_9 = function $$getJudgeResultString(difficulty, total) {
      var $a, self = this;
    ...
    Opal.defn(self, '$getValue', TMP_10 = function $$getValue(text, defaultValue) {
      var $a, $b, self = this;
    ...
    Opal.defn(self, '$isCritical', TMP_11 = function $$isCritical(total) {
      var self = this;

      return ($rb_ge(total, 16));
    }, TMP_11.$$arity = 1);

    Opal.defn(self, '$isFamble', TMP_12 = function $$isFamble(total) {
      var self = this;

      return ($rb_le(total, 5));
    }, TMP_12.$$arity = 1);

    Opal.defn(self, '$getSourceSceneDiceCommandResult', TMP_13 = function $$getSourceSceneDiceCommandResult(command) {
      var $a, self = this, name = nil, table = nil, yearTitle = nil;

      if ((($a = /^B6T$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "BIG-6表";
    ...
    Opal.defn(self, '$getYearTableResult', TMP_14 = function $$getYearTableResult(name, table, yearTitle) {
      ...
      if ((($a = year['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
    ...
    Opal.defn(self, '$getYear', TMP_16 = function $$getYear(yearText) {
      var $a, $b, TMP_15, self = this, text = nil, calculateText = nil, year = nil;

      text = ($a = ($b = yearText).$gsub, $a.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this, $c;

      return self.$getD6xResult((($c = $gvars['~']) === nil ? nil : $c['$[]'](1)).$to_i(), (($c = $gvars['~']) === nil ? nil : $c['$[]'](2)).$length())}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15), $a).call($b, /(\d+)D(6+)/);
      calculateText = "(" + (text) + ")";
    ...
    Opal.defn(self, '$getD6xResult', TMP_19 = function $$getD6xResult(count, dice6Count) {
      var $a, $b, TMP_17, self = this, total = nil;

      total = 0;
      ($a = ($b = count).$times, $a.$$p = (TMP_17 = function(i){var self = TMP_17.$$s || this, $c, $d, TMP_18, number = nil;
if (i == null) i = nil;
      number = 0;
        ($c = ($d = dice6Count).$times, $c.$$p = (TMP_18 = function(i){var self = TMP_18.$$s || this, $e, $f, dice = nil;
if (i == null) i = nil;
        number = $rb_times(number, 10);
          $f = self.$roll(1, 6), $e = Opal.to_ary($f), dice = ($e[0] == null ? nil : $e[0]), $f;
          return number = $rb_plus(number, dice);}, TMP_18.$$s = self, TMP_18.$$arity = 1, TMP_18), $c).call($d);
        return total = $rb_plus(total, number);}, TMP_17.$$s = self, TMP_17.$$arity = 1, TMP_17), $a).call($b);
      return total.$to_s();
    }, TMP_19.$$arity = 2);

    Opal.defn(self, '$getBig6Table', TMP_20 = function $$getBig6Table() {
    ...
    Opal.defn(self, '$getCreateNpcDiceCommandResult', TMP_21 = function $$getCreateNpcDiceCommandResult(command) {
      ...
      if ((($a = /^CNP$/['$==='](command)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      name = "NPC作成表";
    ...
    Opal.defn(self, '$getD66Item', TMP_22 = function $$getD66Item(table, index) {
    ...
    Opal.defn(self, '$getTableDiceCommandResult', TMP_23 = function $$getTableDiceCommandResult(command) {
